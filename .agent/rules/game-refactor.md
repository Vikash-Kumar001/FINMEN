...
3.  **Registry Check:** Check the category's [index.js](cci:7://file:///f:/internship/FINMEN/frontend/src/pages/Student/Finance/Kids/index.js:0:0-0:0) (e.g., [HealthMale/Kids/index.js](cci:7://file:///f:/internship/FINMEN/frontend/src/pages/Student/HealthMale/Kids/index.js:0:0-0:0)) to identify the next 10 games and their import names.
...
Type C: Poster Games
Reference: 
Finance/Kids/PosterSavingHabit.jsx
...
Type D: Badge Games
Reference: 
Finance/Kids/BadgeSaverKid.jsx
...
Identify Game: Open the file (e.g., FruitVsCandyStory.jsx).
Check Type: Is it a Story, Reflex, Puzzle, or Poster game?
Copy Template: Open the corresponding Finance game file to see the structure.
...
Implement Logic:
handleAnswer
: Update score, show feedback (showCorrectAnswerFeedback(1, true)), set timeout for next.
handleNext
: Navigate to menu if finished.
Apply Styling: Wrap in GameShell and apply Tailwind classes.
Verify Timer (Reflex only): Ensure useEffect depends on currentRound.
...
note: all the option have same background bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600