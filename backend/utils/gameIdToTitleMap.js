...
export const gameIdToTitleMap = {
  ...
  // Sustainability - Kids
  'sustainability-kids-1': 'Eco Sort Story',
  'sustainability-kids-2': 'Quiz on Recycling',
  'sustainability-kids-3': 'Reflex Recycle',
  'sustainability-kids-4': 'Puzzle: Sort the Waste',
  'sustainability-kids-5': 'Litter Story',
  'sustainability-kids-6': 'Poster: Reduce, Reuse, Recycle',
  'sustainability-kids-7': 'Journal of Recycling',
  'sustainability-kids-8': 'Plastic Bag Story',
  'sustainability-kids-9': 'Reflex Waste Choice',
  'sustainability-kids-10': 'Badge: Eco Helper Kid',
  'sustainability-kids-11': 'Lights Off Story',
  'sustainability-kids-12': 'Quiz on Saving Energy',
  'sustainability-kids-13': 'Reflex Energy Saver',
  'sustainability-kids-14': 'Puzzle: Energy Sources',
  'sustainability-kids-15': 'Water Tap Story',
  'sustainability-kids-16': 'Poster: Save Water',
  'sustainability-kids-17': 'Journal of Green Habits',
  'sustainability-kids-18': 'Tree Planting Story',
  'sustainability-kids-19': 'Reflex Nature Care',
  'sustainability-kids-20': 'Badge: Planet Protector Kid',
  'sustainability-kids-21': 'Ocean Cleanup Story',
  'sustainability-kids-22': 'Quiz on Wildlife Protection',
  'sustainability-kids-23': 'Reflex Clean Air',
  'sustainability-kids-24': 'Puzzle: Green Transportation',
  'sustainability-kids-25': 'Badge: Earth Guardian',
  
  // Sustainability - Teens
  'sustainability-teens-1': 'Climate Action Story',
  'sustainability-teens-2': 'Quiz on Carbon Footprint',
  'sustainability-teens-3': 'Reflex Eco Choice',
  'sustainability-teens-4': 'Puzzle: Sustainable Solutions',
  'sustainability-teens-5': 'Renewable Energy Story',
  'sustainability-teens-6': 'Debate: Fossil Fuels vs Renewables',
  'sustainability-teens-7': 'Journal of Green Living',
  'sustainability-teens-8': 'Simulation: Eco-Friendly City',
  'sustainability-teens-9': 'Reflex Green Habits',
  'sustainability-teens-10': 'Badge: Climate Activist',
  'sustainability-teens-11': 'Waste Reduction Story',
  'sustainability-teens-12': 'Quiz on Circular Economy',
  'sustainability-teens-13': 'Reflex Zero Waste',
  'sustainability-teens-14': 'Puzzle: Waste Hierarchy',
  'sustainability-teens-15': 'Plastic Pollution Story',
  'sustainability-teens-16': 'Debate: Single-Use vs Reusable',
  'sustainability-teens-17': 'Journal of Waste Audit',
  'sustainability-teens-18': 'Simulation: Recycling Program',
  'sustainability-teens-19': 'Reflex Compost Master',
  'sustainability-teens-20': 'Badge: Zero Waste Champion',
  'sustainability-teens-21': 'Biodiversity Conservation Story',
  'sustainability-teens-22': 'Quiz on Sustainable Agriculture',
  'sustainability-teens-23': 'Reflex Ocean Protector',
  'sustainability-teens-24': 'Simulation: Green Community Project',
  'sustainability-teens-25': 'Badge: Sustainability Leader',
};
