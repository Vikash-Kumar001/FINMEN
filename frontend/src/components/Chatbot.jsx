...
//                 setMessages(history);
//                 setChatStreak(history.filter(msg => msg.sender === "user").length);
//             });
...
//         // Simulate chatbot mood changes based on message content
//         const message = input.toLowerCase();
//         if (message.includes("sad") || message.includes("down")) {
//             setChatbotMood("supportive");
//         } else if (message.includes("happy") || message.includes("great")) {
//             setChatbotMood("excited");
//         } else if (message.includes("help") || message.includes("advice")) {
//             setChatbotMood("wise");
//         } else {
//             setChatbotMood("happy");
//         }
...
//             wise: "🧠"
//         };
//         return avatars[chatbotMood] || "🤖";
//     };

//     const getRandomMoodReaction = () => {
//         const reactions = moodReactions[chatbotMood] || moodReactions.happy;
...
//                 ) : (
//                     <motion.div
//                         className="w-96 max-h-[600px] bg-white/95 backdrop-blur-xl shadow-2xl rounded-3xl flex flex-col border border-white/50 overflow-hidden relative"
...
//                                         Online • Level {Math.floor(userXP / 100) + 1}
//                                     </div>
//                                 </div>
//                             </div>
...
//                                             {msg.sender === "bot" && (
//                                                 <motion.div
//                                                     className="w-8 h-8 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 flex items-center justify-center text-white text-sm shadow-lg"
//                                                     whileHover={{ scale: 1.1 }}
//                                                 >
//                                                     {getChatbotAvatar()}
//                                                 </motion.div>
...
//                                                 className="text-yellow-500 mt-1 hover:text-yellow-600 transition-colors"
...
//                                 >
//                                     <div className="w-8 h-8 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 flex items-center justify-center text-white text-sm">
//                                         {getChatbotAvatar()}
//                                     </div>
...
//                                     className="relative z-10 px-6 py-3 bg-gray-50 border-t border-gray-200"
//                                 >
...
//                                     className="p-2 text-gray-500 hover:text-indigo-500 transition-colors rounded-full hover:bg-indigo-50"
//                                     whileHover={{ scale: 1.1 }}
//                                     whileTap={{ scale: 0.9 }}
//                                 >
...
//                                     className="p-2 text-gray-500 hover:text-yellow-500 transition-colors rounded-full hover:bg-yellow-50"
//                                     whileHover={{ scale: 1.1 }}
//                                     whileTap={{ scale: 0.9 }}
//                                 >
...
//                                     className="flex-1 px-4 py-3 text-sm border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white/80 backdrop-blur-sm"
//                                 />
                                
//                                 <motion.button
//                                     type="submit"
//                                     disabled={loading || !input.trim()}
//                                     className="p-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
