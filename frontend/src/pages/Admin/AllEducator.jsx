...
export default function AllEducators() {
    ...
    useEffect(() => {
        logActivity({
            ...
            description: "Viewed All Educators admin dashboard",
            metadata: {
                page: "/admin/educators",
    ...
    const handleEducatorAction = async (action, educatorId, data = {}) => {
        try {
            ...
            await loadEducators(); // Refresh data after action
        } catch (error) {
    ...
    const handleBulkAction = async (action) => {
        ...
        try {
            ...
            await loadEducators(); // Refresh data after bulk action
        } catch (error) {
