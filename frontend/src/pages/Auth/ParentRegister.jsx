        ...
        >
          ...
          >
            <motion.div className="text-center mb-6">
              <motion.div
                className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 mb-3"
                initial={{ rotate: -5 }}
                animate={{ rotate: 0 }}
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-300">Child Email Address *</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                    <Mail className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400" />
                  </div>
              ...
              >
                <span className="flex items-center justify-center">
                  {isLoading ? (
                    ...
                    <>
                      Create Parent Account <ArrowRight className="ml-1 sm:ml-2 h-3 w-3 sm:h-4 sm:w-4" />
                    </>
                  )}
                </span>
              </button>
