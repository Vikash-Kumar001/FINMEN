...
import GameShell, { OptionButton, Confetti, FeedbackBubble, GameCard, ScoreFlash, LevelCompleteHandler } from "./GameShell";
...
const AIInGames = () => {
  ...
  return (
    ...
    >
      ...
      <LevelCompleteHandler gameId="ai-in-games" gameType="ai" levelNumber={currentLevelIndex + 1}>
        <GameCard>
