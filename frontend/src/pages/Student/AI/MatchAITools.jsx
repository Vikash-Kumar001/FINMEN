...
const MatchAITools = () => {
  ...
  const matches = [
    { 
      ...
      options: ['iPhone', 'Android', 'Computer', 'TV'],
      rewardPoints: 5 
    },
    { 
      id: 2, 
      tool: 'Alexa', 
      correctAnswer: 'Echo', 
      options: ['Echo', 'iPhone', 'Computer', 'TV'],
      rewardPoints: 5 
    },
    { 
      id: 3, 
  ...
  return (
    <GameShell title="Match AI Tools" subtitle="Match tools to their devices">
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 mb-6 border border-white/20 shadow-2xl z-10 max-w-3xl mx-auto w-full">
        ...
        <p style={{ fontSize: 'clamp(16px, 3vw, 24px)', fontWeight: 'bold', color: '#333' }}>
          Which device does this work on?
        </p>
      </div>
