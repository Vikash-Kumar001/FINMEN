...
const MatchAIUses = () => {
  ...
  const matches = [
    { 
      ...
      use: 'Voice Assistant', 
      correctAnswer: 'Siri', 
      options: ['Siri', 'Calculator', 'Remote', 'TV'],
      rewardPoints: 5 
    },
    { 
      id: 2, 
      use: 'Smart Speaker', 
      correctAnswer: 'Alexa', 
      options: ['Alexa', 'Radio', 'Phone', 'Computer'],
      rewardPoints: 5 
    },
    { 
      id: 3, 
      ...
      options: ['ChatGPT', 'Email', 'Text', 'Call'],
      rewardPoints: 5 
    },
    { 
      id: 4, 
      ...
      options: ['Google', 'Calculator', 'Phone', 'TV'],
      rewardPoints: 5 
    },
    { 
      id: 5, 
  ...
  const handleOptionClick = (option) => {
    ...
    if (option === currentMatch.correctAnswer) {
      ...
      setScore(prevScore => prevScore + currentMatch.rewardPoints);
      setShowConfetti(true);
    } else {
      setFeedback({
        message: `Wrong! The correct answer is: ${currentMatch.correctAnswer}`,
        type: 'wrong'
      });
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* Title */}
      <div style={titleBoxStyle}>Match AI Uses</div>
      ...
      <div style={scoreTrackerStyle}>
        Score: {score}
        <span style={{ marginLeft: '10px' }}>⭐ {currentLevelIndex + 1}/{matches.length}</span>
      </div>
