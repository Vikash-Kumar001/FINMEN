...
const PredictionPuzzle = () => {
  ...
  const predictions = [
    { 
      id: 1, 
      scenario: '🌤️ It\'s sunny today. What will the weather be tomorrow?', 
      correctAnswer: 'sunny', 
    ...
    { 
      id: 2, 
      scenario: '🍎 You eat an apple every day. What will you eat tomorrow?', 
      correctAnswer: 'apple', 
    ...
    { 
      id: 3, 
      scenario: '📚 You read a book every night. What will you do tonight?', 
      correctAnswer: 'read', 
      options: ['read', 'watch TV', 'play games', 'sleep'],
      rewardPoints: 5 
    },
    { 
      id: 4, 
      scenario: '🚗 You drive to work every day. What will you do tomorrow?', 
      correctAnswer: 'drive', 
      options: ['drive', 'walk', 'bike', 'bus'],
      rewardPoints: 5 
    },
    { 
      id: 5, 
      scenario: '🌙 It\'s dark outside. What time is it?', 
      correctAnswer: 'night', 
  ...
  const handleOptionClick = (option) => {
    ...
    if (option === currentPrediction.correctAnswer) {
      ...
      setScore(prevScore => prevScore + currentPrediction.rewardPoints);
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* Title */}
      <div style={titleBoxStyle}>Prediction Puzzle</div>
      ...
      <div style={scoreTrackerStyle}>
        Score: {score}
        <span style={{ marginLeft: '10px' }}>⭐ {currentLevelIndex + 1}/{predictions.length}</span>
      </div>
