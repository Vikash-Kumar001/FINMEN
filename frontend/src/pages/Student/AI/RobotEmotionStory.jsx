...
const RobotEmotionStory = () => {
  ...
  const scenarios = [
    { 
      id: 1, 
      scenario: '🤖 Robot sees a sad person. What should it do?', 
      correctAnswer: 'comfort them', 
      options: ['comfort them', 'ignore them', 'laugh', 'run away'],
      rewardPoints: 5 
    },
    { 
      id: 2, 
      scenario: '🤖 Robot sees someone happy. What should it do?', 
      correctAnswer: 'celebrate with them', 
      options: ['celebrate with them', 'ignore them', 'get sad', 'run away'],
      rewardPoints: 5 
    },
    { 
      id: 3, 
      scenario: '🤖 Robot sees someone angry. What should it do?', 
      correctAnswer: 'stay calm', 
      options: ['stay calm', 'get angry too', 'ignore them', 'run away'],
      rewardPoints: 5 
    },
    { 
      id: 4, 
      scenario: '🤖 Robot sees someone scared. What should it do?', 
      correctAnswer: 'reassure them', 
      options: ['reassure them', 'scare them more', 'ignore them', 'run away'],
      rewardPoints: 5 
    },
    { 
      id: 5, 
      scenario: '🤖 Robot sees someone excited. What should it do?', 
      correctAnswer: 'share their joy', 
      options: ['share their joy', 'ignore them', 'get sad', 'run away'],
      rewardPoints: 5 
    },
  ];
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* Title */}
      <div style={titleBoxStyle}>Robot Emotion Story</div>
