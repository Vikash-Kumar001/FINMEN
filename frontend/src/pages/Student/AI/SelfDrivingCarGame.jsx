...
const SelfDrivingCarGame = () => {
  ...
  const scenarios = [
    ...
    { 
      id: 2, 
      scenario: '🚶 Person crossing', 
      correctAnswer: 'stop', 
      options: ['stop', 'go', 'slow down', 'honk'],
      rewardPoints: 5 
    },
    { 
      id: 3, 
      ...
      correctAnswer: 'go', 
      options: ['stop', 'go', 'slow down', 'wait'],
      rewardPoints: 5 
    },
    { 
      id: 4, 
      ...
      options: ['stop', 'go', 'slow down', 'turn around'],
      rewardPoints: 5 
    },
    { 
      id: 5, 
      scenario: '🚗 Car in front braking', 
      correctAnswer: 'slow down', 
      options: ['stop', 'go', 'slow down', 'change lanes'],
      rewardPoints: 5 
    },
  ];
  ...
  const handleOptionClick = (option) => {
    ...
    if (option === currentScenario.correctAnswer) {
      setFeedback({ message: 'Great! Safe driving!', type: 'correct' });
  ...
  return (
    <GameShell title="Self-Driving Car" subtitle="Choose the safest action">
