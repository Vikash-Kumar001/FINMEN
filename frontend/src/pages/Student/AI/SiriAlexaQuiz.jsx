...
const SiriAlexaQuiz = () => {
  ...
  const questions = [
    { 
      ...
      options: ['AI assistant', 'robot', 'computer', 'phone'],
      rewardPoints: 5 
    },
    { 
      id: 2, 
    ...
    { 
      id: 3, 
      question: 'Can Siri understand your voice?', 
      correctAnswer: 'yes', 
    ...
    { 
      id: 5, 
      question: 'Do Siri and Alexa learn from you?', 
      correctAnswer: 'yes', 
      options: ['yes', 'no', 'sometimes', 'never'],
      rewardPoints: 5 
    },
  ...
  return (
    <GameShell title="Siri/Alexa Quiz" subtitle="Voice assistants and what they can do">
