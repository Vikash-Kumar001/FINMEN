...
const PatternFinderPuzzle = () => {
  ...
  const puzzles = [
    { id: 1, sequence: ["1", "2", "3", "?", "5"], correct: "4", options: ["3", "4", "5"] },
    { id: 2, sequence: ["2", "4", "6", "?", "10"], correct: "8", options: ["7", "8", "9"] },
    { id: 3, sequence: ["5", "10", "15", "?", "25"], correct: "20", options: ["18", "20", "22"] },
    { id: 4, sequence: ["10", "9", "8", "?", "6"], correct: "7", options: ["6", "7", "8"] },
    { id: 5, sequence: ["1", "1", "2", "3", "?"], correct: "5", options: ["4", "5", "6"] }
  ];
  ...
  const handleNext = () => {
    navigate("/student/ai-for-all/kids/robot-helper-story");
  };
      ...
      <div className="space-y-8">
        {!showResult ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h3 className="text-white text-xl font-bold mb-6 text-center">Find the missing number!</h3>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {score >= 4 ? "🎉 Sequence Master!" : "💪 Keep Trying!"}
            </h2>
            <p className="text-white/90 text-xl mb-4 text-center">
              You found {score} out of {puzzles.length} sequences correctly!
            </p>
            <div className="bg-blue-500/20 rounded-lg p-4 mb-4">
              <p className="text-white/90 text-sm">
                💡 AI uses sequences and patterns to predict what comes next - just like you did!
              </p>
            </div>
