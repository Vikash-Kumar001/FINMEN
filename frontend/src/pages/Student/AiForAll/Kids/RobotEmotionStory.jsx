            ...
            {selectedChoiceData.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Perfect! Even though robots don't have real feelings, being kind to AI teaches us 
                    empathy and good habits. Treating AI with respect makes us better people!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    {selectedChoice === 2
                      ? "Laughing at others (even robots) is not kind. Being empathetic teaches good values!"
                      : "While robots don't have real feelings, being kind to AI helps us practice empathy!"}
                  </p>
                </div>
                <button
