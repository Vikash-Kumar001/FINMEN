        ...
        {!showFeedback ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {selectedChoiceData.isCorrect ? "🌟 Kind to AI!" : "Think Again..."}
            </h2>
            ...
            {selectedChoiceData.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Perfect! Even though robots are machines, it's good to be polite and thankful. 
                    AI helps us with many tasks. Showing appreciation teaches us to be kind!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Being polite to AI helpers teaches us good habits. AI is here to help us, and 
                    saying thank you shows we appreciate the help!
                  </p>
                </div>
                <button
