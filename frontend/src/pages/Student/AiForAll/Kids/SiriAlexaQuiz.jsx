            ...
            {coins > 0 ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Yes! Alexa, Siri, and Google Assistant are all AI! They understand your voice 
                    and help you with tasks. These AI assistants make our lives easier!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Alexa IS an AI! Voice assistants like Alexa, Siri, and Google Assistant use 
                    artificial intelligence to understand and help us!
                  </p>
                </div>
                <button
