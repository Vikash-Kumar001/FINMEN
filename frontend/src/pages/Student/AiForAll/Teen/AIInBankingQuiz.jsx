...
const AIInBankingQuiz = () => {
  ...
  const handleNextQuestion = () => {
    if (currentQuestion < questions.length - 1) {
      ...
      navigate("/student/ai-for-all/teen/ai-in-retail-story");
    }
  };
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            >
              <p className="text-white text-center">
                {selectedChoiceData?.isCorrect
                  ? "AI helps banks detect fraud, assist customers, and manage transactions smartly. 💳🤖"
                  : "Remember, AI supports banking systems — it doesn’t replace human judgement entirely!"}
              </p>
            </div>
