...
const AIVsToolsQuiz = () => {
  ...
  const handleNext = () => {
    navigate("/student/ai-for-all/teen/future-of-ai-reflection"); // Update with next game path
  };
  ...
  return (
    <GameShell
      ...
      subtitle="Separating AI from Automation"
      onNext={handleNext}
            ...
            {coins > 0 ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Correct! A microwave is a tool, not AI. AI involves systems that learn, adapt, and make intelligent decisions, unlike simple automated devices. 🤖❌
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Remember: Tools like microwaves are automated but not AI. AI learns and adapts, while tools follow pre-set instructions. 🔧
                  </p>
                </div>
                <button
