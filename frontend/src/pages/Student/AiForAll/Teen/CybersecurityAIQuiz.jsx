...
const CybersecurityAIQuiz = () => {
  ...
  const handleNextQuestion = () => {
    if (currentQuestion < questions.length - 1) {
      ...
      navigate("/student/ai-for-all/teen/smart-home-simulation"); // update next game path
    }
  };
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            >
              <p className="text-white text-center">
                {selectedChoiceData?.isCorrect
                  ? "Awesome! AI can detect hackers and keep systems safe! 🛡️"
                  : "Remember: AI helps secure digital systems against hackers!"}
              </p>
            </div>
