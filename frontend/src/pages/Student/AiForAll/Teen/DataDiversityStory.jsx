  ...
  const questions = [
    {
      ...
      choices: [
        { id: 1, text: "Add diverse data 👧👦", isCorrect: true },
        { id: 2, text: "Keep only boys' faces 👦", isCorrect: false },
      ],
    },
    {
      ...
      choices: [
        { id: 1, text: "Include girls’ faces 👩", isCorrect: true },
        { id: 2, text: "Ignore issue ❌", isCorrect: false },
      ],
    },
    {
      ...
      choices: [
        { id: 1, text: "Add varied skin tones 🌈", isCorrect: true },
        { id: 2, text: "Use same dataset only 🏷️", isCorrect: false },
      ],
    },
    {
      title: "Age Variety 👶🧓",
      ...
      choices: [
        { id: 1, text: "Include all age groups 👵👴", isCorrect: true },
        { id: 2, text: "Train only on kids 👦", isCorrect: false },
      ],
    },
    {
      title: "Balanced Dataset ⚖️",
      situation: "AI gives biased results favoring one gender. How to balance?",
      choices: [
        { id: 1, text: "Add diverse samples 🧑👩", isCorrect: true },
        { id: 2, text: "Ignore diversity ❌", isCorrect: false },
      ],
    },
  ];
        ...
        {!showFeedback ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {selectedChoiceData?.isCorrect ? "✅ Bias Corrected!" : "❌ Try Again..."}
            </h2>
            ...
            {selectedChoiceData?.isCorrect ? (
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    AI can be biased if data isn’t diverse. Try again to understand data fairness! ⚖️
                  </p>
                </div>
                <button
