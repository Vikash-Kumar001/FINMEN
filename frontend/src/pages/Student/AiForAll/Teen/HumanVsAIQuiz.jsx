            ...
            {coins > 0 ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Yes! Google Translate uses AI (specifically Neural Machine Translation) to 
                    understand context and translate between languages accurately!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Google Translate IS powered by AI! It uses neural networks to learn patterns 
                    in different languages and translate them accurately!
                  </p>
                </div>
                <button
