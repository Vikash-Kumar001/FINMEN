...
import { Brain, Award, Check, X, Zap, Trophy, Star, RotateCcw, Play, Monitor, BookOpenCheck, Clock, Gamepad, PenTool } from 'lucide-react';
...
const BalancedKidBadge = () => {
  ...
  return (
    <GameShell
      title="Balanced Kid Challenge"
      score={score}
      currentLevel={currentLevel}
      totalLevels={5}
      coinsPerLevel={coinsPerLevel}
      gameId="brain-kids-150"
      ...
      totalXp={totalXp}>
      <GameCard>
        <h3 className="text-2xl font-bold text-white mb-2 text-center">Balanced Kid Challenge</h3>
        ...
        {gameState === 'intro' && (
          ...
          >
            ...
            <h4 className="text-xl font-bold text-white mb-2">Become a Digital Balance Master!</h4>
            <p className="text-white/80 mb-6">Complete 5 digital balance challenges to earn your badge</p>
          ...
          >
            ...
            <div className="bg-white/10 rounded-xl p-4 mb-4">
              <div className="text-center text-white mb-2">
                {currentLevel === 1 && "It's tablet time! Which choice shows digital balance?"}
                {currentLevel === 2 && "Answer this question: What's the best screen time limit for kids?"}
                {currentLevel === 3 && "Quick! Is this a balanced digital activity: 'Playing games for 1 hour then going outside'?"}
                {currentLevel === 4 && "Match these screen habits with their effects to learn balance!"}
                {currentLevel === 5 && "You have homework and a game. What's the balanced approach?"}
              </div>
        ...
        {gameState === 'completed' && (
          ...
          >
            ...
            <h4 className="text-2xl font-bold text-white mb-2">Digital Balance Master!</h4>
            <p className="text-white/80 mb-4">You've earned the Balanced Kid Badge!</p>
            ...
            <div className="bg-gradient-to-r from-yellow-500/30 to-orange-500/30 rounded-xl p-4 mb-6 border-2 border-yellow-400">
              ...
              <div className="text-xl font-bold text-white mb-4">Balanced Kid Badge Earned!</div>
              <p className="text-white/90">
                {score >= 80 ? "🏆 Digital Wellness Champion!" : 
                 score >= 60 ? "🥇 Screen Time Expert!" : 
                 score >= 40 ? "🥈 Good Job!" : 
                 "🥉 Keep Practicing!"}
              </p>
            </div>
