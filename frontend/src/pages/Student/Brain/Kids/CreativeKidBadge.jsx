...
import { Brain, Award, Check, X, Zap, Trophy, Star, RotateCcw, Play, Lightbulb, BookOpenCheck, Clock, Puzzle, Users } from 'lucide-react';
...
const CreativeKidBadge = () => {
  ...
  const tasks = [
    { 
      id: 1, 
      title: "Lost Key Challenge", 
      description: "Solve the lost key problem creatively!",
    ...
    { 
      ...
      description: "Test your creative thinking skills!",
      icon: <BookOpenCheck className="w-8 h-8" />,
      color: "bg-purple-500"
    },
    { 
      id: 3, 
      title: "Creative Reflex", 
      description: "Quickly identify creative actions!",
      icon: <Clock className="w-8 h-8" />,
      color: "bg-green-500"
    },
    { 
      id: 4, 
      title: "Solutions Puzzle", 
      description: "Match problems with creative solutions!",
    ...
    { 
      id: 5, 
      title: "Group Story", 
      description: "Work creatively in team scenarios!",
  ...
  return (
    <GameShell
      title="Creative Kid Challenge"
      score={score}
      currentLevel={currentLevel}
      totalLevels={5}
      coinsPerLevel={coinsPerLevel}
      gameId="brain-kids-170"
      ...
      totalXp={totalXp}>
      <GameCard>
        <h3 className="text-2xl font-bold text-white mb-2 text-center">Creative Kid Challenge</h3>
        ...
        {gameState === 'intro' && (
          ...
          >
            ...
            <h4 className="text-xl font-bold text-white mb-2">Become a Creative Genius!</h4>
            <p className="text-white/80 mb-6">Complete 5 creative challenges to earn your badge</p>
          ...
          >
            ...
            <div className="bg-white/10 rounded-xl p-4 mb-4">
              <div className="text-center text-white mb-2">
                {currentLevel === 1 && "It's time to solve the lost key problem creatively! What would you do?"}
                {currentLevel === 2 && "Answer this creativity question: What makes an idea truly creative?"}
                {currentLevel === 3 && "Quick! Is this a creative action: 'Thinking of a new way to solve a problem'?"}
                {currentLevel === 4 && "Match these problems with their creative solutions to unlock your potential!"}
                {currentLevel === 5 && "Work with your team to come up with a creative solution for this group project!"}
              </div>
        ...
        {gameState === 'completed' && (
          ...
          >
            ...
            <h4 className="text-2xl font-bold text-white mb-2">Creative Genius!</h4>
            <p className="text-white/80 mb-4">You've earned the Creative Kid Badge!</p>
            ...
            <div className="bg-gradient-to-r from-yellow-500/30 to-orange-500/30 rounded-xl p-4 mb-6 border-2 border-yellow-400">
              ...
              <div className="text-xl font-bold text-white mb-4">Creative Kid Badge Earned!</div>
              <p className="text-white/90">
                {score >= 80 ? "🏆 Creative Master!" : 
                 score >= 60 ? "🥇 Innovation Expert!" : 
                 score >= 40 ? "🥈 Good Job!" : 
                 "🥉 Keep Practicing!"}
              </p>
            </div>
