...
const DigitalChoiceReflex = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "Is 'Outdoor Play' a balanced activity?",
      action: "Outdoor Play",
      type: "good",
      emoji: "🌳",
    ...
    {
      id: 2,
      question: "Is 'Endless Screens' a balanced activity?",
      action: "Endless Screens",
      type: "bad",
      emoji: "📱",
    ...
    {
      id: 3,
      question: "Is 'Read Book' a balanced activity?",
      action: "Read Book",
      type: "good",
      emoji: "📚",
    ...
    {
      id: 4,
      question: "Is 'Late Gaming' a balanced activity?",
      action: "Late Gaming",
      type: "bad",
      emoji: "🎮",
      icon: <Monitor className="w-8 h-8" />
    ...
    {
      id: 5,
      question: "Is 'Sports' a balanced activity?",
      action: "Sports",
      type: "good",
      emoji: "⚽",
      ...
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Tap for balanced activities, skip for unbalanced ones!</h3>
            <p className="text-white/90 mb-6">You'll see activities. Tap if it's balanced, skip if it's unbalanced.</p>
            <button
              onClick={startGame}
