...
const PositiveNegativeReflex = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "Is 'Hope' a positive word?",
      action: "Hope",
      type: "positive",
      emoji: "🌟",
    ...
    {
      id: 2,
      question: "Is 'Hopeless' a positive word?",
      action: "Hopeless",
      type: "negative",
      emoji: "😔",
    ...
    {
      id: 3,
      question: "Is 'Success' a positive word?",
      action: "Success",
      type: "positive",
      emoji: "🎉",
    ...
    {
      id: 4,
      question: "Is 'Failure' a positive word?",
      action: "Failure",
      type: "negative",
      emoji: "😞",
      icon: <Frown className="w-8 h-8" />
    ...
    {
      id: 5,
      question: "Is 'Grateful' a positive word?",
      action: "Grateful",
      type: "positive",
      emoji: "🙏",
      ...
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Tap for positive words, skip for negative!</h3>
            <p className="text-white/90 mb-6">You'll see words appear. Tap if it's positive, skip if it's negative.</p>
            <button
              onClick={startGame}
