...
const RestAlertReflex = () => {
  ...
  const levelItems = [
    { good: ['Sleep Early', 'Bed by 9'], bad: ['Sleep Late', 'All-night TV'] },
    { good: ['Rest Now', 'Nap Time'], bad: ['Late Games', 'Midnight Chat'] },
    { good: ['Early Bed', 'Quiet Night'], bad: ['Late Party', 'Bright Screen'] },
    { good: ['Sleep Routine', 'Calm Bed'], bad: ['Late Work', 'No Rest'] },
    { good: ['Rest Early', 'Dark Room'], bad: ['Late Calls', 'Stay Up'] }
  ];
  ...
  const handleResponse = (response) => {
    ...
    if (response === correct) {
      ...
      setFeedbackMessage("Good rest habit!");
      setScore(prev => prev + 1);
    } else {
      setFeedbackType("wrong");
      setFeedbackMessage("Bad for rest!");
    }
  ...
  return (
    <GameShell
      ...
      totalXp={totalXp}>
      <GameCard>
        <h3 className="text-2xl font-bold text-white mb-4 text-center">Reflex Rest Alert</h3>
        <p className="text-white/80 mb-6 text-center">Tap for good rest habits.</p>
