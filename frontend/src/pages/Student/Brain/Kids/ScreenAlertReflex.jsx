...
import { Brain, Monitor, Power, Clock } from 'lucide-react';
...
const ScreenAlertReflex = () => {
  ...
  const levelItems = [
    { good: ['Log Off', 'Screen Break'], bad: ['Keep Scrolling', 'Game All Day'] },
    { good: ['Turn Off', 'Rest Eyes'], bad: ['Watch More', 'Social Media'] },
    { good: ['Stop Screen', 'Go Outside'], bad: ['Endless Videos', 'Chat Online'] },
    { good: ['Power Down', 'Play Out'], bad: ['Nonstop Games', 'Scroll Night'] },
    { good: ['Screen Off', 'Read Book'], bad: ['More Screen', 'Late Browsing'] }
  ];
