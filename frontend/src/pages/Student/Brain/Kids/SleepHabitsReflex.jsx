...
import { Moon, Gamepad, Clock, Bed, Tv, Coffee } from 'lucide-react';
...
const SleepHabitsReflex = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "Is 'Bedtime' a good sleep habit?",
      action: "Bedtime",
      type: "good",
      emoji: "🌙",
    ...
    {
      id: 2,
      question: "Is 'Late Gaming' a good sleep habit?",
      action: "Late Gaming",
      type: "bad",
      emoji: "🎮",
    ...
    {
      id: 3,
      question: "Is 'Early Sleep' a good sleep habit?",
      action: "Early Sleep",
      type: "good",
      emoji: "😴",
    ...
    {
      id: 4,
      question: "Is 'All-night Chat' a good sleep habit?",
      action: "All-night Chat",
      type: "bad",
      emoji: "💬",
    ...
    {
      id: 5,
      question: "Is 'Quiet Time' a good sleep habit?",
      action: "Quiet Time",
      type: "good",
      emoji: "🧘",
      ...
      <div className="space-y-8">
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Tap for good sleep habits, skip for bad ones!</h3>
            <p className="text-white/90 mb-6">You'll see sleep habits. Tap if it's good, skip if it's bad.</p>
            <button
              onClick={startGame}
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-white/90 text-sm">Good habit</p>
              </button>
              ...
              >
                ...
                <p className="text-white/90 text-sm">Bad habit</p>
              </button>
            </div>
          </div>
        )}
