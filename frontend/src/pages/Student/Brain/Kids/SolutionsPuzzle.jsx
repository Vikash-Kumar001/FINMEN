...
import { Brain, Pencil, Droplet, Wrench, Frown, Brush, Trophy, RotateCcw, Smile, Clock } from 'lucide-react';
...
const SolutionsPuzzle = () => {
  ...
  const problemSolutions = [
    { 
      problem: { Icon: Pencil, label: "Broken Pencil", color: "bg-yellow-500" }, 
      solution: { Icon: Wrench, label: "Borrow", color: "bg-blue-500" },
      pairId: 1
    },
    { 
      problem: { Icon: Droplet, label: "Spilled Water", color: "bg-blue-500" }, 
      solution: { Icon: Brush, label: "Clean", color: "bg-green-500" },
      pairId: 2
    },
    { 
      problem: { Icon: Frown, label: "Sad Friend", color: "bg-purple-500" }, 
      solution: { Icon: Smile, label: "Cheer Up", color: "bg-pink-500" },
      pairId: 3
    },
    { 
      problem: { Icon: Clock, label: "Late Start", color: "bg-red-500" }, 
      solution: { Icon: Clock, label: "Wake Early", color: "bg-orange-500" },
      pairId: 4
    }
  ];
  ...
  useEffect(() => {
    ...
    // Create pairs of problem-solutions
    let levelPairsArray = [];
    for (let i = 0; i < numPairs; i++) {
      const pair = problemSolutions[i % problemSolutions.length];
  ...
  const handleFlip = (id) => {
    ...
    if (newFlipped.length === 2) {
      ...
      if (firstCard.pairId === secondCard.pairId && firstCard.isProblem !== secondCard.isProblem) {
        // Match found
        ...
        setFeedbackMessage(`Solution found! +${10 + streak * 2} points`);
        setShowFeedback(true);
  ...
  return (
    <GameShell
      title="Solutions Memory Puzzle"
      score={score}
      currentLevel={currentLevel}
      totalLevels={5}
      coinsPerLevel={coinsPerLevel}
      gameId="brain-kids-164"
      ...
      totalXp={totalXp}>
      <GameCard>
        <h3 className="text-2xl font-bold text-white mb-2 text-center">Solutions Memory Puzzle</h3>
        <p className="text-white/80 mb-4 text-center">Match problems with their solutions!</p>
        ...
        {levelCompleted && (
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white mb-2">Problem-Solving Master!</h3>
            <p className="text-white/80 mb-4">You've mastered creative solutions with {score} points!</p>
            ...
            <div className="bg-gradient-to-r from-yellow-500/30 to-orange-500/30 rounded-xl p-4 mb-6 border-2 border-yellow-400">
              ...
              <div className="text-xl font-bold text-white mb-4">Solutions Expert Badge</div>
              <p className="text-white/90">
                {score >= 100 ? "🏆 Creative Genius!" : 
                 score >= 80 ? "🥇 Problem-Solving Pro!" : 
                 score >= 60 ? "🥈 Good Job!" : 
                 "🥉 Keep Practicing!"}
              </p>
            </div>
