...
const kidBrainGames = {
  ...
  'quiz-on-feelings': FeelingsQuizz,
  'reflex-emotions': ReflexEmotions,
  'match-feelings': MatchFeelingsPuzzle,
  'sharing-story': SharingStory,
  'poster-feelings-matter': FeelingsMatterPoster,
  'journal-of-feelings': FeelingsJournal,
  'lost-game-story': LostGameStory,
  'reflex-quick-emotion': QuickEmotionReflex,
  'badge-emotion-kid': EmotionKidBadge,

  // Sixth set of 10 games (positivity focused)
  'rainy-day-story': RainyDayStory,
  'quiz-on-positivity': PositivityQuiz,
  'reflex-happy-thoughts': HappyThoughtsReflex,
  'puzzle-of-positive-words': PositiveWordsPuzzle,
  'lost-match-story': LostMatchStory,
  'poster-stay-positive': StayPositivePoster,
  'journal-of-good-things': GoodThingsJournal,
  'homework-positive-story': Homeworkk,
  'reflex-positive-negative': PositiveNegativeReflex,
  'badge-positive-kid': PositiveKidBadge,

  // Seventh set of 10 games (sleep focused)
  'bedtime-story': BedtimeStory,
  'quiz-sleep': SleepQuiz,
  'reflex-sleep-habits': SleepHabitsReflex,
  'puzzle-rest': RestPuzzle,
  'exam-stori': ExamStori,
  'poster-sleep-well': SleepWellPoster,
  'journal-rest': RestJournal,
  'holiday-story': HolidayStory,
  'reflex-rest-alert': RestAlertReflex,
  'badge-sleep-champ': SleepChampBadge,

  // Eighth set of 10 games (digital balance focused)
  'tablet-story': TabletStory,
  'quiz-screens': ScreensQuiz,
  'reflex-digital-choice': DigitalChoiceReflex,
  'puzzle-balance': BalancePuzzle,
  'homework-balance-story': HomeworkStories,
  'poster-balance-tech': BalanceTechPoster,
  'journal-screen-use': ScreenUseJournal,
  'outdoor-story': OutdoorStory,
  'reflex-screen-alert': ScreenAlertReflex,
  'badge-balanced-kid': BalancedKidBadge,

  // Ninth set of 10 games (creativity focused)
  'lost-key-story': LostKeyStory,
  'quiz-creativity': CreativityQuiz,
  'reflex-problem-solver': ProblemSolverReflex,
  'puzzle-solutions': SolutionsPuzzle,
  'group-story': GroupStory,
  'poster-be-creative': BeCreativePoster,
  'journal-ideas': IdeasJournal,
  'art-story': ArtStory,
  'reflex-creative-thinking': CreativeThinkingReflex,
  'badge-creative-kid': CreativeKidBadge,

  // Tenth set of 10 games (resilience focused)
  'fall-story': FallStory,
  'quiz-resilience': ResilienceQuiz,
  'reflex-try-again': TryAgainReflex,
  'puzzle-resilience': ResiliencePuzzle,
