...
import { Smartphone, Zap, Award, Star, Trophy } from 'lucide-react';
import { motion } from 'framer-motion';

const BadgeDigitalHero = () => {
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "brain-teens-80";
  ...
  const challenges = [
    {
      ...
      description: "Master your screen time!",
      icon: <Smartphone className="w-8 h-8" />,
      color: "bg-indigo-500",
      question: "What's the best way to manage daily screen time?",
      options: [
        { 
          text: "Set limits and take regular breaks", 
          emoji: "⏰", 
          isCorrect: true
        },
        { 
          text: "Use screens all day without limits", 
          emoji: "📱", 
          isCorrect: false
        },
        { 
        ...
        { 
          text: "Ignore time limits completely", 
          emoji: "😵", 
          isCorrect: false
        }
      ]
    },
    {
      id: 2,
      title: "Digital Detox",
      description: "Show healthy tech habits!",
      ...
      options: [
        ...
        { 
          text: "Ignore health recommendations", 
          emoji: "⚠️", 
          isCorrect: false
        }
      ]
    ...
    {
      id: 3,
      title: "Tech-Life Balance",
      description: "Demonstrate balance!",
    ...
    {
      id: 4,
      title: "Nighttime Tech Control",
      description: "Control nighttime device use!",
      icon: <Star className="w-8 h-8" />,
      color: "bg-teal-500",
      question: "What's the best practice for devices at night?",
      options: [
        { 
          text: "Turn off devices before bed", 
          emoji: "🌙", 
          isCorrect: true
        },
        { 
          text: "Use devices until late at night", 
          emoji: "📱", 
          isCorrect: false
        },
        { 
        ...
        { 
          text: "Use bright screens before sleep", 
          emoji: "💡", 
          isCorrect: false
        }
      ]
    ...
    {
      id: 5,
      title: "Digital Hero Mastery",
      description: "Become a digital hero!",
      ...
      options: [
        ...
        { 
          text: "Ignoring health recommendations", 
          emoji: "😐", 
          isCorrect: false
        },
        { 
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Badge: Digital Hero game completed! Score: ${score}/${challenges.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
      ...
      <div className="space-y-8 max-w-4xl mx-auto px-4">
        {!showResult && currentChallenge ? (
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">Digital Hero Badge Earned!</h3>
            <p className="text-white/90 text-base md:text-lg mb-6">
              You've demonstrated excellent digital balance by handling {score} out of {challenges.length} challenges successfully!
            </p>
...
export default BadgeDigitalHero;
