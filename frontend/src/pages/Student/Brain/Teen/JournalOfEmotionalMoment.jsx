...
const JournalOfEmotionalMoment = () => {
  ...
  const stages = [
    { 
      id: 1, 
      prompt: "A time I controlled anger was ___.", 
      minLength: 10,
      guidance: "Think about a specific moment when you successfully managed your anger. What did you do? How did it help?"
    },
    { 
      id: 2, 
      prompt: "Describe a time when you helped someone manage their emotions. What did you do?", 
      minLength: 10,
      guidance: "Reflect on when you showed empathy or helped someone through an emotional moment. Consider what actions or words helped."
    },
    { 
      id: 3, 
      prompt: "Write about a time when you felt overwhelmed by emotions. How did you handle it?", 
      minLength: 10,
      guidance: "Think about a challenging emotional moment. What strategies did you use? What would you do differently?"
    },
    { 
      id: 4, 
      prompt: "Describe a moment when expressing your emotions helped improve a situation.", 
      minLength: 10,
      guidance: "Reflect on when sharing your feelings led to a positive outcome, better understanding, or resolution of a conflict."
    },
    { 
      id: 5, 
      prompt: "Write about an emotional moment that taught you something important about yourself.", 
      minLength: 10,
      guidance: "Consider what you learned about your emotional patterns, triggers, or strengths from a specific emotional experience."
    }
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Emotional Moment game completed! Score: ${score}/${stages.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
