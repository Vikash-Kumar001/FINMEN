...
const JournalOfStressRelief = () => {
  ...
  const stages = [
    { 
      id: 1, 
      prompt: "One way I reduce stress is ___.", 
      minLength: 10,
      guidance: "Think about specific activities or techniques that help you feel calmer and more relaxed, such as exercise, hobbies, or relaxation methods."
    },
    { 
      id: 2, 
      prompt: "Describe a time when you successfully managed a stressful situation. What did you do?", 
      minLength: 10,
      guidance: "Reflect on a specific instance where you handled stress well. Consider what strategies or actions helped you cope effectively."
    },
    { 
      id: 3, 
      prompt: "What stress relief technique would you like to try that you haven't used before?", 
      minLength: 10,
      guidance: "Consider new methods like meditation, journaling, art therapy, or spending time in nature that you'd like to explore."
    },
    { 
      id: 4, 
      prompt: "How does stress relief help you in your daily life?", 
      minLength: 10,
      guidance: "Think about the practical benefits of managing stress, such as better sleep, improved focus, or healthier relationships."
    },
    { 
      id: 5, 
      prompt: "Write about your favorite stress relief method and why it works well for you.", 
      minLength: 10,
      guidance: "Reflect on which stress management technique resonates most with you and explain why it's effective for your personal needs."
    }
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Stress Relief game completed! Score: ${score}/${stages.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
