...
const JournalOfTricks = () => {
  ...
  const stages = [
    { 
      id: 1, 
      prompt: "One memory trick I use is ___.", 
      minLength: 10,
      guidance: "Think about specific techniques that help you remember information, such as mnemonics, visualization, or associations."
    },
    { 
      id: 2, 
      prompt: "Describe a time when a memory trick helped you remember something important.", 
      minLength: 10,
      guidance: "Reflect on a specific instance where using a memory technique made a difference in your learning or recall."
    },
    { 
      id: 3, 
      prompt: "What memory trick would you like to try that you haven't used before?", 
      minLength: 10,
      guidance: "Consider techniques like the method of loci, chunking, or creating vivid mental images to enhance memory."
    },
    { 
      id: 4, 
      prompt: "How do memory tricks help you in your daily life or studies?", 
      minLength: 10,
      guidance: "Think about practical applications of memory techniques in school, work, or personal life."
    },
    { 
      id: 5, 
      prompt: "Write about your favorite memory trick and why it works well for you.", 
      minLength: 10,
      guidance: "Reflect on which memory technique resonates most with your learning style and why it's effective for you."
    }
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Tricks game completed! Score: ${score}/${stages.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
