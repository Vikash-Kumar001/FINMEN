...
const JournallOfGratitude = () => {
  ...
  const stages = [
    { 
      id: 1, 
      prompt: "Today I am thankful for ___.", 
      minLength: 10,
      guidance: "Think about something specific you're grateful for today. It could be a person, an experience, an opportunity, or even a small moment of joy."
    },
    { 
      id: 2, 
      prompt: "I'm grateful for this person in my life because ___.", 
      minLength: 10,
      guidance: "Reflect on someone who has made a positive impact on your life. What makes you grateful for them?"
    },
    { 
      id: 3, 
      prompt: "Something good that happened today was ___.", 
      minLength: 10,
      guidance: "Think about a positive moment, achievement, or experience from today. Even small wins count!"
    },
    { 
      id: 4, 
      prompt: "I'm thankful for this opportunity because ___.", 
      minLength: 10,
      guidance: "Consider an opportunity you have - it could be education, friendship, health, or any chance to grow."
    },
    { 
      id: 5, 
      prompt: "One thing I appreciate about myself is ___.", 
      minLength: 10,
      guidance: "Reflect on a quality, skill, or aspect of yourself that you value. Self-appreciation is important too!"
    }
  ];
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Gratitude game completed! Score: ${score}/${stages.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
