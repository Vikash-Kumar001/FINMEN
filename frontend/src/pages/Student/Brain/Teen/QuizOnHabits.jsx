...
const QuizOnHabits = () => {
  ...
  const questions = [
    {
      ...
      choices: [
        { id: 'a', text: 'Balanced diet' },
        { id: 'b', text: 'Sleep late' },
    ...
    },
    {
      ...
      choices: [
        { id: 'a', text: 'Damages brain cells' },
        { id: 'b', text: 'Improves memory' },
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Quiz on Habits game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
