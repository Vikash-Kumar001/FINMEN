  ...
  const challenges = [
    {
      ...
      options: [
        "Making fun of traditional foods",
        "Learning about cultural holidays and celebrations",
        "Avoiding people who look different"
      ],
      correctAnswer: "Learning about cultural holidays and celebrations",
      explanation: "Learning about cultural holidays and celebrations shows genuine interest and respect for other cultures!"
    },
    {
      id: 2,
      type: "trueFalse",
      ...
      correctAnswer: "false",
      explanation: "False! Stereotypes are oversimplified beliefs that can be harmful and disrespectful to people from other cultures."
    },
    {
      id: 3,
      type: "fillBlank",
      question: "One way to be a culture friend is by _______ with people from different backgrounds.",
      correctAnswer: "communicating",
      explanation: "Communicating with people from different backgrounds helps build understanding and friendship!"
    },
    {
      id: 4,
      type: "scenario",
      ...
      options: [
        "Join in with the exclusion to fit in",
        "Include them in conversations and be patient",
        "Tell them to speak 'properly'"
      ],
      correctAnswer: "Include them in conversations and be patient",
      explanation: "Including them and being patient shows kindness and helps create an inclusive environment for everyone!"
    },
    {
      id: 5,
      type: "multipleChoice",
      ...
      options: [
        "It makes the world more boring",
        "It helps create understanding and peace",
        "It's only important for adults"
      ],
      correctAnswer: "It helps create understanding and peace",
      explanation: "Respecting cultural differences helps create understanding and peace by building bridges between communities!"
    }
  ];
  ...
  if (gameFinished) {
    return (
      <GameShell
        ...
        showGameOver={true}
        gameId="civic-responsibility-kids-90"
      ...
      >
        <div className="text-center p-8">
          ...
          <h2 className="text-2xl font-bold mb-4">Culture Friend Kid</h2>
          <p className="text-white/80 mb-6">
            You've completed all cultural awareness challenges!
          </p>
          <div className="text-yellow-400 font-bold text-lg mb-8">
            You've earned your Culture Friend Kid Badge!
          </div>
          <button
            onClick={handleNext}
