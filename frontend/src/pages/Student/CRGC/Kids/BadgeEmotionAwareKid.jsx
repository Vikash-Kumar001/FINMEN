  ...
  const challenges = [
    {
      ...
      correctAnswer: "Listen and offer support",
      explanation: "Listening and offering support shows empathy and emotional intelligence!"
    },
    {
      id: 2,
      type: "trueFalse",
      ...
      correctAnswer: "true",
      explanation: "Yes! Expressing emotions appropriately is a key part of emotional intelligence."
    },
    {
      id: 3,
      type: "fillBlank",
      question: "When you feel angry, it's helpful to take ____ breaths.",
      correctAnswer: "deep",
      explanation: "Taking deep breaths activates your body's relaxation response and helps manage anger."
    },
    {
      id: 4,
      type: "scenario",
      ...
      options: [
        ...
        "Make fun of their nervousness"
      ],
      correctAnswer: "Offer encouraging words",
      explanation: "Offering encouragement shows empathy and can help reduce someone's anxiety."
    },
    {
      id: 5,
      type: "multipleChoice",
      ...
      correctAnswer: "Take a break and reassess",
      explanation: "Taking a break allows you to cool down and approach challenges with a fresh perspective."
    }
  ];
  ...
  if (gameFinished) {
    return (
      <GameShell
        ...
        showGameOver={true}
        gameId="civic-responsibility-kids-50"
      ...
      totalXp={totalXp}>
        <div className="text-center p-8">
          ...
          <h2 className="text-2xl font-bold mb-4">Emotion Aware Kid</h2>
          <p className="text-white/80 mb-6">
            You've completed all emotional intelligence challenges!
          </p>
          <div className="text-yellow-400 font-bold text-lg mb-8">
            You've earned your Emotion Aware Kid Badge!
          </div>
          <button
            onClick={handleNext}
