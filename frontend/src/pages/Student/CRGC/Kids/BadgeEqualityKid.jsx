  ...
  const challenges = [
    {
      ...
      options: [
        "Only boys can be class monitors",
        "Both boys and girls take turns being class monitors",
        "Only girls help with classroom cleaning"
      ],
      correctAnswer: "Both boys and girls take turns being class monitors",
      explanation: "Taking turns ensures everyone has equal opportunities to develop leadership skills!"
    },
    {
      id: 2,
      type: "trueFalse",
      ...
      correctAnswer: "true",
      explanation: "Yes! Education is a fundamental right for all children, regardless of gender."
    },
    {
      id: 3,
      type: "fillBlank",
      question: "Equal treatment at home means sharing _____ fairly.",
      correctAnswer: "responsibilities",
      explanation: "Sharing household responsibilities fairly teaches everyone important life skills."
    },
    {
      id: 4,
      type: "scenario",
      ...
      options: [
        ...
        "Explain that anyone can be good at math with practice",
        "Stay quiet to avoid conflict"
      ],
      correctAnswer: "Explain that anyone can be good at math with practice",
      explanation: "Mathematical ability isn't determined by gender - everyone can excel with effort!"
    },
    {
      id: 5,
      type: "multipleChoice",
      ...
      options: [
        ...
        "It creates a fair and inclusive environment for everyone",
        "It helps ignore others' differences"
      ],
      correctAnswer: "It creates a fair and inclusive environment for everyone",
      explanation: "Treating everyone equally creates an environment where everyone feels valued and can thrive!"
    }
  ];
  ...
  if (gameFinished) {
    return (
      <GameShell
        ...
        showGameOver={true}
        gameId="civic-responsibility-kids-30"
      ...
      totalXp={totalXp}>
        <div className="text-center p-8">
          ...
          <h2 className="text-2xl font-bold mb-4">Equality Kid</h2>
          <p className="text-white/80 mb-6">
            You've completed all equality challenges!
          </p>
          <div className="text-yellow-400 font-bold text-lg mb-8">
            You've earned your Equality Kid Badge!
          </div>
          <button
            onClick={handleNext}
