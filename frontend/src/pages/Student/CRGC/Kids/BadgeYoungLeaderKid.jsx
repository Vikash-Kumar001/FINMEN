  ...
  const challenges = [
    {
      ...
      options: [
        ...
        "Complaining about issues without taking action"
      ],
      correctAnswer: "Organizing a neighborhood clean-up",
      explanation: "Organizing a neighborhood clean-up shows initiative and leadership in improving your community!"
    },
    {
      id: 2,
      type: "trueFalse",
      ...
      correctAnswer: "true",
      explanation: "Yes! Admitting mistakes shows integrity and helps leaders learn and grow."
    },
    {
      id: 3,
      type: "fillBlank",
      question: "One important quality of a good leader is _______.",
      correctAnswer: "responsibility",
      explanation: "Responsibility is essential for leaders because they must be accountable for their actions and decisions."
    },
    {
      id: 4,
      type: "scenario",
      ...
      options: [
        "Let everyone argue until they figure it out",
        "Listen to all ideas and help the group find a solution",
        "Impose your idea without discussion"
      ],
      correctAnswer: "Listen to all ideas and help the group find a solution",
      explanation: "Good leaders facilitate discussion and help groups find solutions that everyone can support!"
    },
    {
      id: 5,
      type: "multipleChoice",
      ...
      options: [
        "To boss other kids around",
        "To help create positive changes in their communities",
        "To avoid doing group work"
      ],
      correctAnswer: "To help create positive changes in their communities",
      explanation: "Leadership skills help kids become active, responsible citizens who can make positive differences in their communities!"
    }
  ];
  ...
  if (gameFinished) {
    return (
      <GameShell
        ...
        showGameOver={true}
        gameId="civic-responsibility-kids-100"
      ...
      >
        <div className="text-center p-8">
          ...
          <h2 className="text-2xl font-bold mb-4">Young Leader Kid</h2>
          <p className="text-white/80 mb-6">
            You've completed all civic leadership challenges!
          </p>
          <div className="text-yellow-400 font-bold text-lg mb-8">
            You've earned your Young Leader Kid Badge!
          </div>
          <button
            onClick={handleNext}
