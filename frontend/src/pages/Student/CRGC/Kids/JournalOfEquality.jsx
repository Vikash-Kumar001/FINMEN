...
const JournalOfEquality = () => {
  ...
  return (
    <GameShell
      ...
      gameId="civic-responsibility-kids-27"
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          {!entrySubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="bg-amber-50/10 p-6 rounded-xl border border-amber-100/20">
                ...
                <p className="text-2xl font-bold text-amber-300 mb-6">
                  "One time I treated boys and girls equally was 
            ...
            <div className="text-center p-8 bg-gradient-to-br from-amber-500/20 to-orange-600/20 rounded-2xl border border-amber-500/30">
              ...
              <p className="text-white/80 mt-4">
                "{journalEntry}" is a wonderful example of promoting equality!
              </p>
            </div>
          )}
          ...
          {!entrySubmitted && (
            <div className="mt-6 p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
              <p className="text-blue-300 text-sm">💡 Tip: Think about times you treated everyone fairly, shared responsibilities equally, or stood up for someone's rights.</p>
            </div>
          )}
        </div>
      </div>
