      ...
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          <h2 className="text-2xl font-bold text-center mb-6 text-white">
            Create a Poster: "Different but United"
          </h2>
          
          <div className="bg-gradient-to-br from-purple-500 to-pink-600 p-8 rounded-2xl text-center mb-8">
            <div className="text-6xl mb-4">🌈</div>
            <h3 className="text-3xl font-bold text-white mb-4">Different but United</h3>
            <p className="text-white/90">
              Draw or design a poster showing how people from different cultures can be united despite their differences!
            </p>
          </div>
          ...
          {!posterCreated ? (
            ...
            <div className="text-center p-6 bg-green-500/20 rounded-xl border border-green-500/30">
              ...
              <p className="text-yellow-300 font-medium mt-2">Badge Unlocked: Culture Artist</p>
            </div>
          )}
          
          <div className="mt-6 text-sm text-white/60">
            <p>Tip: Show your poster to friends and family to teach them about cultural unity!</p>
          </div>
        </div>
      </div>
    </GameShell>
