...
const ReflexAction = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🌟 for 'Lead Clean-Up' or ❌ for 'Ignore Dirt'",
      correctAnswer: '🌟',
      feedback: {
    ...
    {
      id: 2,
      text: "Tap 🌟 for 'Organize Recycling' or ❌ for 'Litter Carelessly'",
      correctAnswer: '🌟',
      feedback: {
    ...
    {
      id: 3,
      text: "Quick! Tap 🌟 for 'Help Classmate' or ❌ for 'Mind Only Self'",
      correctAnswer: '🌟',
      feedback: {
    ...
    {
      id: 4,
      text: "Tap 🌟 for 'Report Safety Issue' or ❌ for 'Hide Problem'",
      correctAnswer: '🌟',
      feedback: {
    ...
    {
      id: 5,
      text: "Quick! Tap 🌟 for 'Start Community Project' or ❌ for 'Wait for Others'",
      correctAnswer: '🌟',
      feedback: {
