...
const ReflexBullyAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🛡️ for 'Stand Against Bully' or ❌ for 'Join Bully'",
      correctAnswer: '🛡️',
      feedback: {
        correct: "Great job! Standing against bullying helps protect others!",
        incorrect: "Remember, joining a bully hurts others. Always stand for what's right!"
      }
    },
    {
      id: 2,
      text: "Tap 🛡️ for 'Tell a Teacher' or ❌ for 'Stay Silent'",
      correctAnswer: '🛡️',
      feedback: {
        correct: "Excellent! Telling a trusted adult helps stop bullying!",
        incorrect: "Staying silent allows bullying to continue. Speaking up is important!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🛡️ for 'Include Everyone' or ❌ for 'Leave Someone Out'",
      correctAnswer: '🛡️',
      feedback: {
        correct: "Perfect! Including everyone creates a welcoming environment!",
        incorrect: "Leaving people out is a form of bullying. Inclusion is always better!"
      }
    },
    {
      id: 4,
      text: "Tap 🛡️ for 'Support the Victim' or ❌ for 'Laugh at Them'",
      correctAnswer: '🛡️',
      feedback: {
        correct: "Well done! Supporting victims helps them feel safe and cared for!",
        incorrect: "Laughing at victims makes them feel worse. Always show kindness!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🛡️ for 'Stop Rumors' or ❌ for 'Spread Them'",
      correctAnswer: '🛡️',
      feedback: {
        correct: "Awesome! Stopping rumors prevents harm to others!",
        incorrect: "Spreading rumors can hurt people's feelings. Always think before you speak!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You're ready to stand up against bullying!
          </div>
          <p className="text-white/80">
            Remember: Always stand up for what's right!
          </p>
        </div>
      </GameShell>
    );
