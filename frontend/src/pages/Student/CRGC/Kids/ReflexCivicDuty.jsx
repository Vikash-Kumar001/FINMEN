...
const ReflexCivicDuty = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🇮🇳 for 'Respect Rules' or ❌ for 'Ignore Duties'",
      correctAnswer: '🇮🇳',
      feedback: {
        correct: "Great job! Respecting rules shows civic responsibility!",
        incorrect: "Remember, ignoring civic duties harms our community!"
      }
    },
    {
      id: 2,
      text: "Tap 🇮🇳 for 'Vote When Old Enough' or ❌ for 'Never Participate'",
      correctAnswer: '🇮🇳',
      feedback: {
        correct: "Excellent! Voting is a key civic duty in a democracy!",
        incorrect: "Not participating in democracy weakens our society!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🇮🇳 for 'Help Neighbors' or ❌ for 'Only Care for Self'",
      correctAnswer: '🇮🇳',
      feedback: {
        correct: "Perfect! Helping neighbors strengthens community bonds!",
        incorrect: "Being selfish weakens the fabric of society!"
      }
    },
    {
      id: 4,
      text: "Tap 🇮🇳 for 'Keep Public Spaces Clean' or ❌ for 'Litter Anywhere'",
      correctAnswer: '🇮🇳',
      feedback: {
        correct: "Well done! Keeping public spaces clean shows respect for shared resources!",
        incorrect: "Littering shows disrespect for our community!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🇮🇳 for 'Follow Traffic Rules' or ❌ for 'Run Red Lights'",
      correctAnswer: '🇮🇳',
      feedback: {
        correct: "Awesome! Following traffic rules keeps everyone safe!",
        incorrect: "Breaking traffic rules endangers lives!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You understand civic duties!
          </div>
          <p className="text-white/80">
            Remember: Civic duties help create a better community for everyone!
          </p>
        </div>
      </GameShell>
    );
