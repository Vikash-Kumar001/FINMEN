...
const ReflexEquality = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 📚 for 'Girls Can Study' or ❌ for 'Girls Stay Home'",
      correctAnswer: '📚',
      feedback: {
        correct: "Great job! Girls can study just as well as boys!",
        incorrect: "Remember, girls have the same right to education as boys!"
      }
    },
    {
      id: 2,
      text: "Tap 📚 for 'Both Genders Can Lead' or ❌ for 'Only Boys Lead'",
      correctAnswer: '📚',
      feedback: {
        correct: "Excellent! Leadership isn't determined by gender!",
        incorrect: "Don't forget that girls can be great leaders too!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 📚 for 'Equal Pay for Equal Work' or ❌ for 'Boys Earn More'",
      correctAnswer: '📚',
      feedback: {
        correct: "Perfect! Equal work deserves equal pay regardless of gender!",
        incorrect: "Equal work should be compensated equally, regardless of gender!"
      }
    },
    {
      id: 4,
      text: "Tap 📚 for 'Shared Household Chores' or ❌ for 'Only Girls Work'",
      correctAnswer: '📚',
      feedback: {
        correct: "Well done! Household responsibilities should be shared!",
        incorrect: "Household chores should be shared fairly between everyone!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 📚 for 'Equal Sports Opportunities' or ❌ for 'Boys Only Play'",
      correctAnswer: '📚',
      feedback: {
        correct: "Awesome! Everyone should have equal sports opportunities!",
        incorrect: "Sports should be open to everyone, regardless of gender!"
      }
    }
  ];
