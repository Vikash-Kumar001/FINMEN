...
const ReflexFeelings = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 💙 for 'Calm Down' or ❌ for 'Get Angry'",
      correctAnswer: '💙',
      feedback: {
        correct: "Great job! Calming down helps you think clearly!",
        incorrect: "Remember, getting angry doesn't solve problems. Staying calm is better!"
      }
    },
    {
      id: 2,
      text: "Tap 💙 for 'Take Deep Breaths' or ❌ for 'Yell at Friends'",
      correctAnswer: '💙',
      feedback: {
        correct: "Excellent! Deep breathing helps manage strong emotions!",
        incorrect: "Yelling at friends hurts relationships. Breathing deeply is much better!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 💙 for 'Talk It Out' or ❌ for 'Ignore Problem'",
      correctAnswer: '💙',
      feedback: {
        correct: "Perfect! Talking things out leads to understanding!",
        incorrect: "Ignoring problems doesn't make them go away. Communication is key!"
      }
    },
    {
      id: 4,
      text: "Tap 💙 for 'Ask for Help' or ❌ for 'Hit Someone'",
      correctAnswer: '💙',
      feedback: {
        correct: "Well done! Asking for help shows strength, not weakness!",
        incorrect: "Hitting someone is never okay. There are always better ways to solve problems!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 💙 for 'Feel Your Emotions' or ❌ for 'Hide Them'",
      correctAnswer: '💙',
      feedback: {
        correct: "Awesome! Recognizing your emotions is the first step to managing them!",
        incorrect: "Hiding emotions can make them stronger. It's okay to feel and express them appropriately!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You know how to manage emotions!
          </div>
          <p className="text-white/80">
            Remember: All feelings are okay, but our actions matter!
          </p>
        </div>
      </GameShell>
    );
