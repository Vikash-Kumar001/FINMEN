...
const ReflexGlobalRespect = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🌐 for 'Learn From Cultures' or ❌ for 'Mock Cultures'",
      correctAnswer: '🌐',
      feedback: {
        correct: "Great job! Learning from cultures broadens our understanding!",
        incorrect: "Remember, mocking cultures shows disrespect and ignorance!"
      }
    },
    {
      id: 2,
      text: "Tap 🌐 for 'Celebrate Diversity' or ❌ for 'Fear Differences'",
      correctAnswer: '🌐',
      feedback: {
        correct: "Excellent! Celebrating diversity makes our world more vibrant!",
        incorrect: "Fearing differences creates division and misunderstanding!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🌐 for 'Share Traditions' or ❌ for 'Hide Customs'",
      correctAnswer: '🌐',
      feedback: {
        correct: "Perfect! Sharing traditions helps build bridges between communities!",
        incorrect: "Hiding customs prevents others from learning and appreciating your culture!"
      }
    },
    {
      id: 4,
      text: "Tap 🌐 for 'Speak Kindly' or ❌ for 'Use Stereotypes'",
      correctAnswer: '🌐',
      feedback: {
        correct: "Well done! Speaking kindly promotes understanding and respect!",
        incorrect: "Using stereotypes creates prejudice and hurts relationships!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🌐 for 'Build Friendships' or ❌ for 'Create Barriers'",
      correctAnswer: '🌐',
      feedback: {
        correct: "Awesome! Building friendships across cultures enriches our lives!",
        incorrect: "Creating barriers limits our opportunities for growth and connection!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You understand global respect!
          </div>
          <p className="text-white/80">
            Remember: Respecting and learning from different cultures helps create a more inclusive world!
          </p>
        </div>
      </GameShell>
    );
