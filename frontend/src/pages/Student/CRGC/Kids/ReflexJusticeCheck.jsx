...
const ReflexJusticeCheck = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap ⚖️ for 'Equal Treatment' or ❌ for 'Unfair Rules'",
      correctAnswer: '⚖️',
      feedback: {
        correct: "Great job! Equal treatment is the foundation of justice!",
        incorrect: "Remember, unfair rules create inequality and injustice!"
      }
    },
    {
      id: 2,
      text: "Tap ⚖️ for 'Fair Chance for All' or ❌ for 'Privileges for Few'",
      correctAnswer: '⚖️',
      feedback: {
        correct: "Excellent! Everyone deserves a fair chance to succeed!",
        incorrect: "Giving privileges to only a few creates unfair advantages!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap ⚖️ for 'Equal Access to Resources' or ❌ for 'Resource Hoarding'",
      correctAnswer: '⚖️',
      feedback: {
        correct: "Perfect! Equal access to resources ensures fairness for all!",
        incorrect: "Hoarding resources creates scarcity for others and is unjust!"
      }
    },
    {
      id: 4,
      text: "Tap ⚖️ for 'Impartial Decisions' or ❌ for 'Biased Judgments'",
      correctAnswer: '⚖️',
      feedback: {
        correct: "Well done! Impartial decisions are essential for justice!",
        incorrect: "Biased judgments favor some over others and violate fairness!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap ⚖️ for 'Equal Opportunities' or ❌ for 'Barriers for Some'",
      correctAnswer: '⚖️',
      feedback: {
        correct: "Awesome! Equal opportunities allow everyone to reach their potential!",
        incorrect: "Creating barriers for some people limits their potential and is unjust!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You understand the principles of justice!
          </div>
          <p className="text-white/80">
            Remember: Justice means fairness and equal treatment for all!
          </p>
        </div>
      </GameShell>
    );
