...
const ReflexRespect = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 👂 for 'Listening' or ❌ for 'Interrupting'",
      correctAnswer: '👂',
      feedback: {
        correct: "Great job! Listening shows respect for others!",
        incorrect: "Remember, interrupting is disrespectful. Listening is much better!"
      }
    },
    {
      id: 2,
      text: "Tap 👂 for 'Being Patient' or ❌ for 'Making Fun of Others'",
      correctAnswer: '👂',
      feedback: {
        correct: "Excellent! Being patient shows respect for others!",
        incorrect: "Don't forget that making fun of others is disrespectful!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 👂 for 'Using Polite Words' or ❌ for 'Being Rude'",
      correctAnswer: '👂',
      feedback: {
        correct: "Perfect! Using polite words shows respect!",
        incorrect: "Being rude doesn't show respect. Polite words are better!"
      }
    },
    {
      id: 4,
      text: "Tap 👂 for 'Including Everyone' or ❌ for 'Leaving Someone Out'",
      correctAnswer: '👂',
      feedback: {
        correct: "Well done! Including everyone shows respect!",
        incorrect: "Leaving people out is disrespectful. Inclusion is important!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 👂 for 'Valuing Opinions' or ❌ for 'Ignoring Others'",
      correctAnswer: '👂',
      feedback: {
        correct: "Awesome! Valuing opinions shows respect!",
        incorrect: "Ignoring others is disrespectful. Valuing opinions is much better!"
      }
    }
  ];
