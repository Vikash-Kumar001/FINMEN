...
const ReflexRights = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 👑 for 'Girls Can Be Leaders' or ❌ for 'Girls Must Be Silent'",
      correctAnswer: '👑',
      feedback: {
        correct: "Great job! Girls can be excellent leaders!",
        incorrect: "Remember, girls have the right to express themselves and lead!"
      }
    },
    {
      id: 2,
      text: "Tap 👑 for 'Equal Education for All' or ❌ for 'Only Boys Study'",
      correctAnswer: '👑',
      feedback: {
        correct: "Excellent! Education is a right for everyone!",
        incorrect: "Don't forget that education is a fundamental right for all children!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 👑 for 'Choose Any Career' or ❌ for 'Limited by Gender'",
      correctAnswer: '👑',
      feedback: {
        correct: "Perfect! Everyone should be free to choose their career!",
        incorrect: "Career choices should never be limited by gender!"
      }
    },
    {
      id: 4,
      text: "Tap 👑 for 'Decide Own Future' or ❌ for 'Others Control Future'",
      correctAnswer: '👑',
      feedback: {
        correct: "Well done! Everyone has the right to decide their own future!",
        incorrect: "Everyone should have the right to make their own life decisions!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 👑 for 'Safe from Harm' or ❌ for 'Accept Unsafe Treatment'",
      correctAnswer: '👑',
      feedback: {
        correct: "Awesome! Everyone has the right to be safe and protected!",
        incorrect: "Everyone deserves to be safe and protected from harm!"
      }
    }
  ];
