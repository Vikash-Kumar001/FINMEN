...
const ReflexRightsAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 📚 for 'Right to Education' or ❌ for 'No School for Girls'",
      correctAnswer: '📚',
      feedback: {
        correct: "Great job! Every child has the right to education regardless of gender!",
        incorrect: "Remember, all children have the right to education. Denying it based on gender is unfair!"
      }
    },
    {
      id: 2,
      text: "Tap 📚 for 'Equal Access to Learning' or ❌ for 'Boys First Always'",
      correctAnswer: '📚',
      feedback: {
        correct: "Excellent! Equal access to learning opportunities is a fundamental right!",
        incorrect: "Prioritizing one gender over another in education violates basic human rights!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 📚 for 'Freedom to Read' or ❌ for 'Censor Books for Girls'",
      correctAnswer: '📚',
      feedback: {
        correct: "Perfect! Freedom to access information and knowledge is essential for everyone!",
        incorrect: "Censoring educational materials based on gender restricts fundamental rights!"
      }
    },
    {
      id: 4,
      text: "Tap 📚 for 'Quality Teaching for All' or ❌ for 'Better Teachers for Boys'",
      correctAnswer: '📚',
      feedback: {
        correct: "Well done! Quality education should be available to all students equally!",
        incorrect: "Providing different quality education based on gender is discriminatory!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 📚 for 'Safe Learning Environment' or ❌ for 'Ignore Bullying'",
      correctAnswer: '📚',
      feedback: {
        correct: "Awesome! Every student deserves to learn in a safe and supportive environment!",
        incorrect: "Ignoring bullying creates an unsafe environment that violates students' rights!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You understand education rights!
          </div>
          <p className="text-white/80">
            Remember: Education is a fundamental right for all children!
          </p>
        </div>
      </GameShell>
    );
