...
const ReflexRuleAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap ✅ for 'Follow Rules' or ❌ for 'Break Rules'",
      correctAnswer: '✅',
      feedback: {
        correct: "Great job! Following rules keeps everyone safe and creates order!",
        incorrect: "Remember, breaking rules can harm yourself and others!"
      }
    },
    {
      id: 2,
      text: "Tap ✅ for 'Respect Traffic Signals' or ❌ for 'Ignore Red Lights'",
      correctAnswer: '✅',
      feedback: {
        correct: "Excellent! Respecting traffic signals prevents accidents!",
        incorrect: "Ignoring traffic signals puts you and others at risk!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap ✅ for 'Obey School Rules' or ❌ for 'Skip Class'",
      correctAnswer: '✅',
      feedback: {
        correct: "Perfect! Following school rules creates a safe learning environment!",
        incorrect: "Skipping class disrupts your education and school秩序!"
      }
    },
    {
      id: 4,
      text: "Tap ✅ for 'Keep Public Spaces Clean' or ❌ for 'Litter Everywhere'",
      correctAnswer: '✅',
      feedback: {
        correct: "Well done! Keeping public spaces clean shows respect for your community!",
        incorrect: "Littering harms the environment and shows disrespect for shared spaces!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap ✅ for 'Help Neighbors' or ❌ for 'Ignore Community Needs'",
      correctAnswer: '✅',
      feedback: {
        correct: "Awesome! Helping neighbors strengthens community bonds!",
        incorrect: "Ignoring community needs weakens the fabric of society!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You understand the importance of following rules!
          </div>
          <p className="text-white/80">
            Remember: Rules exist to keep everyone safe and create order!
          </p>
        </div>
      </GameShell>
    );
