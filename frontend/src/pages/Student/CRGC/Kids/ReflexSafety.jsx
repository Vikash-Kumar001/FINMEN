...
const ReflexSafety = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 📢 for 'Report Bully' or ❌ for 'Stay Silent'",
      correctAnswer: '📢',
      feedback: {
        correct: "Great job! Reporting bullying helps protect others!",
        incorrect: "Remember, staying silent allows bullying to continue. Always speak up!"
      }
    },
    {
      id: 2,
      text: "Tap 📢 for 'Tell Trusted Adult' or ❌ for 'Keep Secret'",
      correctAnswer: '📢',
      feedback: {
        correct: "Excellent! Telling a trusted adult gets help when you need it!",
        incorrect: "Keeping secrets about bullying doesn't help anyone. Adults can help!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 📢 for 'Ask for Help' or ❌ for 'Handle Alone'",
      correctAnswer: '📢',
      feedback: {
        correct: "Perfect! Asking for help is brave and gets you the support you need!",
        incorrect: "Trying to handle serious problems alone can be dangerous. Help is available!"
      }
    },
    {
      id: 4,
      text: "Tap 📢 for 'Stop Cyberbullying' or ❌ for 'Ignore Online'",
      correctAnswer: '📢',
      feedback: {
        correct: "Well done! Reporting cyberbullying stops online harassment!",
        incorrect: "Ignoring cyberbullying allows it to continue hurting people. Report it!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 📢 for 'Support Victim' or ❌ for 'Blame Victim'",
      correctAnswer: '📢',
      feedback: {
        correct: "Awesome! Supporting victims helps them feel safe and cared for!",
        incorrect: "Blaming victims makes them feel worse. Always support those who are hurt!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <p className="text-white/80">
            Remember: Always speak up when you see something wrong!
          </p>
        </div>
      </GameShell>
    );
