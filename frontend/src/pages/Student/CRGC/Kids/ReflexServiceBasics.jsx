...
const ReflexServiceBasics = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🤝 for 'Help Others' or ❌ for 'Ignore Needs'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Great job! Helping others makes the world a better place!",
        incorrect: "Remember, ignoring people in need doesn't help anyone. Helping is always better!"
      }
    },
    {
      id: 2,
      text: "Tap 🤝 for 'Volunteer Time' or ❌ for 'Stay Home'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Excellent! Volunteering your time helps those who need it!",
        incorrect: "Staying home when you could help means missing a chance to make a difference!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🤝 for 'Share Resources' or ❌ for 'Keep Everything'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Perfect! Sharing resources helps ensure everyone has what they need!",
        incorrect: "Keeping everything for yourself doesn't help build a caring community!"
      }
    },
    {
      id: 4,
      text: "Tap 🤝 for 'Listen to Problems' or ❌ for 'Avoid Issues'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Well done! Listening helps you understand how to help others!",
        incorrect: "Avoiding problems doesn't make them go away. Listening is the first step to helping!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🤝 for 'Work as Team' or ❌ for 'Act Alone'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Awesome! Working as a team multiplies your positive impact!",
        incorrect: "Acting alone limits what you can accomplish. Teamwork achieves more!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You know the basics of community service!
          </div>
