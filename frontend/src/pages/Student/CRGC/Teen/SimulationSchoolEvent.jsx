...
const SimulationSchoolEvent = () => {
  ...
  const scenario = {
    title: "School Event",
    emoji: "🎉",
    situation: "Your team is planning a school event. A new classmate wants to join but your teammates exclude her. What should you do?",
    choices: [
      { id: 1, text: "Add her to the team and welcome her ideas", emoji: "🤝", isCorrect: true },
      { id: 2, text: "Ignore her and go with the team", emoji: "🙈", isCorrect: false },
      { id: 3, text: "Laugh along with the exclusion", emoji: "😂", isCorrect: false }
    ]
  };
  ...
  const handleNext = () => {
    navigate("/student/civic-responsibility/teen/reflex-teen-inclusion");
  };
  ...
  return (
    <GameShell
      ...
      subtitle="Practice Inclusion in Action"
      onNext={handleNext}
          ...
          <div className={`p-8 rounded-2xl ${selectedChoiceData?.isCorrect ? 'bg-green-50' : 'bg-red-50'}`}>
            <div className="text-center">
              ...
              <h3 className={`text-2xl font-bold mb-4 ${
                ...
                {selectedChoiceData?.isCorrect ? 'Inclusive Leadership!' : 'Think Again'}
              </h3>
              <p className="text-lg text-gray-700 mb-4">
                {selectedChoiceData?.isCorrect 
                  ? 'Perfect! Standing up for inclusion even when others exclude shows true leadership and compassion!'
                  : 'When others are excluded, it\'s important to stand up and include them. Everyone deserves to be part of the group.'}
              </p>
              {!selectedChoiceData?.isCorrect && (
                <button
