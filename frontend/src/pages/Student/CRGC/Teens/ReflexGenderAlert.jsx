...
const ReflexGenderAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🤝 for 'Equal Respect' or ❌ for 'Unequal Treatment'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Great job! Everyone deserves equal respect regardless of gender!",
        incorrect: "Remember, all people deserve equal treatment and respect!"
      }
    },
    {
      id: 2,
      text: "Tap 💼 for 'Equal Opportunities' or ❌ for 'Gender Barriers'",
      correctAnswer: '💼',
      feedback: {
        correct: "Excellent! Opportunities should be available to everyone equally!",
        incorrect: "Opportunities should never be limited by gender!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🎓 for 'Equal Education' or ❌ for 'Gender Limits'",
      correctAnswer: '🎓',
      feedback: {
        correct: "Perfect! Education is a right for all people regardless of gender!",
        incorrect: "Education should never be restricted based on gender!"
      }
    },
    {
      id: 4,
      text: "Tap 💰 for 'Equal Pay' or ❌ for 'Pay Gap'",
      correctAnswer: '💰',
      feedback: {
        correct: "Well done! Equal work deserves equal pay regardless of gender!",
        incorrect: "Pay should be based on work quality, not gender!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🗳️ for 'Equal Voice' or ❌ for 'Silenced Voices'",
      correctAnswer: '🗳️',
      feedback: {
        correct: "Awesome! Everyone deserves to have their voice heard in decisions!",
        incorrect: "All voices should be heard in democratic processes!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You understand gender equality!
          </div>
