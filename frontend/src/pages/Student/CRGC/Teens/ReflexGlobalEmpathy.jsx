...
const ReflexGlobalEmpathy = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🌐 for 'Support Victims' or ❌ for 'Ignore Others' Pain'",
      correctAnswer: '🌐',
      feedback: {
        correct: "Great job! Supporting victims regardless of where they are shows global empathy!",
        incorrect: "Remember, empathy should extend beyond our immediate circles to all who suffer!"
      }
    },
    {
      id: 2,
      text: "Tap ❤️ for 'Donate to Global Causes' or ❌ for 'Only Care Locally'",
      correctAnswer: '❤️',
      feedback: {
        correct: "Excellent! Contributing to global causes helps address suffering worldwide!",
        incorrect: "Limiting concern to only local issues misses opportunities to help others globally!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🤝 for 'Welcome Refugees' or ❌ for 'Close Borders'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Perfect! Welcoming refugees demonstrates compassion for displaced people!",
        incorrect: "Closing borders to refugees ignores the humanitarian crisis they face!"
      }
    },
    {
      id: 4,
      text: "Tap 🌍 for 'Care About Climate Change' or ❌ for 'Ignore Environmental Impact'",
      correctAnswer: '🌍',
      feedback: {
        correct: "Well done! Recognizing climate change impacts everyone shows global awareness!",
        incorrect: "Ignoring environmental issues affects everyone, especially vulnerable populations!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 📚 for 'Support Global Education' or ❌ for 'Education Only Matters Locally'",
      correctAnswer: '📚',
      feedback: {
        correct: "Awesome! Supporting global education helps create opportunities worldwide!",
        incorrect: "Education is a universal right that should be accessible to all children!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You understand global empathy!
          </div>
          <p className="text-white/80">
            Remember: Empathy should extend to all people, regardless of borders!
          </p>
        </div>
      </GameShell>
    );
