...
const ReflexTeenBullyAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🚫 for 'Block + Report' or ❌ for 'Reply Angrily'",
      correctAnswer: '🚫',
      feedback: {
        correct: "Great job! Blocking and reporting is the safest way to handle cyberbullying!",
        incorrect: "Remember, replying angrily can make cyberbullying worse and put you at risk!"
      }
    },
    {
      id: 2,
      text: "Tap 🛡️ for 'Defend a Victim' or ❌ for 'Join the Bullying'",
      correctAnswer: '🛡️',
      feedback: {
        correct: "Excellent! Standing up for victims helps create a safer environment for everyone!",
        incorrect: "Joining bullying makes you part of the problem and can hurt others deeply!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🗣️ for 'Tell a Trusted Adult' or ❌ for 'Keep It Secret'",
      correctAnswer: '🗣️',
      feedback: {
        correct: "Perfect! Talking to a trusted adult is crucial for stopping bullying effectively!",
        incorrect: "Keeping bullying a secret allows it to continue and can make it worse!"
      }
    },
    {
      id: 4,
      text: "Tap 🤝 for 'Include the Excluded' or ❌ for 'Exclude Others'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Well done! Including others helps build a more welcoming community!",
        incorrect: "Excluding others creates division and can lead to bullying situations!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🚨 for 'Report Serious Threats' or ❌ for 'Ignore Them'",
      correctAnswer: '🚨',
      feedback: {
        correct: "Awesome! Reporting serious threats helps keep everyone safe!",
        incorrect: "Ignoring serious threats can put people in danger and allow harm to occur!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You know how to handle bullying situations!
          </div>
          <p className="text-white/80">
            Remember: Taking action against bullying helps create a safer environment for everyone!
          </p>
        </div>
      </GameShell>
    );
