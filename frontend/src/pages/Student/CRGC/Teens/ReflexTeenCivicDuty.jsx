...
const ReflexTeenCivicDuty = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🌟 for 'Lead With Respect' or ❌ for 'Lead With Fear'",
      correctAnswer: '🌟',
      feedback: {
    ...
    {
      id: 2,
      text: "Tap 🤝 for 'Collaborate for Community' or ❌ for 'Work Alone'",
      correctAnswer: '🤝',
      feedback: {
    ...
    {
      id: 3,
      text: "Quick! Tap 🗳️ for 'Participate in Democracy' or ❌ for 'Ignore Politics'",
      correctAnswer: '🗳️',
      feedback: {
    ...
    {
      id: 4,
      text: "Tap 🌱 for 'Serve Others' or ❌ for 'Only Self-Interest'",
      correctAnswer: '🌱',
      feedback: {
    ...
    {
      id: 5,
      text: "Quick! Tap 🎯 for 'Set Positive Example' or ❌ for 'Negative Influence'",
      correctAnswer: '🎯',
      feedback: {
