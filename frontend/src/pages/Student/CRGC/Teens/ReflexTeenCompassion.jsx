...
const ReflexTeenCompassion = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap ❤️ for 'Donate Clothes' or ❌ for 'Throw Clothes'",
      correctAnswer: '❤️',
      feedback: {
    ...
    {
      id: 2,
      text: "Tap 🍲 for 'Share Food with Needy' or ❌ for 'Waste Food'",
      correctAnswer: '🍲',
      feedback: {
    ...
    {
      id: 3,
      text: "Quick! Tap 🤝 for 'Volunteer Time' or ❌ for 'Ignore Community Needs'",
      correctAnswer: '🤝',
      feedback: {
    ...
    {
      id: 4,
      text: "Tap 📚 for 'Tutor a Struggling Student' or ❌ for 'Ignore Classmate's Struggles'",
      correctAnswer: '📚',
      feedback: {
    ...
    {
      id: 5,
      text: "Quick! Tap 🏠 for 'Help Elderly Neighbor' or ❌ for 'Leave Them Alone'",
      correctAnswer: '🏠',
      feedback: {
