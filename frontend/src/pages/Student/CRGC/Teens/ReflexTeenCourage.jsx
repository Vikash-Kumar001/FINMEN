...
const ReflexTeenCourage = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🗣️ for 'Speak Against Bully' or ❌ for 'Be Silent'",
      correctAnswer: '🗣️',
      feedback: {
        correct: "Great job! Speaking up against bullying shows courage and helps protect others!",
        incorrect: "Remember, staying silent allows bullying to continue and harm others!"
      }
    },
    {
      id: 2,
      text: "Tap 🛡️ for 'Defend Victim' or ❌ for 'Ignore Situation'",
      correctAnswer: '🛡️',
      feedback: {
        correct: "Excellent! Defending victims creates a safer environment for everyone!",
        incorrect: "Ignoring bullying situations leaves victims feeling unsupported and alone!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🚨 for 'Report to Adult' or ❌ for 'Handle Alone'",
      correctAnswer: '🚨',
      feedback: {
        correct: "Perfect! Reporting to adults ensures proper action is taken safely!",
        incorrect: "Trying to handle serious bullying alone can be dangerous and ineffective!"
      }
    },
    {
      id: 4,
      text: "Tap 🤝 for 'Include Excluded' or ❌ for 'Join Exclusion'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Well done! Including others helps build a welcoming community!",
        incorrect: "Joining exclusion creates division and hurts those who are left out!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap ❤️ for 'Show Kindness' or ❌ for 'Be Indifferent'",
      correctAnswer: '❤️',
      feedback: {
        correct: "Awesome! Showing kindness can make a huge difference in someone's day!",
        incorrect: "Being indifferent to others' struggles misses opportunities to help and connect!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You have courage to stand up against bullying!
          </div>
          <p className="text-white/80">
            Remember: Courage to do what's right makes a positive difference in the world!
          </p>
        </div>
      </GameShell>
    );
