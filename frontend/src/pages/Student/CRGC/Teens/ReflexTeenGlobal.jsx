...
const ReflexTeenGlobal = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🤝 for 'Help Across Borders' or ❌ for 'Ignore Others'",
      correctAnswer: '🤝',
      feedback: {
    ...
    {
      id: 2,
      text: "Tap 🌍 for 'Care for Planet' or ❌ for 'Pollute Environment'",
      correctAnswer: '🌍',
      feedback: {
    ...
    {
      id: 3,
      text: "Quick! Tap 📚 for 'Share Knowledge' or ❌ for 'Hide Information'",
      correctAnswer: '📚',
      feedback: {
    ...
    {
      id: 4,
      text: "Tap 🕊️ for 'Promote Peace' or ❌ for 'Incite Conflict'",
      correctAnswer: '🕊️',
      feedback: {
    ...
    {
      id: 5,
      text: "Quick! Tap 🌱 for 'Support Sustainability' or ❌ for 'Waste Resources'",
      correctAnswer: '🌱',
      feedback: {
