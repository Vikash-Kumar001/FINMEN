...
const ReflexTeenInclusion = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap ⚖️ for 'Equal Rights' or ❌ for 'Only Some Deserve'",
      correctAnswer: '⚖️',
      feedback: {
        correct: "Great job! Everyone deserves equal rights regardless of their differences!",
        incorrect: "Remember, equal rights should be given to everyone, not just some!"
      }
    },
    {
      id: 2,
      text: "Tap 🤝 for 'Include Everyone' or ❌ for 'Leave Some Out'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Excellent! Including everyone creates a welcoming and supportive community!",
        incorrect: "Leaving people out creates division and hurt feelings!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🌈 for 'Celebrate Diversity' or ❌ for 'Ignore Differences'",
      correctAnswer: '🌈',
      feedback: {
        correct: "Perfect! Celebrating diversity enriches our communities and broadens our perspectives!",
        incorrect: "Ignoring differences misses opportunities to learn and grow from one another!"
      }
    },
    {
      id: 4,
      text: "Tap 🎓 for 'Equal Education' or ❌ for 'Only Some Learn'",
      correctAnswer: '🎓',
      feedback: {
        correct: "Well done! Equal access to education is a fundamental right for all!",
        incorrect: "Education should be accessible to everyone regardless of their background!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🗳️ for 'Equal Voice' or ❌ for 'Silence Some'",
      correctAnswer: '🗳️',
      feedback: {
        correct: "Awesome! Everyone deserves to have their voice heard and opinions respected!",
        incorrect: "Silencing some voices creates inequality and prevents diverse perspectives!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You understand inclusion!
          </div>
          <p className="text-white/80">
            Remember: Inclusion means ensuring everyone has equal opportunities and feels valued!
          </p>
        </div>
      </GameShell>
    );
