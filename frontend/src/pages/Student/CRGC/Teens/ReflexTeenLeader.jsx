...
const ReflexTeenLeader = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 👂 for 'Listen to Team' or ❌ for 'Ignore Team'",
      correctAnswer: '👂',
      feedback: {
        correct: "Great job! Listening to your team shows respect and helps you make better decisions!",
        incorrect: "Remember, ignoring your team creates disconnection and prevents effective leadership!"
      }
    },
    {
      id: 2,
      text: "Tap 🤝 for 'Support Team Members' or ❌ for 'Criticize Publicly'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Excellent! Supporting team members builds trust and creates a positive environment!",
        incorrect: "Public criticism damages relationships and undermines team morale!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🎯 for 'Set Clear Goals' or ❌ for 'Create Confusion'",
      correctAnswer: '🎯',
      feedback: {
        correct: "Perfect! Clear goals provide direction and help everyone work toward the same objectives!",
        incorrect: "Creating confusion leads to frustration and prevents team success!"
      }
    },
    {
      id: 4,
      text: "Tap 💡 for 'Encourage Ideas' or ❌ for 'Dismiss Suggestions'",
      correctAnswer: '💡',
      feedback: {
        correct: "Well done! Encouraging ideas from team members taps into diverse perspectives and creativity!",
        incorrect: "Dismissing suggestions discourages participation and wastes valuable input!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🏆 for 'Celebrate Success' or ❌ for 'Take All Credit'",
      correctAnswer: '🏆',
      feedback: {
        correct: "Awesome! Celebrating team success builds morale and reinforces positive collaboration!",
        incorrect: "Taking all the credit undermines trust and discourages future contributions!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You're a leadership champion!
          </div>
          <p className="text-white/80">
            Remember: Quick thinking in support of good leadership makes a real difference in team success!
          </p>
        </div>
      </GameShell>
    );
