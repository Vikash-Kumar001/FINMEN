...
const ReflexTeenRespect = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🙋‍♀️ for 'Respect Women' or ❌ for 'Disrespect Women'",
      correctAnswer: '🙋‍♀️',
      feedback: {
        correct: "Great job! Respecting women shows equality and good character!",
        incorrect: "Remember, everyone deserves respect regardless of gender!"
      }
    },
    {
      id: 2,
      text: "Tap 🙋‍♂️ for 'Respect Men' or ❌ for 'Disrespect Men'",
      correctAnswer: '🙋‍♂️',
      feedback: {
        correct: "Excellent! Respecting men shows fairness and maturity!",
        incorrect: "Everyone deserves respect, including men!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 👵 for 'Respect Elderly' or ❌ for 'Disrespect Elderly'",
      correctAnswer: '👵',
      feedback: {
        correct: "Perfect! Respecting elderly people shows wisdom and kindness!",
        incorrect: "Elderly people deserve our respect for their experience and contributions!"
      }
    },
    {
      id: 4,
      text: "Tap 👶 for 'Respect Children' or ❌ for 'Disrespect Children'",
      correctAnswer: '👶',
      feedback: {
        correct: "Well done! Respecting children shows compassion and understanding!",
        incorrect: "Children deserve respect for their potential and innocence!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🧑‍🦱 for 'Respect All People' or ❌ for 'Disrespect Some People'",
      correctAnswer: '🧑‍🦱',
      feedback: {
        correct: "Awesome! Respecting all people shows true character and inclusion!",
        incorrect: "Everyone deserves respect regardless of their differences!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <p className="text-white/80">
            Remember: Respect should be given to everyone regardless of their differences!
          </p>
        </div>
      </GameShell>
    );
