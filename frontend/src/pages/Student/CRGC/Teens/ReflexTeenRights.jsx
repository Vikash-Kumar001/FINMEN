...
const ReflexTeenRights = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 💼 for 'Equal Opportunities' or ❌ for 'Only Boys Allowed'",
      correctAnswer: '💼',
      feedback: {
        correct: "Great job! Everyone deserves equal opportunities regardless of gender!",
        incorrect: "Remember, equal opportunities should be available to all, not just one gender!"
      }
    },
    {
      id: 2,
      text: "Tap 🎓 for 'Equal Education' or ❌ for 'Girls Don't Need School'",
      correctAnswer: '🎓',
      feedback: {
        correct: "Excellent! Education is a fundamental right for everyone!",
        incorrect: "Education should never be denied based on gender!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 💰 for 'Equal Pay' or ❌ for 'Men Earn More'",
      correctAnswer: '💰',
      feedback: {
        correct: "Perfect! Equal pay for equal work is a basic right!",
        incorrect: "Pay should be based on work quality, not gender!"
      }
    },
    {
      id: 4,
      text: "Tap 🗳️ for 'Equal Voice' or ❌ for 'Only Men Vote'",
      correctAnswer: '🗳️',
      feedback: {
        correct: "Well done! Everyone deserves to have their voice heard in decisions!",
        incorrect: "Political participation should never be limited by gender!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 👑 for 'Leadership Has No Gender' or ❌ for 'Only Men Lead'",
      correctAnswer: '👑',
      feedback: {
        correct: "Awesome! Leadership qualities exist in people of all genders!",
        incorrect: "Leadership ability should never be determined by gender!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You understand gender rights!
          </div>
          <p className="text-white/80">
            Remember: Gender equality means equal rights and opportunities for all!
          </p>
        </div>
      </GameShell>
    );
