...
const ReflexTeenVolunteer = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🌱 for 'Plant Trees' or ❌ for 'Cut Trees'",
      correctAnswer: '🌱',
      feedback: {
        correct: "Great job! Planting trees helps the environment and future generations!",
        incorrect: "Remember, cutting down trees harms the environment and reduces oxygen production!"
      }
    },
    {
      id: 2,
      text: "Tap 🤝 for 'Help Community' or ❌ for 'Ignore Needs'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Excellent! Helping your community builds stronger bonds and improves everyone's quality of life!",
        incorrect: "Ignoring community needs prevents positive change and social progress!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 📚 for 'Tutor Students' or ❌ for 'Discourage Learning'",
      correctAnswer: '📚',
      feedback: {
        correct: "Perfect! Tutoring helps others gain knowledge and reach their potential!",
        incorrect: "Discouraging learning limits others' opportunities and personal growth!"
      }
    },
    {
      id: 4,
      text: "Tap 🍽️ for 'Feed Hungry' or ❌ for 'Waste Food'",
      correctAnswer: '🍽️',
      feedback: {
        correct: "Well done! Feeding the hungry addresses basic needs and shows compassion!",
        incorrect: "Wasting food while others are hungry is disrespectful and irresponsible!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🏥 for 'Support Hospital' or ❌ for 'Spread Illness'",
      correctAnswer: '🏥',
      feedback: {
        correct: "Awesome! Supporting healthcare helps protect and heal members of our community!",
        incorrect: "Spreading illness endangers others and puts strain on healthcare systems!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg mb-4">
            You're a volunteering champion!
          </div>
          <p className="text-white/80">
            Remember: Quick thinking in support of positive actions makes a real difference!
          </p>
        </div>
      </GameShell>
    );
