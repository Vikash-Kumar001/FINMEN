  ...
  const questions = [
    {
      ...
      options: [
        { 
          id: "a", 
          text: "No, never share with strangers", 
          emoji: "🛡️",
          isCorrect: true
        },
        { 
          id: "b", 
          text: "Yes, it's okay to share", 
          emoji: "👍",
          isCorrect: false
        },
        { 
    ...
    },
    {
      ...
      options: [
        ...
        { 
          id: "b", 
          text: "No, never share with people you don't know well", 
          emoji: "🛡️",
          isCorrect: true
        },
        { 
    ...
    },
    {
      ...
      options: [
        { 
          id: "a", 
          text: "No, always lock your device", 
          emoji: "🛡️",
          isCorrect: true
        },
        { 
