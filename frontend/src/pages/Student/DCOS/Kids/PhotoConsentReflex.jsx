      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] w-full px-4">
        {!gameStarted ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 text-center w-full max-w-2xl">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Tap Fast, Be Respectful! 📸</h2>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl">
            <div className="text-6xl md:text-8xl mb-4 text-center animate-pulse">{currentScenario.emoji}</div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="text-white font-bold text-xl md:text-2xl">Ask Permission ✅</div>
              </button>
              <button
              ...
              >
                <div className="text-white font-bold text-xl md:text-2xl">Post 📤</div>
              </button>
            </div>
          </div>
        ) : (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              {score === scenarios.length ? "Perfect Photo Respect Hero! 🎉" : `You got ${score} out of ${scenarios.length}!`}
            </h2>
            <p className="text-white/90 text-lg mb-4">
              {score === scenarios.length 
                ? "Excellent! You always ask permission before posting photos of friends or others!"
