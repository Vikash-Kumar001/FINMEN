...
const PicturePuzzle = () => {
  ...
  const items = [
    ...
    { id: 2, item: "Official School Notice Image", emoji: "🏫", correctCategory: "Real News" },
    { id: 3, item: "Celebrity with Wings Photo", emoji: "😇", correctCategory: "Fake News" },
    { id: 4, item: "Photo from School Sports Day", emoji: "🏅", correctCategory: "Real News" },
    { id: 5, item: "Image Claiming 'Cows Can Talk'", emoji: "🐮", correctCategory: "Fake News" }
  ];
