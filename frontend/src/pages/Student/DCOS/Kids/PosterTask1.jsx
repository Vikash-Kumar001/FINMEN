  ...
  const stages = [
    {
      ...
      messages: [
        { id: 1, text: "Think Before You Post!", emoji: "💭", color: "from-purple-400 to-pink-400", isCorrect: true },
        { id: 2, text: "Post Everything!", emoji: "📤", color: "from-blue-400 to-cyan-400", isCorrect: false },
        { id: 3, text: "Don't Think!", emoji: "⚡", color: "from-orange-400 to-yellow-400", isCorrect: false }
      ],
      correctMessage: 1
    },
    {
      ...
      messages: [
        { id: 1, text: "Kind Words Cost Nothing 💬", emoji: "💖", color: "from-pink-400 to-red-400", isCorrect: true },
        { id: 2, text: "Be Mean Online!", emoji: "😠", color: "from-blue-400 to-indigo-400", isCorrect: false },
        { id: 3, text: "Ignore Others!", emoji: "🙄", color: "from-green-400 to-teal-400", isCorrect: false }
      ],
      correctMessage: 1
    },
    {
      ...
      messages: [
        { id: 1, text: "Ask Before You Share!", emoji: "📸", color: "from-yellow-400 to-orange-400", isCorrect: true },
        { id: 2, text: "Share Everything!", emoji: "📢", color: "from-purple-400 to-blue-400", isCorrect: false },
        { id: 3, text: "Ignore Privacy!", emoji: "🙈", color: "from-teal-400 to-green-400", isCorrect: false }
      ],
      correctMessage: 1
    },
    {
      ...
      messages: [
        { id: 1, text: "Stay Smart. Stay Safe Online!", emoji: "🛡️", color: "from-indigo-400 to-blue-500", isCorrect: true },
        { id: 2, text: "Share Passwords!", emoji: "🔓", color: "from-orange-400 to-red-400", isCorrect: false },
        { id: 3, text: "Click Everything!", emoji: "🖱️", color: "from-green-400 to-emerald-400", isCorrect: false }
      ],
      correctMessage: 1
    },
    {
      ...
      messages: [
        { id: 1, text: "Be a Responsible Digital Citizen!", emoji: "🌍", color: "from-blue-400 to-cyan-400", isCorrect: true },
        { id: 2, text: "Be Rude Online!", emoji: "😠", color: "from-pink-400 to-red-400", isCorrect: false },
        { id: 3, text: "Ignore Rules!", emoji: "❌", color: "from-purple-400 to-indigo-400", isCorrect: false }
      ],
      correctMessage: 1
    }
  ];
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] w-full px-4">
        {!showResult ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl">
            ...
            <p className="text-white/70 mb-4 text-sm">Create a poster about digital citizenship!</p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              {score === stages.length 
                ? "Amazing creativity! Your posters inspire safe and kind online behavior!"
                : "Great job creating digital citizenship posters! Keep learning about online safety!"}
            </p>
          </div>
        )}
      </div>
