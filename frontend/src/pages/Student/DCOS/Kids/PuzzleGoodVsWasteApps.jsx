...
const PuzzleGoodVsWasteApps = () => {
  ...
  return (
    <GameShell
      ...
      score={score}
      subtitle={!showResult ? `App ${currentMatch + 1} of ${items.length}` : "Game Complete!"}
        ...
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              {score === items.length ? "Perfect App Expert! 🎉" : `You sorted ${score} out of ${items.length} correctly!`}
            </h2>
            <p className="text-white/90 text-lg mb-6">
              {score === items.length 
                ? "Excellent! You can identify good and waste apps perfectly!"
                : `You sorted ${score} out of ${items.length} apps correctly!`}
            </p>
