...
const SmileStory = () => {
  ...
  const handleNext = () => {
    navigate("/student/dcos/kids/gossip-puzzle");
  };
        ...
        {!showFeedback ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {selectedChoiceData.isCorrect ? "💖 Kindness Hero!" : "Think Again..."}
            </h2>
            ...
            {selectedChoiceData.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Perfect! Praising their drawing is the kindest choice. Your positive comment 
                    can make them feel good and might encourage others to be nice too. One kind 
                    word can change someone's whole day!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    {selectedChoice === 1 
                      ? "Laughing with the bullies makes it worse and hurts the child's feelings. Instead, say something kind about their drawing!"
                      : "While ignoring isn't as bad as laughing, standing up and saying something nice is the best choice. Be the kindness they need!"}
                  </p>
                </div>
                <button
