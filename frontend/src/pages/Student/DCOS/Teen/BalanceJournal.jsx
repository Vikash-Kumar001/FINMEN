...
const BalanceJournal = () => {
  ...
  const tasks = [
    {
      id: 1,
      prompt: "How many hours did I spend offline today?",
      emoji: "⏰"
    },
    {
      id: 2,
      prompt: "What offline activities did I do today?",
      emoji: "🏃"
    },
    {
      id: 3,
      prompt: "How can I balance screen time better?",
      emoji: "⚖️"
    },
    {
      id: 4,
      prompt: "What activities make me feel good offline?",
      emoji: "😊"
    },
    {
      id: 5,
      prompt: "How will I limit my screen time tomorrow?",
      emoji: "📝"
    }
  ];
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] w-full px-4">
        {!showResult ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-white mb-6 text-center">Balance Reflection</h2>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              {score === tasks.length ? "Perfect Balance Achieved! 🎉" : `You completed ${score} out of ${tasks.length} tasks!`}
            </h2>
            <p className="text-white/90 text-lg mb-6">
              {score === tasks.length 
                ? "Excellent! Tracking your offline time helps you maintain a healthy balance. Remember to spend time offline doing activities you enjoy - exercise, hobbies, reading, or spending time with friends and family!"
                : "Great job! Keep learning to balance screen time!"}
            </p>
            <div className="bg-green-500/20 rounded-lg p-4 mb-4">
              <p className="text-white text-center text-sm">
                💡 Balance screen time with offline activities for better wellbeing!
              </p>
            </div>
          </div>
        )}
