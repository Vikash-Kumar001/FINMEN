...
const DebateStage = () => {
  ...
  const debates = [
    {
      id: 1,
      topic: "Should schools teach privacy rights?",
      emoji: "🏫",
      positions: [
        { id: 1, position: "Yes - it's important to learn", emoji: "✅", isCorrect: true },
        { id: 2, position: "No - not necessary", emoji: "❌", isCorrect: false }
      ]
    },
    {
      id: 2,
      topic: "Should privacy be taught in schools?",
      emoji: "📚",
      positions: [
        { id: 1, position: "Yes - students need to know", emoji: "✅", isCorrect: true },
        { id: 2, position: "No - it's not important", emoji: "❌", isCorrect: false }
      ]
    },
    {
      id: 3,
      topic: "Is teaching privacy rights important?",
      emoji: "🎓",
      positions: [
        { id: 1, position: "Yes - protects students", emoji: "✅", isCorrect: true },
        { id: 2, position: "No - not needed", emoji: "❌", isCorrect: false }
      ]
    },
    {
      id: 4,
      topic: "Should students learn about data privacy?",
      emoji: "💻",
      positions: [
        { id: 1, position: "Yes - essential knowledge", emoji: "✅", isCorrect: true },
        { id: 2, position: "No - not relevant", emoji: "❌", isCorrect: false }
      ]
    },
    {
      id: 5,
      topic: "Is privacy education necessary in schools?",
      emoji: "🛡️",
      positions: [
        { id: 1, position: "Yes - helps protect students", emoji: "✅", isCorrect: true },
        { id: 2, position: "No - unnecessary", emoji: "❌", isCorrect: false }
      ]
    }
  ];
        ...
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              {score === debates.length ? "Perfect Privacy Advocate! 🎉" : `You got ${score} out of ${debates.length}!`}
            </h2>
            <p className="text-white/90 text-lg mb-6">
              {score === debates.length 
                ? "Excellent! Yes, schools should definitely teach privacy rights! It's essential knowledge that helps protect students online. Learning about privacy helps students understand their rights, protect their personal information, and make informed decisions about sharing data. Privacy education is crucial in the digital age!"
                : "Great job! Keep learning about privacy rights!"}
            </p>
            <div className="bg-green-500/20 rounded-lg p-4 mb-4">
              <p className="text-white text-center text-sm">
                💡 Yes! Schools should teach privacy rights - it's essential for student protection!
              </p>
            </div>
          </div>
        )}
