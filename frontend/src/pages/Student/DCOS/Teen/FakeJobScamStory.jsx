  ...
  const scenarios = [
    {
      ...
      emoji: "💼",
      situation: "A post says 'Pay ₹5000 for a guaranteed job.' What should you do?",
      options: [
        { id: 1, text: "Pay the money - it's a good deal", emoji: "💰", isCorrect: false },
        { id: 2, text: "It's a scam - real jobs don't ask for payment", emoji: "🚫", isCorrect: true },
        { id: 3, text: "Ask for more details first", emoji: "❓", isCorrect: false }
      ]
    },
    {
      id: 2,
      title: "Easy Money Offer",
      emoji: "💵",
      situation: "A message offers 'Easy money - just pay ₹3000 to start.' What's your response?",
      options: [
