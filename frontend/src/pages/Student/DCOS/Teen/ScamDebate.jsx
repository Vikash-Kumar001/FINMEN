...
const ScamDebate = () => {
  ...
  const debates = [
    {
      id: 1,
      topic: "Are all online offers safe?",
      emoji: "💭",
      positions: [
        { id: 1, position: "Yes - if it's online, it's safe", emoji: "✅", isCorrect: false },
        { id: 2, position: "No - many online offers are scams", emoji: "❌", isCorrect: true }
      ]
    },
    {
      id: 2,
      topic: "Should we trust all online deals?",
      emoji: "🛒",
      positions: [
        { id: 1, position: "Yes - online deals are always good", emoji: "✅", isCorrect: false },
        { id: 2, position: "No - verify before trusting", emoji: "❌", isCorrect: true }
      ]
    },
    {
      id: 3,
      topic: "Is it safe to click all online links?",
      emoji: "🔗",
      positions: [
        { id: 1, position: "Yes - links are usually safe", emoji: "✅", isCorrect: false },
        { id: 2, position: "No - many links are scams", emoji: "❌", isCorrect: true }
      ]
    },
    {
      id: 4,
      topic: "Should we share personal info for online offers?",
      emoji: "📱",
      positions: [
        { id: 1, position: "Yes - if they ask, it's okay", emoji: "✅", isCorrect: false },
        { id: 2, position: "No - be very careful with personal info", emoji: "❌", isCorrect: true }
      ]
    },
    {
      id: 5,
      topic: "Are all online job offers legitimate?",
      emoji: "💼",
      positions: [
        { id: 1, position: "Yes - online jobs are real", emoji: "✅", isCorrect: false },
        { id: 2, position: "No - many are scams, verify first", emoji: "❌", isCorrect: true }
      ]
    }
  ];
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              {score === debates.length 
                ? "Excellent! Not all online offers are safe - many are scams! Always verify online deals, be cautious with links, protect your personal information, and verify job offers. If something seems too good to be true, it probably is!"
                : "Great job! Keep learning to identify online scams!"}
            </p>
            <div className="bg-green-500/20 rounded-lg p-4 mb-4">
              <p className="text-white text-center text-sm">
                💡 Not all online offers are safe - always verify and be cautious!
              </p>
            </div>
          </div>
        )}
