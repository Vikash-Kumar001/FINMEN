...
const SocialMediaJournal = () => {
  ...
  const tasks = [
    {
      id: 1,
      prompt: "What information about me is okay to share online?",
      emoji: "📝"
    },
    {
      id: 2,
      prompt: "What personal details should I never share?",
      emoji: "🔒"
    },
    {
      id: 3,
      prompt: "How can I protect my privacy on social media?",
      emoji: "🛡️"
    },
    {
      id: 4,
      prompt: "What should I do if someone asks for my personal information?",
      emoji: "❓"
    },
    {
      id: 5,
      prompt: "Why is it important to think before sharing online?",
      emoji: "💭"
    }
  ];
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] w-full px-4">
        {!showResult ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-white mb-6 text-center">Digital Privacy Reflection</h2>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/20 w-full max-w-2xl text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              {score === tasks.length 
                ? "Excellent! Remember: SAFE to share - hobbies, interests, general opinions. NEVER share - full name, address, phone number, school name, family details, passwords, location, or anything that can identify you!"
                : "Great job! Keep learning to protect your privacy!"}
            </p>
            <div className="bg-green-500/20 rounded-lg p-4 mb-4">
              <p className="text-white text-center text-sm">
                💡 Think before you share! Your privacy matters.
              </p>
            </div>
          </div>
        )}
