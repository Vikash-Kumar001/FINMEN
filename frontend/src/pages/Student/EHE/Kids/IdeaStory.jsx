...
const IdeaStory = () => {
  ...
  const story = {
    ...
    choices: [
      { id: 1, text: "Think of a plan", emoji: "💡", isCorrect: true },
      { id: 2, text: "Just start selling randomly", emoji: "🤷", isCorrect: false },
      { id: 3, text: "Give up before trying", emoji: "😔", isCorrect: false }
    ]
  };
        ...
        {!showFeedback ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {selectedChoiceData.isCorrect ? "💡 Smart Thinker!" : "Try Again..."}
            </h2>
