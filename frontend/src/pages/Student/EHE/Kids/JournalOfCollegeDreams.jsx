...
const JournalOfCollegeDreams = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={isSubmitted ? "Great job!" : "Write about your college dreams"}
      onNext={handleNext}
          ...
          {!isSubmitted ? (
            <>
              <h2 className="text-xl font-semibold text-white mb-4">
                Write: "The college I dream of joining is ___."
              </h2>
              <p className="text-white/80 mb-6">
                Think about your future college aspirations and write about which college you dream of joining. What would you like to study there? What makes it special to you? Write at least 10 words.
              </p>
              
              <textarea
                value={journalEntry}
                onChange={(e) => setJournalEntry(e.target.value)}
                placeholder="Start writing about your college dreams here..."
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-white mb-6">Your College Dreams Journal</h2>
