...
const JournalOfDreamFutureJob = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={isSubmitted ? "Great job!" : "Write about your dream future job"}
      onNext={handleNext}
          ...
          {!isSubmitted ? (
            <>
              <h2 className="text-xl font-semibold text-white mb-4">
                Write: "One new career I want to explore is ___."
              </h2>
              <p className="text-white/80 mb-6">
                Think about future careers that interest you. What new job would you like to explore? Why does it appeal to you? What skills would you need to develop? Write at least 10 words.
              </p>
              
              <textarea
                value={journalEntry}
                onChange={(e) => setJournalEntry(e.target.value)}
                placeholder="Start writing about your dream future job here..."
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-white mb-6">Your Dream Future Job Journal</h2>
