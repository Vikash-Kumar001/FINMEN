...
const JournalOfDreams = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={isSubmitted ? "Great job!" : "Write about your dreams"}
      onNext={handleNext}
          ...
          {!isSubmitted ? (
            <>
              <h2 className="text-xl font-semibold text-white mb-4">
                Write: "After school, I dream of becoming ___."
              </h2>
              <p className="text-white/80 mb-6">
                Think about your future aspirations and write about what you dream of becoming after school. What would you like to achieve? Write at least 10 words.
              </p>
              
              <textarea
                value={journalEntry}
                onChange={(e) => setJournalEntry(e.target.value)}
                placeholder="Start writing about your dreams here..."
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-white mb-6">Your Dreams Journal</h2>
