...
const JournalOfIdeas = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={isSubmitted ? "Great job!" : "Write about your ideas"}
      onNext={handleNext}
          ...
          {!isSubmitted ? (
            <>
              <h2 className="text-xl font-semibold text-white mb-4">
                Write: "One idea I have to solve a problem is ___."
              </h2>
              <p className="text-white/80 mb-6">
                Think of a problem you've noticed and an idea to solve it. Write at least 10 words.
              </p>
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-white mb-6">Your Idea Journal</h2>
