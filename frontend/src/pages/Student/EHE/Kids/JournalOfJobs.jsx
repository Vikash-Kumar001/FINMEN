...
const JournalOfJobs = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={isSubmitted ? "Great job!" : "Write about your career goals"}
      onNext={handleNext}
          ...
          {!isSubmitted ? (
            <>
              <h2 className="text-xl font-semibold text-white mb-4">
                Write: "When I grow up, I want to be ___."
              </h2>
              <p className="text-white/80 mb-6">
                Think about what job interests you and why. Write at least 10 words.
              </p>
