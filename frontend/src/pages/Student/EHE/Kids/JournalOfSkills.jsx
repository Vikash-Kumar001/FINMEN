...
const JournalOfSkills = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={isSubmitted ? "Great job!" : "Write about your skills"}
      onNext={handleNext}
          ...
          {!isSubmitted ? (
            <>
              <h2 className="text-xl font-semibold text-white mb-4">
                Write: "One skill I want to improve is ___."
              </h2>
              <p className="text-white/80 mb-6">
                Think about which skill you'd like to get better at and why. Write at least 10 words.
              </p>
