...
const PosterKeepGrowing = () => {
  ...
  const posters = [
    {
      ...
      image: "🌱",
      description: "Learning = Growth for Life",
    ...
    },
    {
      ...
      image: "📚",
      description: "Every Day is a Learning Day",
    ...
    },
    {
      ...
      image: "🌟",
      description: "Grow Your Potential Every Day",
  ...
  const getSelectedPoster = () => {
    if (selectedPoster === "custom") return { title: "Keep Growing", description: customMessage };
  ...
  return (
    <GameShell
      ...
      subtitle={selectedPoster ? "Great choice!" : "Create or select a poster about lifelong learning"}
      onNext={handleNext}
          ...
          {!selectedPoster ? (
            <>
              <h2 className="text-xl font-semibold text-white mb-6 text-center">
                Create or select a poster: "Learning = Growth for Life"
              </h2>
              ...
              <div className="border-t border-white/20 pt-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    placeholder="Enter your message about lifelong learning..."
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-white mb-6">Your "Keep Growing" Poster</h2>
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-8 border border-white/10 mb-6">
                ...
                <h3 className="text-3xl font-bold text-white mb-4">
                  {selectedPoster === "custom" ? "Keep Growing" : getSelectedPoster().title}
                </h3>
                <p className="text-xl text-white/90">
                  {selectedPoster === "custom" ? customMessage : getSelectedPoster().description}
                </p>
              </div>
              
              <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30">
                <p className="text-green-300 font-bold">
                  🎉 Congratulations! You've created your lifelong learning poster!
                </p>
                <p className="text-green-300 mt-2">
                  Remember: Learning is growth that continues throughout your life!
                </p>
              </div>
            </div>
          )}
