...
const PosterMyCollegeDream = () => {
  ...
  const posters = [
    {
      ...
      image: "🎓",
      description: "One Day I Will Go to College",
    ...
    },
    {
      ...
      image: "💭",
      description: "My College Dreams Will Come True",
    ...
    },
    {
      ...
      image: "📚",
      description: "College is My Path to Success",
    ...
    },
    {
      ...
      title: "Future Leader",
      image: "🌟",
      description: "I Will Excel in College",
  ...
  const getSelectedPoster = () => {
    if (selectedPoster === "custom") return { title: "My College Dream", description: customPoster };
  ...
  return (
    <GameShell
      ...
      subtitle={selectedPoster ? "Great choice!" : "Create your college dream poster"}
      onNext={handleNext}
          ...
          {!selectedPoster ? (
            <>
              <h2 className="text-xl font-semibold text-white mb-6 text-center">
                Create or select a poster: "One Day I Will Go to College"
              </h2>
              ...
              <div className="border-t border-white/20 pt-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    placeholder="Enter your college dream message..."
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-white mb-6">Your College Dream Poster</h2>
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-8 border border-white/10 mb-6">
                ...
                <h3 className="text-3xl font-bold text-white mb-4">
                  {selectedPoster === "custom" ? "My College Dream" : getSelectedPoster().title}
                </h3>
              ...
              <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30">
                <p className="text-green-300 font-bold">
                  🎉 Congratulations! You've created your college dream poster!
                </p>
                <p className="text-green-300 mt-2">
                  Remember: One Day I Will Go to College!
                </p>
              </div>
            </div>
          )}
