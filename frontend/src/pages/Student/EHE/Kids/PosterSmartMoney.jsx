...
const PosterSmartMoney = () => {
  ...
  const posters = [
    {
      ...
      title: "Earn Smart",
      image: "💼",
      description: "Work hard to earn money",
    ...
    },
    {
      ...
      title: "Save Wisely",
      image: "🏦",
      description: "Save for future needs",
      color: "from-blue-500 to-indigo-500"
    },
    {
      id: 3,
      title: "Spend Thoughtfully",
      image: "🛒",
      description: "Buy what you need, not just what you want",
    ...
    },
    {
      ...
      title: "Money Balance",
      image: "⚖️",
      description: "Earn, Save, Spend Wisely",
  ...
  const getSelectedPoster = () => {
    if (selectedPoster === "custom") return { title: "My Smart Money Plan", description: customPoster };
  ...
  return (
    <GameShell
      ...
      subtitle={selectedPoster ? "Great choice!" : "Create your money poster"}
      onNext={handleNext}
          ...
          {!selectedPoster ? (
            <>
              <h2 className="text-xl font-semibold text-white mb-6 text-center">
                Create or select a poster: "Earn, Save, Spend Wisely"
              </h2>
              ...
              <div className="border-t border-white/20 pt-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    placeholder="Enter your smart money message..."
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-white mb-6">Your Smart Money Poster</h2>
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-8 border border-white/10 mb-6">
                ...
                <h3 className="text-3xl font-bold text-white mb-4">
                  {selectedPoster === "custom" ? "My Smart Money Plan" : getSelectedPoster().title}
                </h3>
              ...
              <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl p-4 border border-green-400/30">
                <p className="text-green-300 font-bold">
                  🎉 Congratulations! You've created your smart money poster!
                </p>
                <p className="text-green-300 mt-2">
                  Remember: Earn, Save, Spend Wisely!
                </p>
              </div>
            </div>
          )}
