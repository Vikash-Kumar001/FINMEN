...
const ReflexCareerAlert = () => {
  ...
  const careerItems = [
    { id: 1, emoji: "💼", concept: "Scholarship", correct: true },
    { id: 2, emoji: "💼", concept: "Drop Out Too Early", correct: false },
    { id: 3, emoji: "🎓", concept: "Further Education", correct: true },
    { id: 4, emoji: "🎓", concept: "Avoid Learning", correct: false },
    { id: 5, emoji: "🔧", concept: "Skill Development", correct: true },
    { id: 6, emoji: "🔧", concept: "No Skills Needed", correct: false },
    { id: 7, emoji: "📈", concept: "Career Growth", correct: true },
    { id: 8, emoji: "📈", concept: "Stagnation", correct: false },
    { id: 9, emoji: "🎯", concept: "Goal Setting", correct: true },
    { id: 10, emoji: "🎯", concept: "No Planning", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...careerItems].sort(() => Math.random() - 0.5));
    setCurrentItem(careerItems[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...careerItems].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick career concepts!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick career concepts! Tap 💼 for correct concepts, ❌ for incorrect ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this a good career concept?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand career concepts well!" : 
                   score >= 5 ? "Good job! Keep learning about career planning!" : 
