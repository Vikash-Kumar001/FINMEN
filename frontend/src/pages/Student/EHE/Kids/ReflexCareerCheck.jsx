...
const ReflexCareerCheck = () => {
  ...
  const items = [
    { id: 1, statement: "Engineer builds bridges", isCorrect: true },
    { id: 2, statement: "Engineer cooks food", isCorrect: false },
    { id: 3, statement: "Artist creates paintings", isCorrect: true },
    { id: 4, statement: "Artist drives buses", isCorrect: false },
    { id: 5, statement: "Scientist does experiments", isCorrect: true },
    { id: 6, statement: "Scientist plays sports", isCorrect: false },
    { id: 7, statement: "Librarian organizes books", isCorrect: true },
    { id: 8, statement: "Librarian flies planes", isCorrect: false },
    { id: 9, statement: "Musician plays instruments", isCorrect: true },
    { id: 10, statement: "Musician fixes cars", isCorrect: false }
  ];
  ...
  const handleNext = () => {
    navigate("/student/ehe/kids/badge-career-explorer");
  };
        ...
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {score >= 7 ? "🎉 Lightning Fast!" : "💪 Keep Practicing!"}
            </h2>
            ...
            <div className="bg-blue-500/20 rounded-lg p-4 mb-4">
              <p className="text-white/90 text-sm">
                💡 Understanding what different careers involve helps you make smart choices!
              </p>
            </div>
