...
const ReflexCollegeAwareness = () => {
  ...
  const collegeItems = [
    { id: 1, emoji: "🏫", concept: "Study in College", correct: true },
    { id: 2, emoji: "🏫", concept: "College = Shopping Mall", correct: false },
    { id: 3, emoji: "📚", concept: "Learning New Subjects", correct: true },
    { id: 4, emoji: "📚", concept: "Only Playing Games", correct: false },
    { id: 5, emoji: "🎓", concept: "Earn a Degree", correct: true },
    { id: 6, emoji: "🎓", concept: "Get Free Money", correct: false },
    { id: 7, emoji: "🧠", concept: "Develop Skills", correct: true },
    { id: 8, emoji: "🧠", concept: "Avoid Studying", correct: false },
    { id: 9, emoji: "💼", concept: "Better Career Options", correct: true },
    { id: 10, emoji: "💼", concept: "No Need to Work", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...collegeItems].sort(() => Math.random() - 0.5));
    setCurrentItem(collegeItems[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...collegeItems].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick college concepts!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick college concepts! Tap 🏫 for correct concepts, ❌ for incorrect ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this a correct college concept?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand college concepts well!" : 
                   score >= 5 ? "Good job! Keep learning about college!" : 
