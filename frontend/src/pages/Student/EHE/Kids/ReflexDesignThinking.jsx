...
const ReflexDesignThinking = () => {
  ...
  const designThinkingItems = [
    { id: 1, emoji: "🔧", action: "Test Ideas", correct: true },
    { id: 2, emoji: "🔧", action: "Ignore Problems", correct: false },
    { id: 3, emoji: "🧠", action: "Empathize with Users", correct: true },
    { id: 4, emoji: "🧠", action: "Assume Needs", correct: false },
    { id: 5, emoji: "✏️", action: "Prototype Solutions", correct: true },
    { id: 6, emoji: "✏️", action: "Skip Planning", correct: false },
    { id: 7, emoji: "🔄", action: "Iterate Designs", correct: true },
    { id: 8, emoji: "🔄", action: "Never Change", correct: false },
    { id: 9, emoji: "🎯", action: "Define Problems", correct: true },
    { id: 10, emoji: "🎯", action: "Ignore Feedback", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...designThinkingItems].sort(() => Math.random() - 0.5));
    setCurrentItem(designThinkingItems[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...designThinkingItems].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick design thinking!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick design thinking! Tap 🔧 for good actions, ❌ for bad ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this good design thinking?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand design thinking well!" : 
                   score >= 5 ? "Good job! Keep learning about design thinking!" : 
