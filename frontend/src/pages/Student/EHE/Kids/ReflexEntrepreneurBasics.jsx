...
const ReflexEntrepreneurBasics = () => {
  ...
  const entrepreneurItems = [
    { id: 1, emoji: "💪", concept: "Hard Work", correct: true },
    { id: 2, emoji: "💪", concept: "Giving Up", correct: false },
    { id: 3, emoji: "💡", concept: "Creative Ideas", correct: true },
    { id: 4, emoji: "💡", concept: "Copying Others", correct: false },
    { id: 5, emoji: "🔄", concept: "Learn from Failures", correct: true },
    { id: 6, emoji: "🔄", concept: "Avoid Challenges", correct: false },
    { id: 7, emoji: "🤝", concept: "Teamwork", correct: true },
    { id: 8, emoji: "🤝", concept: "Working Alone", correct: false },
    { id: 9, emoji: "📈", concept: "Grow Business", correct: true },
    { id: 10, emoji: "📈", concept: "Ignore Feedback", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...entrepreneurItems].sort(() => Math.random() - 0.5));
    setCurrentItem(entrepreneurItems[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...entrepreneurItems].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick entrepreneur concepts!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick entrepreneur concepts! Tap 💪 for correct concepts, ❌ for incorrect ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this an entrepreneur concept?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand entrepreneur concepts well!" : 
                   score >= 5 ? "Good job! Keep learning about entrepreneurship!" : 
