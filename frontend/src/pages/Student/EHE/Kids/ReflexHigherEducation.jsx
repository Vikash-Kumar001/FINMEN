...
const ReflexHigherEducation = () => {
  ...
  const educationItems = [
    { id: 1, emoji: "📚", concept: "College = Learning", correct: true },
    { id: 2, emoji: "📚", concept: "College = Party Only", correct: false },
    { id: 3, emoji: "🎓", concept: "Earn Knowledge", correct: true },
    { id: 4, emoji: "🎓", concept: "Just Get Certificate", correct: false },
    { id: 5, emoji: "🏫", concept: "Develop Skills", correct: true },
    { id: 6, emoji: "🏫", concept: "Avoid Responsibilities", correct: false },
    { id: 7, emoji: "🧠", concept: "Critical Thinking", correct: true },
    { id: 8, emoji: "🧠", concept: "No Need to Study", correct: false },
    { id: 9, emoji: "💼", concept: "Career Preparation", correct: true },
    { id: 10, emoji: "💼", concept: "Waste Time", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...educationItems].sort(() => Math.random() - 0.5));
    setCurrentItem(educationItems[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...educationItems].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick higher education concepts!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick higher education concepts! Tap 📚 for correct concepts, ❌ for incorrect ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this a correct higher education concept?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand higher education concepts well!" : 
                   score >= 5 ? "Good job! Keep learning about higher education!" : 
