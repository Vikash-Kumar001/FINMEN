...
const ReflexInnovationBasics = () => {
  ...
  const innovationItems = [
    { id: 1, emoji: "💡", concept: "New Idea", correct: true },
    { id: 2, emoji: "💡", concept: "Copy Idea", correct: false },
    { id: 3, emoji: "🔧", concept: "Improve Design", correct: true },
    { id: 4, emoji: "🔧", concept: "Break Things", correct: false },
    { id: 5, emoji: "🔄", concept: "Iterate Solution", correct: true },
    { id: 6, emoji: "🔄", concept: "Repeat Mistakes", correct: false },
    { id: 7, emoji: "🔬", concept: "Test Hypothesis", correct: true },
    { id: 8, emoji: "🔬", concept: "Guess Randomly", correct: false },
    { id: 9, emoji: "🚀", concept: "Launch Product", correct: true },
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick innovation concepts!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick innovation concepts! Tap 💡 for correct concepts, ❌ for incorrect ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this an innovation concept?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand innovation concepts well!" : 
