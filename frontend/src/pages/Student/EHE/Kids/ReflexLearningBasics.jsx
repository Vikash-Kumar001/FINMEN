...
const ReflexLearningBasics = () => {
  ...
  const learningItems = [
    { id: 1, emoji: "❓", action: "Ask Questions", correct: true },
    { id: 2, emoji: "❓", action: "Stay Silent", correct: false },
    { id: 3, emoji: "📚", action: "Read Books", correct: true },
    { id: 4, emoji: "📚", action: "Ignore Books", correct: false },
    { id: 5, emoji: "🧠", action: "Think Critically", correct: true },
    { id: 6, emoji: "🧠", action: "Accept Everything", correct: false },
    { id: 7, emoji: "✍️", action: "Take Notes", correct: true },
    { id: 8, emoji: "✍️", action: "Forget Everything", correct: false },
    { id: 9, emoji: "👥", action: "Discuss with Others", correct: true },
    { id: 10, emoji: "👥", action: "Never Talk to Anyone", correct: false }
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Tap ❓ for 'Ask Questions,' ❌ for 'Stop Curiosity'"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Tap ❓ for "Ask Questions," ❌ for "Stop Curiosity."
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this good for learning?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent job! You're a learning expert!" : 
