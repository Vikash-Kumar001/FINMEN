...
const ReflexMoneyAlert = () => {
  ...
  const moneyActions = [
    { id: 1, emoji: "🏦", action: "Save in Bank", correct: true },
    { id: 2, emoji: "🏦", action: "Throw Away Money", correct: false },
    { id: 3, emoji: "💰", action: "Count Your Money", correct: true },
    { id: 4, emoji: "💰", action: "Lose Your Money", correct: false },
    { id: 5, emoji: "🛒", action: "Compare Prices", correct: true },
    { id: 6, emoji: "🛒", action: "Buy Everything", correct: false },
    { id: 7, emoji: "📋", action: "Make a Budget", correct: true },
    { id: 8, emoji: "📋", action: "Spend Randomly", correct: false },
    { id: 9, emoji: "📈", action: "Earn Interest", correct: true },
    { id: 10, emoji: "📈", action: "Ignore Growth", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...moneyActions].sort(() => Math.random() - 0.5));
    setCurrentItem(moneyActions[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...moneyActions].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick money decisions!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick money decisions! Tap 🏦 for smart actions, ❌ for bad ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this a smart money action?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand smart money actions well!" : 
                   score >= 5 ? "Good job! Keep learning about money management!" : 
