...
const ReflexMoneyBasics = () => {
  ...
  const moneyItems = [
    { id: 1, emoji: "💰", concept: "Money = Value", correct: true },
    { id: 2, emoji: "💰", concept: "Money = Toy", correct: false },
    { id: 3, emoji: "💳", concept: "Money can be digital", correct: true },
    { id: 4, emoji: "💳", concept: "Money is only coins", correct: false },
    { id: 5, emoji: "🏦", concept: "Banks keep money safe", correct: true },
    { id: 6, emoji: "🏦", concept: "Banks are toy stores", correct: false },
    { id: 7, emoji: "🛒", concept: "Money buys goods", correct: true },
    { id: 8, emoji: "🛒", concept: "Money buys time", correct: false },
    { id: 9, emoji: "📈", concept: "Money can grow with saving", correct: true },
    { id: 10, emoji: "📈", concept: "Money disappears when saved", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...moneyItems].sort(() => Math.random() - 0.5));
    setCurrentItem(moneyItems[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...moneyItems].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick money concepts!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick money concepts! Tap 💰 for correct concepts, ❌ for incorrect ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this concept correct?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand money basics well!" : 
                   score >= 5 ? "Good job! Keep learning about money!" : 
