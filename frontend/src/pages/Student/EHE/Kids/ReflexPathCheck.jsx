...
const ReflexPathCheck = () => {
  ...
  const pathItems = [
    { id: 1, emoji: "🎓", concept: "Study After School", correct: true },
    { id: 2, emoji: "🎓", concept: "No Learning Forever", correct: false },
    { id: 3, emoji: "📚", concept: "Continuous Education", correct: true },
    { id: 4, emoji: "📚", concept: "Stop Learning Early", correct: false },
    { id: 5, emoji: "🔧", concept: "Skill Development", correct: true },
    { id: 6, emoji: "🔧", concept: "Avoid All Skills", correct: false },
    { id: 7, emoji: "💼", concept: "Career Planning", correct: true },
    { id: 8, emoji: "💼", concept: "No Future Planning", correct: false },
    { id: 9, emoji: "🎯", concept: "Set Goals", correct: true },
    { id: 10, emoji: "🎯", concept: "No Direction", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...pathItems].sort(() => Math.random() - 0.5));
    setCurrentItem(pathItems[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...pathItems].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick path concepts!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick path concepts! Tap 🎓 for correct concepts, ❌ for incorrect ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this a good path concept?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand path concepts well!" : 
                   score >= 5 ? "Good job! Keep learning about pathways!" : 
