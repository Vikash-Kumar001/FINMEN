...
const ReflexSkillCheck = () => {
  ...
  const skillItems = [
    { id: 1, emoji: "💡", skill: "Creativity", correct: true },
    { id: 2, emoji: "💡", skill: "Cheating", correct: false },
    { id: 3, emoji: "🤝", skill: "Teamwork", correct: true },
    { id: 4, emoji: "🤝", skill: "Ignoring others", correct: false },
    { id: 5, emoji: "🧩", skill: "Problem-solving", correct: true },
    { id: 6, emoji: "🧩", skill: "Giving up", correct: false },
    { id: 7, emoji: "💬", skill: "Communication", correct: true },
    { id: 8, emoji: "💬", skill: "Lying", correct: false },
    { id: 9, emoji: "💪", skill: "Perseverance", correct: true },
    { id: 10, emoji: "💪", skill: "Quitting", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...skillItems].sort(() => Math.random() - 0.5));
    setCurrentItem(skillItems[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...skillItems].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Test your entrepreneur skills!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Tap 💡 for good skills, ❌ for bad ones. Test your reflexes!
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this a good entrepreneur skill?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You know your entrepreneur skills well!" : 
                   score >= 5 ? "Good job! Keep learning about important skills!" : 
