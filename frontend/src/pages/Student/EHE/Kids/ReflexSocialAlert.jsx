...
const ReflexSocialAlert = () => {
  ...
  const socialItems = [
    { id: 1, emoji: "⚖️", concept: "Fair Business", correct: true },
    { id: 2, emoji: "⚖️", concept: "Cheating", correct: false },
    { id: 3, emoji: "🤝", concept: "Honest Partnerships", correct: true },
    { id: 4, emoji: "🤝", concept: "Breaking Promises", correct: false },
    { id: 5, emoji: "🌱", concept: "Ethical Practices", correct: true },
    { id: 6, emoji: "🌱", concept: "Environmental Harm", correct: false },
    { id: 7, emoji: "💼", concept: "Responsible Leadership", correct: true },
    { id: 8, emoji: "💼", concept: "Exploiting Workers", correct: false },
    { id: 9, emoji: "💰", concept: "Transparent Finances", correct: true },
    { id: 10, emoji: "💰", concept: "Hidden Fees", correct: false }
  ];
  ...
  const startGame = () => {
    ...
    setScore(0);
    setCoins(0);
    setItems([...socialItems].sort(() => Math.random() - 0.5));
    setCurrentItem(socialItems[0]);
  };
  ...
  const handleChoice = (isCorrect) => {
    ...
    if (currentIndex < items.length - 1) {
      ...
      const shuffled = [...socialItems].sort(() => Math.random() - 0.5);
      setItems(shuffled);
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick social business concepts!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick social business concepts! Tap ⚖️ for correct concepts, ❌ for incorrect ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this a fair business practice?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand fair business practices well!" : 
                   score >= 5 ? "Good job! Keep learning about ethical business!" : 
