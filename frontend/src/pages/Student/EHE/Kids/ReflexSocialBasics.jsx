...
const ReflexSocialBasics = () => {
  ...
  const socialItems = [
    { id: 1, emoji: "🤝", concept: "Help + Earn", correct: true },
    { id: 2, emoji: "🤝", concept: "Ignore Problems", correct: false },
    { id: 3, emoji: "🌱", concept: "Sustainable Solutions", correct: true },
    { id: 4, emoji: "🌱", concept: "Waste Resources", correct: false },
    { id: 5, emoji: "💡", concept: "Innovative Ideas", correct: true },
    { id: 6, emoji: "💡", concept: "Copy Old Methods", correct: false },
    { id: 7, emoji: "🌍", concept: "Environmental Care", correct: true },
    { id: 8, emoji: "🌍", concept: "Pollute Nature", correct: false },
    { id: 9, emoji: "👥", concept: "Community Support", correct: true },
    { id: 10, emoji: "👥", concept: "Work Alone", correct: false }
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={gameActive ? `Time: ${timeLeft}s | Score: ${score}` : "Quick social concepts!"}
      onNext={handleNext}
          ...
          {!gameActive && !gameFinished && (
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-4">
                Quick social concepts! Tap 🤝 for correct concepts, ❌ for incorrect ones.
              </h2>
          ...
          {gameActive && currentItem && (
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80">Is this a good social concept?</p>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                ...
                <p className="text-white/80">
                  {score >= 8 ? "Excellent! You understand social concepts well!" : 
                   score >= 5 ? "Good job! Keep learning about social impact!" : 
