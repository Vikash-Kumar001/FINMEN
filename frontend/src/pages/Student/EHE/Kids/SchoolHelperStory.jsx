...
const SchoolHelperStory = () => {
  ...
  const story = {
    title: "School Safety",
    emoji: "🏫",
    situation: "Who keeps your school safe and helps visitors?",
    choices: [
      { id: 1, text: "Security Guard", emoji: "👮", isCorrect: true },
      { id: 2, text: "Chef", emoji: "👨‍🍳", isCorrect: false },
      { id: 3, text: "Pilot", emoji: "👨‍✈️", isCorrect: false }
    ]
  };
  ...
  const handleNext = () => {
    navigate("/student/ehe/kids/reflex-career-check");
  };
            ...
            {selectedChoiceData.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Perfect! Security guards keep schools safe, monitor who enters and exits, and 
                    help in emergencies. They are very important!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Security guards are the ones who keep schools safe and help visitors!
                  </p>
                </div>
                <button
