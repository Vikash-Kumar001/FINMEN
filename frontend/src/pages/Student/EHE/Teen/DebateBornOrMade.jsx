...
const DebateBornOrMade = () => {
  ...
  const debateTopic = {
    question: "Are entrepreneurs born with talent or made through learning skills?",
    sides: [
      { id: 1, position: "Made - entrepreneurs learn skills", isCorrect: true },
      { id: 2, position: "Born - it's natural talent only", isCorrect: false }
    ]
  };
  ...
  const handleNext = () => {
    navigate("/student/ehe/teen/journal-of-strengths");
  };

  return (
    <GameShell
      title="Debate: Born or Made?"
      subtitle="Entrepreneur Development"
      onNext={handleNext}
        ...
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {coins > 0 ? "Perfect Argument!" : "Good Try!"}
            </h2>
            ...
            {coins > 0 ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Excellent! Entrepreneurs are made through learning, practice, and perseverance. While 
                    some traits help, skills like leadership, creativity, and resilience can be developed!
                  </p>
                </div>
              ...
              <>
                <div className="bg-yellow-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Research shows entrepreneurs are made, not born! Skills can be learned through 
                    education, mentorship, and experience. Anyone can become an entrepreneur!
                  </p>
                </div>
                <button
