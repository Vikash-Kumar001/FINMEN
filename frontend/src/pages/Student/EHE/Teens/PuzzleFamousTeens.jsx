  ...
  const puzzles = [
    {
      ...
      matches: shuffleArray([
        { id: "tie", text: "Tie Business", emoji: "👔", correct: true },
        { id: "cookies", text: "Cookies", emoji: "🍪", correct: false },
    ...
    },
    {
      ...
      emoji: "🍪",
      matches: shuffleArray([
        { id: "tie", text: "Tie Business", emoji: "👔", correct: false },
        { id: "cookies", text: "Cookies", emoji: "🍪", correct: true },
        { id: "candy", text: "Candy", emoji: "🍬", correct: false }
      ])
    },
    {
      ...
      matches: shuffleArray([
        { id: "tie", text: "Tie Business", emoji: "👔", correct: false },
        { id: "cookies", text: "Cookies", emoji: "🍪", correct: false },
        { id: "candy", text: "Candy", emoji: "🍬", correct: true }
      ])
    },
    {
      id: 4,
      ...
      emoji: "💄",
      matches: shuffleArray([
        { id: "cosmetics", text: "Cosmetics Brand", emoji: "💄", correct: true },
        { id: "tech", text: "Tech Company", emoji: "💻", correct: false },
        { id: "books", text: "Book Publishing", emoji: "📚", correct: false }
      ])
    },
    {
      id: 5,
      ...
      emoji: "🎮",
      matches: shuffleArray([
        { id: "apps", text: "App Development", emoji: "📱", correct: true },
        { id: "fashion", text: "Fashion Design", emoji: "👗", correct: false },
        { id: "food", text: "Food Business", emoji: "🍔", correct: false }
      ])
    }
  ];
      ...
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <p className="text-white text-lg mb-6 text-center">
            Match the teen entrepreneur to their business!
          </p>
