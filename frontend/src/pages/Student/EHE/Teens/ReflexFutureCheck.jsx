...
const ReflexFutureCheck = () => {
  ...
  const scenarios = [
    { action: "Engineer = Build", emoji: "🏗️", isCorrect: true },
    { action: "Engineer = Cook", emoji: "🍳", isCorrect: false },
    { action: "Scientist = Research", emoji: "🔬", isCorrect: true },
    { action: "Scientist = Drive", emoji: "🚗", isCorrect: false },
    { action: "Teacher = Educate", emoji: "📚", isCorrect: true },
    { action: "Teacher = Fight", emoji: "🥊", isCorrect: false },
    { action: "Doctor = Heal", emoji: "👨‍⚕️", isCorrect: true },
    { action: "Doctor = Act", emoji: "🎭", isCorrect: false }
  ];
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              ...
              {gameState === 'ready' && 'QUICK! Match the career to the right action!'}
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Match careers to their correct actions!</p>
              </div>
            </div>
          )}
        </div>
