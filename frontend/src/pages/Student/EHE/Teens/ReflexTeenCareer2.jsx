...
const ReflexTeenCareer2 = () => {
  ...
  const scenarios = [
    { action: "Choose Path", emoji: "🎯", isCorrect: true },
    { action: "No Direction", emoji: "🧭", isCorrect: false },
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Get ready for career decisions...'}
              ...
              {gameState === 'fail' && 'Too slow! Career planning needs quick thinking!'}
            </p>
          </div>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Good career planning requires quick, thoughtful decisions!</p>
              </div>
            </div>
          )}
        </div>
