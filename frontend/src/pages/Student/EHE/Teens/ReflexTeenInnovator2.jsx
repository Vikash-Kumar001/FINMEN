...
const ReflexTeenInnovator2 = () => {
  ...
  const scenarios = [
    { action: "Prototype", emoji: "🛠️", isCorrect: true },
    { action: "Ignore Ideas", emoji: "❌", isCorrect: false },
    { action: "Test Concept", emoji: "🧪", isCorrect: true },
    { action: "Copy Exactly", emoji: "📎", isCorrect: false },
    { action: "Build Model", emoji: "🏗️", isCorrect: true },
    { action: "Give Up", emoji: "🏳️", isCorrect: false },
    { action: "Create Version", emoji: "🔧", isCorrect: true },
    { action: "Never Improve", emoji: "🔒", isCorrect: false }
  ];
