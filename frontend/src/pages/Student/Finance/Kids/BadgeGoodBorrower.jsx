...
const BadgeGoodBorrower = () => {
  ...
  const questions = [
    {
      id: 1,
      icon: <Book className="w-8 h-8 sm:w-10 sm:h-10 text-blue-500" />,
      text: "Your friend lent you a storybook last week. What is the best thing to do?",
      choices: [
        { id: "a", text: "Return it clean and on time", emoji: "📚", correct: true },
        { id: "b", text: "Keep it forever", emoji: "📦", correct: false },
        { id: "c", text: "Give it to someone else", emoji: "🎁", correct: false },
      ],
    },
    {
      id: 2,
      icon: <Pencil className="w-8 h-8 sm:w-10 sm:h-10 text-indigo-500" />,
      text: "You borrowed a pencil from your classmate and it broke. What should you do?",
      choices: [
        { id: "a", text: "Replace it with a new pencil", emoji: "✏️", correct: true },
        { id: "b", text: "Return only the broken pencil", emoji: "🪵", correct: false },
        { id: "c", text: "Say nothing and walk away", emoji: "🙈", correct: false },
      ],
    },
    {
      id: 3,
      icon: <Smartphone className="w-8 h-8 sm:w-10 sm:h-10 text-purple-500" />,
      text: "Your cousin let you use their phone to play. How should you return it?",
      choices: [
        { id: "a", text: "Return it carefully and say thank you", emoji: "🙏", correct: true },
        { id: "b", text: "Return it with low battery", emoji: "🔋", correct: false },
        { id: "c", text: "Change settings and delete apps", emoji: "⚙️", correct: false },
      ],
    },
    {
      id: 4,
      icon: <Umbrella className="w-8 h-8 sm:w-10 sm:h-10 text-teal-500" />,
      text: "Your neighbour lent you an umbrella when it rained. When should you return it?",
      choices: [
        { id: "a", text: "Soon, after drying and cleaning it", emoji: "☔", correct: true },
        { id: "b", text: "Only when it rains again", emoji: "🌧️", correct: false },
        { id: "c", text: "Keep it for emergencies", emoji: "🧺", correct: false },
      ],
    },
    {
      id: 5,
      icon: <Gift className="w-8 h-8 sm:w-10 sm:h-10 text-pink-500" />,
      text: "Your sibling lent you their favorite toy. How should you treat it?",
      choices: [
        { id: "a", text: "Take extra care and return it safely", emoji: "🧸", correct: true },
        { id: "b", text: "Play roughly because it's not yours", emoji: "💥", correct: false },
        { id: "c", text: "Trade it with friends", emoji: "🔁", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Badge: Good Borrower</span>
              <span className="xs:hidden">Good Borrower</span>
            </span>
          </h1>
        </div>
          ...
          {showBadge ? (
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                Fantastic! You answered all {questions.length} questions correctly.
                <br />
                You’ve shown that you are careful, honest, and respectful with borrowed
                things. 🎯
              </p>
            ...
            !showResult ? (
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-purple-300 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-purple-600">
                      Borrowed Item Question {currentQuestion + 1}
                    </span>
                  </div>
                      ...
                      return (
                        <button
                          ...
                          className={`flex-1 min-w-[120px] sm:min-w-[150px] p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl shadow-lg transition-all transform hover:scale-105 disabled:opacity-75 disabled:cursor-not-allowed disabled:transform-none ${
                            !showResult
                              ? "bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400 hover:from-purple-500 hover:via-pink-500 hover:to-indigo-500 text-white border-2 border-white/30"
                              ...
                              : "bg-gradient-to-r from-purple-400/50 via-pink-400/50 to-indigo-400/50 text-white/70 border-2 border-white/20"
                          }`}
                        >
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8 leading-relaxed">
                  {isCorrect
                    ? "Great choice! That's what a good borrower does."
                    : "The best answer is: " +
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                ...
                <br />
                {allCorrect
                  ? "You earned the Good Borrower badge!"
                  : "Keep practicing to earn the Good Borrower badge!"}
              </p>
              <div className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white py-2 sm:py-2.5 px-4 sm:px-6 rounded-full inline-flex items-center gap-2 mb-3 sm:mb-4 shadow-lg">
                <span className="text-xl sm:text-2xl">💰</span>
                <span className="text-base sm:text-lg md:text-xl font-bold">
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Good borrowers return, repair, and respect the things they use.
              </p>
