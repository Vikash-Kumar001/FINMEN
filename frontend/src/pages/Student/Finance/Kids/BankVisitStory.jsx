  ...
  const questions = [
    {
      ...
      choices: [
        { id: "a", text: "Watch and learn quietly", emoji: "👀", correct: true },
        { id: "b", text: "Run around and play", emoji: "🏃", correct: false },
        { id: "c", text: "Touch everything", emoji: "👋", correct: false },
      ],
    },
    {
      id: 2,
      ...
      choices: [
        { id: "a", text: "Be polite and respectful", emoji: "🙏", correct: true },
        { id: "b", text: "Ignore them completely", emoji: "😑", correct: false },
        { id: "c", text: "Be rude to them", emoji: "😠", correct: false },
      ],
    },
    {
      id: 3,
      ...
      choices: [
        { id: "a", text: "Stand back and give privacy", emoji: "🔒", correct: true },
        { id: "b", text: "Watch the PIN closely", emoji: "👁️", correct: false },
        { id: "c", text: "Press random buttons", emoji: "🔘", correct: false },
      ],
    },
    {
      id: 4,
      ...
      choices: [
        { id: "a", text: "Understand it's for safety", emoji: "✅", correct: true },
        { id: "b", text: "Get angry at guard", emoji: "😡", correct: false },
        { id: "c", text: "Refuse the check", emoji: "❌", correct: false },
      ],
    },
    {
      id: 5,
      ...
      choices: [
        { id: "a", text: "Wait patiently in line", emoji: "⏳", correct: true },
        { id: "b", text: "Push to go first", emoji: "💪", correct: false },
        { id: "c", text: "Complain loudly", emoji: "😤", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Bank Visit Story</span>
              <span className="xs:hidden">Bank Visit</span>
            </span>
          </h1>
        </div>
        ...
        <div className="w-full max-w-3xl flex-1 flex flex-col justify-center min-h-0">
          {finalScore === 0 ? (
            !showResult ? (
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-blue-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great choice! You know how to behave at a bank!"
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-blue-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-600 mb-2 sm:mb-3">Bank Visit Complete!</h3>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — excellent bank etiquette!
                <br />
                You learned how to behave at a bank! 🎯
              </p>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Banks are safe places for money!
              </p>
