  ...
  const questions = [
    {
      ...
      options: [
        { id: "spend", text: "Spend all on toys and candies", emoji: "🎮🍬", isCorrect: false },
        { id: "give", text: "Give it all to mom for safekeeping", emoji: "👩‍👧", isCorrect: false },
        { id: "split", text: "Split it: some for fun, some for saving", emoji: "💡🏦", isCorrect: true },
      ],
    },
    {
      id: 2,
      ...
      options: [
        { id: "gifts", text: "Spend half on friends' gifts", emoji: "🎁", isCorrect: false },
        { id: "balance", text: "Keep some for savings and some for fun", emoji: "🎯", isCorrect: true },
        { id: "needs", text: "Buy only needs, no wants", emoji: "🛒", isCorrect: false },
      ],
    },
    {
      id: 3,
      ...
      options: [
        { id: "bigger", text: "Buy bigger things later", emoji: "🚀", isCorrect: true },
        { id: "forget", text: "Forget about the money", emoji: "😅", isCorrect: false },
        { id: "spend", text: "Spend more now", emoji: "🛍️", isCorrect: false },
      ],
    },
    {
      id: 4,
      ...
      options: [
        { id: "regular", text: "Save small amounts regularly", emoji: "💰", isCorrect: true },
        { id: "borrow", text: "Borrow from friends", emoji: "🙈", isCorrect: false },
        { id: "wait", text: "Wait for next birthday", emoji: "🎂", isCorrect: false },
      ],
    },
    {
      id: 5,
      ...
      options: [
        { id: "enjoy", text: "Enjoy a treat and save the rest", emoji: "🧁🏦", isCorrect: true },
        { id: "all", text: "Spend all today", emoji: "🎉", isCorrect: false },
        { id: "save", text: "Save everything, no fun", emoji: "😔", isCorrect: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-pink-500 via-rose-500 to-orange-500 bg-clip-text text-transparent truncate">
              ...
              <span className="xs:hidden">Birthday Money</span>
            </span>
          </h1>
        </div>
        ...
        <div className="w-full max-w-3xl flex-1 flex flex-col justify-center min-h-0">
          {!showResult ? (
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-pink-300 shadow-xl">
              ...
              {/* Options - Single Row */}
              <div className="flex flex-row gap-2 sm:gap-3 md:gap-4 justify-center flex-wrap">
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-pink-300 shadow-xl text-center max-w-2xl w-full">
              {finalScore >= 3 ? (
                <div>
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-600 mb-2 sm:mb-3">Wise Birthday Choices!</h3>
                  <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                    You earned {finalScore} out of {questions.length} — that's balanced budgeting!
                  </p>
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                    ...
                    Remember to balance your spending and saving!
                  </p>
                  <button
                    onClick={() => {
                      setShowResult(false);
