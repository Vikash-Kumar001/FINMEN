  ...
  const questions = [
    {
      id: 1,
      icon: "🧾",
      text: "The shopkeeper charges ₹20 instead of ₹10 for candy. What should you do?",
      choices: [
        { id: "a", text: "Check the bill and ask about the price", correct: true },
        { id: "b", text: "Just pay without looking", correct: false },
        { id: "c", text: "Ask a friend to pay for you", correct: false },
      ],
    },
    {
      id: 2,
      icon: "💰",
      text: "You give ₹50 for candy that costs ₹15. How much change should you get back?",
      choices: [
    ...
    },
    {
      id: 3,
      icon: "🔍",
      text: "The shopkeeper gives you only ₹30 change instead of ₹35. What is the right action?",
      choices: [
        {
          id: "a",
        ...
        { id: "b", text: "Take ₹30 and leave", correct: false },
        { id: "c", text: "Buy more candy with the change", correct: false },
      ],
    },
    {
      id: 4,
      icon: "🍬",
      text: "You want two candies that cost ₹10 each. Can you buy both with ₹15?",
      choices: [
        { id: "a", text: "No, you need ₹20", correct: true },
        { id: "b", text: "Yes, ₹15 is enough", correct: false },
        { id: "c", text: "Only if you get a discount", correct: false },
      ],
    },
    {
      id: 5,
      icon: "🧠",
      text: "What is the best way to be a smart shopper in any shop?",
      choices: [
        {
          id: "a",
          text: "Check prices, bills, and change carefully",
          correct: true,
        },
        { id: "b", text: "Buy everything that looks nice", correct: false },
        { id: "c", text: "Only shop when friends are with you", correct: false },
      ],
    },
  ];
      ...
      <div className="flex items-center justify-between px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 relative z-30 bg-white/40 backdrop-blur-sm border-b border-pink-200 flex-shrink-0 gap-2 sm:gap-4">
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            <ShoppingCart className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-pink-500" />
            <span className="bg-gradient-to-r from-pink-600 via-rose-600 to-amber-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Candy Shop Story</span>
              <span className="xs:hidden">Candy Shop</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-pink-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-pink-700">
                      Candy Shop Question {currentQuestion + 1}
                    </span>
                  </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-pink-200 shadow-xl text-center">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-pink-800 mb-2 sm:mb-4">
                  {isCorrect ? "Smart Shop Choice!" : "Check Again"}
                </h3>
                <p className="text-lg sm:text-xl text-pink-900 mb-6 sm:mb-8 leading-relaxed px-1">
                  {isCorrect
                    ? "Great! That is what a smart shopper would do."
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-pink-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-pink-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — great job checking
                bills, prices, and change!
                <br />
                Smart shoppers always know what they should pay and what they should get
                back. 💰
              </p>
              ...
              <p className="text-pink-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Always check the bill and your change — it keeps your money safe
                and your shopping fair.
              </p>
