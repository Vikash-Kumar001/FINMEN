...
const LostCoinStoryGame = () => {
  ...
  const questions = [
    {
      id: 1,
      situation: "You are walking in class and see a small ₹5 coin on the floor.",
      prompt: "What is the most honest thing to do?",
      options: [
        {
          text: "Give it to the teacher",
          description: "So the real owner can get it back.",
          correct: true,
        },
        {
          text: "Keep it quietly",
          description: "No one saw it, so you take it.",
          correct: false,
        },
        {
          text: "Spend it on candy",
          description: "Use it for a quick treat.",
          correct: false,
        },
      ],
    },
    {
      id: 2,
      situation: "You find a ₹10 note inside a library book you borrowed.",
      prompt: "What is the honest choice?",
      options: [
        {
          text: "Return it to the librarian or owner",
          description: "It belongs to someone who used the book.",
          correct: true,
        },
        {
          text: "Buy snacks with it",
          description: "Use it since you found it.",
          correct: false,
        },
        {
          text: "Hide it in your bag",
          description: "Keep the money a secret.",
          correct: false,
        },
      ],
    },
    {
      id: 3,
      situation: "A shopkeeper gives you ₹5 extra by mistake after you pay.",
      prompt: "What should you do?",
      options: [
        {
          text: "Return the extra change",
          description: "Give back what is not yours.",
          correct: true,
        },
        {
          text: "Keep it quietly",
          description: "Walk away and say nothing.",
          correct: false,
        },
        {
          text: "Spend it on toys",
          description: "Use it since you got it.",
          correct: false,
        },
      ],
    },
    {
      id: 4,
      situation: "You see a ₹20 note lying on the street near your home.",
      prompt: "What is the best action?",
      options: [
        {
          text: "Ask nearby people or adults if they lost it",
          description: "Try to find the owner first.",
          correct: true,
        },
        {
          text: "Take it home",
          description: "Assume it is now yours.",
          correct: false,
        },
        {
          text: "Buy ice cream",
          description: "Spend the money quickly.",
          correct: false,
        },
      ],
    },
    {
      id: 5,
      situation: "You often find small coins or extra change in different places.",
      prompt: "Why is it good to be honest with found money?",
      options: [
        {
          text: "It builds trust and respect",
          description: "People know they can trust you.",
          correct: true,
        },
        {
          text: "It gives you more money",
          description: "You get rich by keeping found coins.",
          correct: false,
        },
        {
          text: "It lets you buy more things",
          description: "You can shop more by keeping it.",
          correct: false,
        },
      ],
    },
      ...
      <div className="flex items-center justify-between px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 relative z-30 bg-white/40 backdrop-blur-sm border-b border-sky-200 flex-shrink-0 gap-2 sm:gap-4">
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            <Coins className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-sky-500" />
            <span className="bg-gradient-to-r from-sky-600 via-blue-600 to-emerald-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Lost Coin Story</span>
              <span className="xs:hidden">Lost Coin</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-sky-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-sky-700">
                      Honest Choices with Found Money
                    </span>
                  </div>
              ...
              <div className="flex items-center justify-center min-h-[60vh]">
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-sky-200 shadow-xl text-center max-w-2xl w-full">
                  ...
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-sky-800 mb-2 sm:mb-3">
                    {isCorrect ? "Honest Choice!" : "Think About Honesty"}
                  </h3>
                  <p className="text-sky-900 text-sm sm:text-base md:text-lg mb-4 sm:mb-6 leading-relaxed px-1">
                    {isCorrect
                      ? "Great! You chose to be fair and honest with found money."
                      : "A more honest choice is: " +
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-sky-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-sky-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You made {finalScore} out of {totalQuestions} honest choices with found
                money.
                <br />
                When you return or report money that isn’t yours, people know they can
                trust you.
              </p>
              ...
              <p className="text-sky-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Money on the floor or in change isn’t a prize — it belongs to
                someone. Honest kids always try to give it back.
              </p>
