...
const NeedsFirstKidBadge = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "You have ₹20. Buy candy or a school notebook?",
      choices: [
        { id: "a", text: "Notebook", emoji: "📓", correct: true },
        { id: "b", text: "Candy", emoji: "🍬", correct: false },
        { id: "c", text: "Toys", emoji: "🧸", correct: false },
      ],
    },
    {
      id: 2,
      text: "You need ₹15 for lunch. You have ₹10. What's smart?",
      choices: [
        { id: "a", text: "Save ₹5 more", emoji: "💰", correct: true },
        { id: "b", text: "Buy snacks", emoji: "🍟", correct: false },
        { id: "c", text: "Borrow ₹5", emoji: "🙈", correct: false },
      ],
    },
    {
      id: 3,
      text: "You want a game but need shoes. What comes first?",
      choices: [
        { id: "a", text: "Shoes", emoji: "👟", correct: true },
        { id: "b", text: "Game", emoji: "🎮", correct: false },
        { id: "c", text: "Both", emoji: "🛍️", correct: false },
      ],
    },
    {
      id: 4,
      text: "You have ₹30. Spend on needs or wants?",
      choices: [
        { id: "a", text: "Needs like books", emoji: "📚", correct: true },
        { id: "b", text: "Wants like toys", emoji: "🧸", correct: false },
        { id: "c", text: "Give it away", emoji: "🎁", correct: false },
      ],
    },
    {
      id: 5,
      ...
      choices: [
        { id: "a", text: "Meets essentials first", emoji: "🥗", correct: true },
        { id: "b", text: "Gets you more toys", emoji: "🛒", correct: false },
        { id: "c", text: "Makes you popular", emoji: "👥", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Badge: Needs First Kid</span>
        ...
        <div className="w-full max-w-3xl flex-1 flex flex-col justify-center min-h-0">
          {showBadge ? (
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-purple-600 mb-3 sm:mb-4">Needs First Kid Badge!</h3>
              <p className="text-gray-700 text-sm sm:text-base md:text-lg mb-4 sm:mb-6">
                Congratulations! You chose needs correctly in all {questions.length} scenarios!
              </p>
            ...
            !showResult ? (
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great choice! You prioritized needs!"
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-600 mb-2 sm:mb-3">Great Effort!</h3>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length}!
                <br />
                {allCorrect ? "You earned the badge!" : "Keep practicing to earn the badge!"}
              </p>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Needs come first for smart choices!
              </p>
