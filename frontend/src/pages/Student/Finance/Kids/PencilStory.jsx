...
const PencilStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "You borrow a pencil from a friend during class. What is the right thing to do after using it?",
      choices: [
        { id: "a", text: "Return it and say thank you", emoji: "🙏", correct: true },
        { id: "b", text: "Keep it in your bag", emoji: "🎒", correct: false },
        { id: "c", text: "Forget about it", emoji: "😐", correct: false },
      ],
    },
    {
      id: 2,
      text: "You need a pencil but don’t have one. What is the honest way to handle this?",
      choices: [
        { id: "a", text: "Ask to borrow and promise to return", emoji: "🤝", correct: true },
        { id: "b", text: "Take someone’s pencil without asking", emoji: "🤫", correct: false },
        { id: "c", text: "Stop writing and do nothing", emoji: "✍️", correct: false },
      ],
    },
    {
      id: 3,
      text: "You accidentally break a pencil you borrowed. What should you do?",
      choices: [
        { id: "a", text: "Tell the friend and replace it", emoji: "✅", correct: true },
        { id: "b", text: "Hide the broken pencil", emoji: "🧸", correct: false },
        { id: "c", text: "Blame someone else", emoji: "🙈", correct: false },
      ],
    },
    {
      id: 4,
      text: "A friend lends you ₹5 to buy a pencil. What is the fair thing to do?",
      choices: [
        { id: "a", text: "Repay the ₹5 as soon as you can", emoji: "💸", correct: true },
        { id: "b", text: "Use the money for candy instead", emoji: "🍬", correct: false },
        { id: "c", text: "Pretend you forgot about it", emoji: "😞", correct: false },
      ],
    },
    {
      id: 5,
      text: "Why is it important to return or replace borrowed items like pencils?",
      choices: [
        { id: "a", text: "It builds trust and shows respect", emoji: "😊", correct: true },
        { id: "b", text: "So you can borrow more things", emoji: "✏️", correct: false },
        { id: "c", text: "To make others do your homework", emoji: "📚", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Pencil Story</span>
              <span className="xs:hidden">Pencil</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great choice! You are an honest borrower!"
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — wonderful honesty with
                borrowed things!
                <br />
                You know how to return, repay, and respect your friends' things. 🎯
              </p>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: When you borrow something, always return it or replace it — that is
                true money honesty.
              </p>
