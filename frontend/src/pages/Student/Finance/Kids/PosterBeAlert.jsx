...
const PosterBeAlert = () => {
  ...
  return (
    <GameShell
      ...
      subtitle="Choose posters to stop scams!"
      coins={coins}
      ...
      <div className="text-center text-white space-y-8">
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
            ...
            <h3 className="text-3xl font-bold mb-4">Scam-Stopper!</h3>
            <p className="text-white/90 text-lg mb-6">
              You earned {coins} out of 5 for raising scam awareness!
            </p>
            <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2 mb-6">
              +{coins} Coins
            </div>
            <p className="text-white/80">Lesson: Stay alert to avoid scams!</p>
          </div>
        )}
      </div>
    </GameShell>
