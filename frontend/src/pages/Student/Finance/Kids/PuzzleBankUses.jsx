...
const PuzzleBankUses = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Match: Deposit → Safe",
      choices: [
        { id: "a", text: "Deposit = Safe", emoji: "🔒", correct: true },
        { id: "b", text: "Deposit = Spend", emoji: "🛍️", correct: false },
        { id: "c", text: "Deposit = Borrow", emoji: "💸", correct: false },
      ],
    },
    {
      id: 2,
      text: "Match: Loan → Borrow",
      choices: [
        { id: "a", text: "Loan = Borrow", emoji: "🤝", correct: true },
        { id: "b", text: "Loan = Save", emoji: "💰", correct: false },
        { id: "c", text: "Loan = Withdraw", emoji: "🏧", correct: false },
      ],
    },
    {
      id: 3,
      text: "Match: ATM → Withdraw",
      choices: [
        { id: "a", text: "ATM = Withdraw", emoji: "🏧", correct: true },
        { id: "b", text: "ATM = Deposit", emoji: "📥", correct: false },
        { id: "c", text: "ATM = Invest", emoji: "📈", correct: false },
      ],
    },
    {
      id: 4,
      text: "Match: Savings Account → Grow Money",
      choices: [
        { id: "a", text: "Savings Account = Grow Money", emoji: "📈", correct: true },
        { id: "b", text: "Savings Account = Spend", emoji: "🛒", correct: false },
        { id: "c", text: "Savings Account = Lose Money", emoji: "😞", correct: false },
      ],
    },
    {
      id: 5,
      text: "Why learn about bank uses?",
      choices: [
        { id: "a", text: "Helps manage money wisely", emoji: "📚", correct: true },
        { id: "b", text: "Makes banks fun", emoji: "🎉", correct: false },
        { id: "c", text: "Gets you more toys", emoji: "🧸", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Puzzle: Bank Uses</span>
              <span className="xs:hidden">Bank Uses</span>
            </span>
          </h1>
        </div>
        ...
        <div className="w-full max-w-3xl flex-1 flex flex-col justify-center min-h-0">
          {finalScore === 0 ? (
            !showResult ? (
                      ...
                      <div
                        ...
                        className={`h-2 rounded-full transition-all ${
                          index < currentQuestion
                            ...
                            : index === currentQuestion
                            ? "bg-orange-500 w-5 sm:w-6 animate-pulse"
                            : "bg-gray-300 w-2"
                        }`}
                      />
                    ))}
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-orange-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great job! You matched correctly!"
                    : "The correct answer is: " + currentQuestionData.choices.find(opt => opt.correct)?.text}
                </p>
                <button
                  onClick={handleNextQuestion}
                  className="px-8 sm:px-10 py-3 sm:py-4 bg-orange-500 hover:bg-orange-600 text-white rounded-xl sm:rounded-2xl font-bold text-lg sm:text-xl transition-all hover:scale-105 shadow-lg"
                >
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-orange-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-600 mb-2 sm:mb-3">Bank Puzzle Master!</h3>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — excellent matching!
                <br />
                You understand bank uses! 🎯
              </p>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Banks help manage money wisely!
              </p>
