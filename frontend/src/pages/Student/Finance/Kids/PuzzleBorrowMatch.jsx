...
const PuzzleBorrowMatch = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Match: Book Borrowed → ?",
      choices: [
        { id: "a", text: "Return", emoji: "📚", correct: true },
        { id: "b", text: "Keep Forever", emoji: "📦", correct: false },
        { id: "c", text: "Throw Away", emoji: "🗑️", correct: false },
      ],
    },
    {
      id: 2,
      text: "Match: Toy Borrowed → ?",
      choices: [
        { id: "a", text: "Share and give back", emoji: "🧸", correct: true },
        { id: "b", text: "Hide it", emoji: "🙈", correct: false },
        { id: "c", text: "Say it’s yours", emoji: "😐", correct: false },
      ],
    },
    {
      id: 3,
      text: "Match: Money Borrowed → ?",
      choices: [
        { id: "a", text: "Repay the amount", emoji: "💸", correct: true },
        { id: "b", text: "Spend and forget", emoji: "🍭", correct: false },
        { id: "c", text: "Ask for more", emoji: "➕", correct: false },
      ],
    },
    {
      id: 4,
      text: "Match: Lunch Borrowed → ?",
      choices: [
        { id: "a", text: "Share back another day", emoji: "🥪", correct: true },
        { id: "b", text: "Never share back", emoji: "🚫", correct: false },
        { id: "c", text: "Laugh about it", emoji: "😅", correct: false },
      ],
    },
    {
      id: 5,
      text: "Match: Help Borrowed (friend helped you) → ?",
      choices: [
        { id: "a", text: "Say thank you and help them someday", emoji: "🤝", correct: true },
        { id: "b", text: "Ignore it", emoji: "😑", correct: false },
        { id: "c", text: "Pretend you did it alone", emoji: "🙄", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Puzzle: Borrow Match</span>
              <span className="xs:hidden">Borrow Match</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great match! You chose the right action for that borrowed thing!"
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-600 mb-2 sm:mb-3">
                Borrowing Puzzle Master!
              </h3>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — great matching!
                <br />
                You know how to match borrowed things with honest actions. 🎯
              </p>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: “Book Borrowed → Return”, “Money Borrowed → Repay”, “Help Borrowed →
                Thank and help back.”
              </p>
