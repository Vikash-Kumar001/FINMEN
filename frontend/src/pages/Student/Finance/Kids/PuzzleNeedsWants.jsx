...
const PuzzleNeedsWants = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Match: Water → Need, Candy → Want",
      choices: [
        { id: "a", text: "Water = Need, Candy = Want", emoji: "🥤🍬", correct: true },
        { id: "b", text: "Water = Want, Candy = Need", emoji: "🍬🥤", correct: false },
        { id: "c", text: "Both are Needs", emoji: "🥤🍬", correct: false },
      ],
    },
    {
      id: 2,
      text: "Match: Shoes → Need, Video Game → Want",
      choices: [
        { id: "a", text: "Shoes = Need, Video Game = Want", emoji: "👟🎮", correct: true },
        { id: "b", text: "Shoes = Want, Video Game = Need", emoji: "🎮👟", correct: false },
        { id: "c", text: "Both are Wants", emoji: "👟🎮", correct: false },
      ],
    },
    {
      id: 3,
      text: "Match: Food → Need, Toy Car → Want",
      choices: [
        { id: "a", text: "Food = Need, Toy Car = Want", emoji: "🍎🚗", correct: true },
        { id: "b", text: "Food = Want, Toy Car = Need", emoji: "🚗🍎", correct: false },
        { id: "c", text: "Both are Needs", emoji: "🍎🚗", correct: false },
      ],
    },
    {
      id: 4,
      text: "Match: School Books → Need, Ice Cream → Want",
      choices: [
        { id: "a", text: "School Books = Need, Ice Cream = Want", emoji: "📚🍨", correct: true },
        { id: "b", text: "School Books = Want, Ice Cream = Need", emoji: "🍨📚", correct: false },
        { id: "c", text: "Both are Wants", emoji: "📚🍨", correct: false },
      ],
    },
    {
      id: 5,
      text: "Why distinguish between needs and wants?",
      choices: [
        { id: "a", text: "Helps prioritize spending", emoji: "📚", correct: true },
        { id: "b", text: "Makes buying toys fun", emoji: "🧸", correct: false },
        { id: "c", text: "Gets you more candy", emoji: "🍬", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Puzzle: Needs/Wants</span>
              <span className="xs:hidden">Needs/Wants</span>
            </span>
          </h1>
        </div>
        ...
        <div className="w-full max-w-3xl flex-1 flex flex-col justify-center min-h-0">
          {finalScore === 0 ? (
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-600 mb-2 sm:mb-3">Needs/Wants Puzzle Star!</h3>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You earned {finalScore} out of {questions.length} — great matching!
                <br />
                You understand needs and wants! 🎯
              </p>
