  ...
  const questions = [
    {
      id: 1,
      icon: "🌱",
      text: "Which pair shows how something small can grow bigger over time?",
      choices: [
        { id: "a", text: "Seed → Tree", correct: true },
        { id: "b", text: "Seed → Stone", correct: false },
        { id: "c", text: "Tree → Seed", correct: false },
      ],
    },
    {
      id: 2,
      icon: "💰",
      text: "Which pair is just like money saved in a bank growing bigger?",
      choices: [
        { id: "a", text: "Savings → Growth", correct: true },
        { id: "b", text: "Savings → Candy", correct: false },
        { id: "c", text: "Savings → New Game", correct: false },
      ],
    },
    {
      id: 3,
      icon: "🏦",
      text: "Which pair shows what happens when you put money in a bank deposit?",
      choices: [
        { id: "a", text: "Bank Deposit → Interest", correct: true },
        { id: "b", text: "Bank Deposit → Toys", correct: false },
        { id: "c", text: "Bank Deposit → Ice cream", correct: false },
      ],
    },
    {
      id: 4,
      icon: "📊",
      text: "Which pair shows what a good investment can lead to?",
      choices: [
        { id: "a", text: "Investment → Profit", correct: true },
        { id: "b", text: "Investment → Nothing", correct: false },
        { id: "c", text: "Investment → Trash", correct: false },
      ],
    },
    {
      id: 5,
      icon: "🪴",
      text: "Which pair is like saving money for your future dreams?",
      choices: [
        { id: "a", text: "Money Saved → Future Fund", correct: true },
        { id: "b", text: "Money Saved → Instant Snack", correct: false },
        { id: "c", text: "Money Saved → New Problem", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-emerald-600 via-green-600 to-sky-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Puzzle of Growth</span>
              <span className="xs:hidden">Growth Puzzle</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-emerald-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-emerald-700">
                      Money Growth Puzzle {currentQuestion + 1}
                    </span>
                  </div>
                      ...
                      return (
                        <button
                          ...
                          className={`flex-1 min-w-[120px] sm:min-w-[150px] p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl shadow-lg transition-all transform hover:scale-105 disabled:opacity-75 disabled:cursor-not-allowed disabled:transform-none ${
                            !showResult
                              ? "bg-gradient-to-r from-emerald-400 via-green-400 to-sky-400 hover:from-emerald-500 hover:via-green-500 hover:to-sky-500 text-white border-2 border-white/40"
                              ...
                              : "bg-gradient-to-r from-emerald-300/60 via-green-300/60 to-sky-300/60 text-emerald-900 border-2 border-white/30"
                          }`}
                        >
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-emerald-200 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-emerald-800 mb-6 sm:mb-8 leading-relaxed px-1">
                  {isCorrect
                    ? "Great! That pair shows how small things can grow — just like savings."
                    : "The best growth match is: " +
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-emerald-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-emerald-700 mb-2 sm:mb-3">
                Growth Puzzle Master!
              </h3>
              <p className="text-emerald-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — awesome matching of
                growth pairs!
                <br />
                Just like seeds become trees, your savings can grow into future funds. 🌳
              </p>
              ...
              <p className="text-emerald-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Small, smart steps with money today can grow into big results
                tomorrow.
              </p>
