  ...
  const questions = [
    {
      ...
      text: "What is a bank?",
      choices: [
        { id: "a", text: "Toy shop", emoji: "🧸", correct: false },
        { id: "b", text: "Place to keep money safe", emoji: "🏦", correct: true },
        { id: "c", text: "Ice cream shop", emoji: "🍦", correct: false },
      ],
    },
    {
      id: 2,
      ...
      choices: [
        { id: "a", text: "Gives you toys", emoji: "🧸", correct: false },
        { id: "b", text: "Grows your money", emoji: "📈", correct: true },
        { id: "c", text: "Sells food", emoji: "🍔", correct: false },
      ],
    },
    {
      id: 3,
      ...
      choices: [
        { id: "a", text: "Buy clothes", emoji: "👕", correct: false },
        { id: "b", text: "Withdraw money", emoji: "💰", correct: true },
        { id: "c", text: "Play games", emoji: "🎮", correct: false },
      ],
    },
    {
      id: 4,
      ...
      choices: [
        { id: "a", text: "To help you borrow money", emoji: "🤝", correct: true },
        { id: "b", text: "To give free money", emoji: "🎁", correct: false },
        { id: "c", text: "To sell toys", emoji: "🧸", correct: false },
      ],
    },
    {
      id: 5,
      ...
      choices: [
        { id: "a", text: "They protect your savings", emoji: "🔒", correct: true },
        { id: "b", text: "They give you candy", emoji: "🍬", correct: false },
        { id: "c", text: "They hide money", emoji: "🙈", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Quiz on Banks</span>
              <span className="xs:hidden">Banks Quiz</span>
            </span>
          </h1>
        </div>
        ...
        <div className="w-full max-w-3xl flex-1 flex flex-col justify-center min-h-0">
          {finalScore === 0 ? (
            !showResult ? (
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great job! You know about banks!"
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-600 mb-2 sm:mb-3">Bank Quiz Master!</h3>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — excellent banking knowledge!
                <br />
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Banks keep and grow your money!
              </p>
