...
const QuizBorrowing = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "What is the best meaning of borrowing?",
      choices: [
        { id: "a", text: "Taking without asking", emoji: "🙈", correct: false },
        { id: "b", text: "Using something and then returning it", emoji: "🤝", correct: true },
        { id: "c", text: "Keeping it forever", emoji: "📦", correct: false },
      ],
    },
    {
      id: 2,
      text: "What should you do after borrowing a book from a friend?",
      choices: [
        { id: "a", text: "Keep it as your own", emoji: "📚", correct: false },
        { id: "b", text: "Return it in good condition", emoji: "✅", correct: true },
        { id: "c", text: "Give it to someone else", emoji: "🎁", correct: false },
      ],
    },
    {
      id: 3,
      text: "Why is borrowing money from a bank okay when done honestly?",
      choices: [
        { id: "a", text: "Because you repay it with interest", emoji: "💰", correct: true },
        { id: "b", text: "Because it is free money", emoji: "🎉", correct: false },
        { id: "c", text: "Because you never have to return it", emoji: "😅", correct: false },
      ],
    },
    {
      id: 4,
      text: "What happens if you don’t return borrowed things or money?",
      choices: [
        { id: "a", text: "You lose people’s trust", emoji: "💔", correct: true },
        { id: "b", text: "You get more gifts", emoji: "🎁", correct: false },
        { id: "c", text: "Nothing happens", emoji: "😐", correct: false },
      ],
    },
    {
      id: 5,
      ...
      choices: [
        { id: "a", text: "It builds trust and good friendships", emoji: "😊", correct: true },
        { id: "b", text: "It gets you more toys", emoji: "🧸", correct: false },
        { id: "c", text: "It makes borrowing fun", emoji: "🎲", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Quiz on Borrowing</span>
              <span className="xs:hidden">Borrowing Quiz</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-blue-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great job! You understand how to borrow the right way!"
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-blue-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — awesome borrowing
                skills!
                <br />
                You know how to borrow, return, and keep trust with others. 🎯
              </p>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Always return what you borrow, repay what you owe, and people will
                trust you with money and things.
              </p>
