  ...
  const questions = [
    {
      id: 1,
      icon: "📈",
      text: "What is the best way to help your money grow over time?",
      choices: [
        { id: "a", text: "Save it and earn interest", correct: true },
        { id: "b", text: "Spend it as soon as you get it", correct: false },
    ...
    },
    {
      id: 2,
      icon: "🏦",
      text: "How does keeping money in a bank help it grow?",
      choices: [
        { id: "a", text: "The bank pays you interest", correct: true },
        { id: "b", text: "The bank gives you toys", correct: false },
        { id: "c", text: "The bank keeps it forever", correct: false },
      ],
    },
    {
      id: 3,
      icon: "💰",
      text: "Which is a safe place to grow your savings?",
      choices: [
        { id: "a", text: "In a bank savings account", correct: true },
        { id: "b", text: "In a candy shop", correct: false },
        { id: "c", text: "Loose in your school bag", correct: false },
      ],
    },
    {
      id: 4,
      icon: "📊",
      text: "What does investing usually mean?",
      choices: [
        { id: "a", text: "Putting money where it can grow", correct: true },
        { id: "b", text: "Throwing money away", correct: false },
        { id: "c", text: "Spending money on snacks", correct: false },
      ],
    },
    {
      id: 5,
      icon: "⏳",
      text: "Which habit helps your money grow the most?",
      choices: [
        { id: "a", text: "Saving a little regularly for a long time", correct: true },
        { id: "b", text: "Saving once and then stopping", correct: false },
        { id: "c", text: "Only saving when you feel like it", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Quiz on Growth</span>
              <span className="xs:hidden">Growth Quiz</span>
            </span>
          </h1>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center px-2 sm:px-4 md:px-6 z-10 py-2 sm:py-4 overflow-y-auto min-h-0">
        {!showResult && finalScore === 0 && (
          <div className="mb-1 sm:mb-2 md:mb-3 relative z-20 flex-shrink-0">
            <p className="text-sky-800 text-xs sm:text-sm mt-0.5 sm:mt-1 font-medium">
          ...
          {finalScore === 0 ? (
            !showResult ? (
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-sky-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-sky-700">
                      Money Growth Question {currentQuestion + 1}
                    </span>
                  </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-sky-200 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-sky-800 mb-6 sm:mb-8 leading-relaxed px-1">
                  {isCorrect
                    ? "Great job! That’s how money grows safely over time."
                    : "The best answer is: " +
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-sky-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-sky-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — your money-growth
                knowledge is strong!
                <br />
                Remember: saving regularly and using banks and investments can grow your
                money over time. 💹
              </p>
              ...
              <p className="text-sky-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Let time, saving, and smart choices grow your money step by step.
              </p>
