  ...
  const questions = [
    {
      id: 1,
      icon: "🤝",
      text: "Who is the most honest person in a money situation?",
      choices: [
        { id: "a", text: "The one who gives correct change", correct: true },
        { id: "b", text: "The one who cheats customers", correct: false },
        { id: "c", text: "The one who lies about prices", correct: false },
      ],
    },
    {
      id: 2,
      ...
      choices: [
        { id: "a", text: "Charges fair prices and gives correct change", correct: true },
        { id: "b", text: "Overcharges customers on purpose", correct: false },
        { id: "c", text: "Hides important information", correct: false },
      ],
    },
    {
      id: 3,
      icon: "💡",
      text: "How does honesty help when people are shopping?",
      choices: [
        { id: "a", text: "It builds trust between buyer and seller", correct: true },
        { id: "b", text: "It gets you free items", correct: false },
    ...
    },
    {
      id: 4,
      icon: "📚",
      text: "What is an honest way to borrow something?",
      choices: [
        { id: "a", text: "Return it on time and in good condition", correct: true },
        { id: "b", text: "Keep it forever", correct: false },
        { id: "c", text: "Borrow more and never return", correct: false },
      ],
    },
    {
      id: 5,
      ...
      choices: [
        { id: "a", text: "Because it earns trust from others", correct: true },
        { id: "b", text: "Because it always gets you toys", correct: false },
        { id: "c", text: "Because it makes you famous", correct: false },
      ],
    },
  ];
      ...
      <div className="flex items-center justify-between px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 relative z-30 bg-white/40 backdrop-blur-sm border-b border-emerald-200 flex-shrink-0 gap-2 sm:gap-4">
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            <ClipboardCheck className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-emerald-500" />
            <span className="bg-gradient-to-r from-emerald-600 via-sky-600 to-indigo-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Quiz on Honesty</span>
          ...
          {finalScore === 0 ? (
            !showResult ? (
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-emerald-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-emerald-700">
                      Honesty Question {currentQuestion + 1}
                    </span>
                  </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-emerald-200 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-emerald-900 mb-6 sm:mb-8 leading-relaxed px-1">
                  {isCorrect
                    ? "Great! That is what an honest person would do."
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-emerald-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-emerald-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                ...
                honesty and money should go together!
                <br />
                Honest choices build trust with friends, family, and customers. 🤝
              </p>
              ...
              <p className="text-emerald-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Being honest with money — about prices, change, and borrowing —
                makes you someone people can trust.
              </p>
