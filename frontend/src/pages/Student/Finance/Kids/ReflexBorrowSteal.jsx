...
const ReflexBorrowSteal = () => {
  ...
  const stages = [
    {
      action: "Return Borrowed",
      wrong: "Keep Forever",
      prompt: "Tap for the honest borrowing action!",
    },
    {
      action: "Repay Loan",
      wrong: "Avoid Payment",
      prompt: "Tap for the fair money action!",
    },
    {
      action: "Give Back",
      wrong: "Hide",
      prompt: "Tap to give back what you borrowed!",
    },
    {
      action: "Be Honest",
      wrong: "Cheat",
      prompt: "Tap to choose honesty!",
    },
    {
      action: "Return On Time",
      wrong: "Delay",
      prompt: "Tap to return on time!",
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Reflex: Borrow vs Steal</span>
              <span className="xs:hidden">Borrow/Steal</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-blue-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great choice! You chose honest borrowing instead of stealing!"
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-blue-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-600 mb-2 sm:mb-3">
                Borrowing Reflex Star!
              </h3>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {stages.length} — strong borrowing reflexes!
                <br />
                You know how to return, repay, and choose honesty over stealing. 🎯
              </p>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Borrowing is about trust — always return what you take and never
                steal.
              </p>
