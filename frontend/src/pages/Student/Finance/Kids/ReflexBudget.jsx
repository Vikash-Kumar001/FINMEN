...
const ReflexBudget = () => {
  ...
  const handleTap = (isSmart) => {
    ...
    const isCorrect = (isSmart && currentWord.isCorrect) || (!isSmart && !currentWord.isCorrect);
  ...
  const handleNext = () => {
    navigate("/student/finance/kids/budget-items-puzzle");
  };
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-purple-500 via-indigo-500 to-pink-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Reflex: Budget</span>
              <span className="xs:hidden">Reflex Budget</span>
            </span>
          </h1>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center px-2 sm:px-4 md:px-6 z-10 py-2 sm:py-4 overflow-y-auto min-h-0">
        ...
        <div className="w-full max-w-2xl flex-1 flex flex-col justify-center min-h-0">
          {gameState === "waiting" && (
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-700 mb-3 sm:mb-4">Get Ready!</h3>
                ...
                <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-5 text-left">
                  <div className="flex items-start gap-2 sm:gap-3 bg-green-50 rounded-lg p-2 sm:p-3">
                    ...
                    <p className="text-gray-700 text-xs sm:text-sm md:text-base">
                      Tap <span className="font-bold text-green-600">"SMART CHOICE"</span> when you see words like: Plan Before Spending, Save First, Track Expenses, Set Goals, Budget Wisely
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 bg-red-50 rounded-lg p-2 sm:p-3">
                    <span className="text-xl sm:text-2xl flex-shrink-0">❌</span>
                    <p className="text-gray-700 text-xs sm:text-sm md:text-base">
                      Tap <span className="font-bold text-red-600">"BAD CHOICE"</span> when you see words like: Spend Instantly, Buy Now, Ignore Costs, Spend Freely, Overspend
                    </p>
                  </div>
                </div>
          ...
          {gameState === "playing" && (
            <div className="space-y-3 sm:space-y-4">
              {/* Timer and Score */}
              <div className="flex justify-between items-center bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 border-2 border-purple-300 shadow-lg">
              ...
              {/* Word Display */}
              {currentWord && (
                <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 border-2 border-purple-300 shadow-xl">
                  <div className="text-5xl sm:text-6xl md:text-7xl mb-3 sm:mb-4">{currentWord.emoji}</div>
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-purple-700 mb-4 sm:mb-6">
                    {currentWord.text}
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    >
                      <div className="text-3xl sm:text-4xl mb-2">❌</div>
                      <h3 className="font-bold text-base sm:text-lg md:text-xl">BAD CHOICE</h3>
                    </button>
                  </div>
                </div>
              )}
          ...
          {gameState === "finished" && (
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center">
              <div className="text-4xl sm:text-5xl md:text-6xl mb-3 sm:mb-4">🏆</div>
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-700 mb-3 sm:mb-4">Game Over!</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 mb-4 sm:mb-5">
                <div className="bg-gradient-to-r from-blue-500/30 to-indigo-500/30 p-3 sm:p-4 rounded-lg sm:rounded-xl">
                  <p className="text-2xl sm:text-3xl font-bold text-purple-700">{score}</p>
                ...
                <div className="bg-gradient-to-r from-green-500/30 to-emerald-500/30 p-3 sm:p-4 rounded-lg sm:rounded-xl">
                  <p className="text-2xl sm:text-3xl font-bold text-purple-700">{bestStreak}</p>
                ...
                <div className="bg-gradient-to-r from-purple-500/30 to-pink-500/30 p-3 sm:p-4 rounded-lg sm:rounded-xl">
                  <p className="text-2xl sm:text-3xl font-bold text-purple-700">{Math.round((score / 30) * 60)}</p>
              ...
              {score >= 15 ? (
                <div>
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-600 mb-2 sm:mb-3">Amazing Reflexes!</h3>
                  <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4">
                    You scored {score} points! You know your budgeting habits well! 📊
                  </p>
                </div>
              ) : score >= 10 ? (
                <div>
                  <div className="text-4xl sm:text-5xl md:text-6xl mb-2 sm:mb-3">👍</div>
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-600 mb-2 sm:mb-3">Good Job!</h3>
                  <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4">
                ...
                <div>
                  <div className="text-4xl sm:text-5xl md:text-6xl mb-2 sm:mb-3">💪</div>
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-600 mb-2 sm:mb-3">Keep Practicing!</h3>
                  <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4">
