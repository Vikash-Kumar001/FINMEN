...
const ReflexEthicsGame = () => {
  ...
  const stages = [
    {
      id: 1,
      prompt: "You are tempted to cheat on a test. What is the right choice?",
      action: "Truth",
      wrong: "Cheat",
    },
    {
      id: 2,
      prompt: "You made a mistake with money. What should you choose?",
      action: "Honest",
      wrong: "Lie",
    },
    {
      id: 3,
      prompt: "You and a friend share money for a game. How should you act?",
      action: "Fair",
      wrong: "Unfair",
    },
    {
      id: 4,
      prompt: "Someone trusts you with their savings. What should you be?",
      action: "Trust",
      wrong: "Deceive",
    },
    {
      id: 5,
      prompt: "You have to pick how to behave with money every day. What is best?",
      action: "Ethical",
      wrong: "Dishonest",
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-emerald-600 via-sky-600 to-indigo-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Reflex: Ethics</span>
              <span className="xs:hidden">Ethics Reflex</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
              ...
              <div className="flex items-center justify-center min-h-[60vh]">
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-emerald-200 shadow-xl text-center max-w-2xl w-full">
                  ...
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-emerald-800 mb-2 sm:mb-3">
                    {isCorrect ? "Ethics First!" : "Think About What’s Right"}
                  </h3>
                  <p className="text-emerald-900 text-sm sm:text-base md:text-lg mb-4 sm:mb-6 leading-relaxed px-1">
                    {isCorrect
                      ? "Great reflex — you picked the honest and fair choice."
                      : "The better choice is: " + currentStageData.action + "."}
                  </p>
                  <button
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-emerald-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-emerald-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You chose the ethical option in {finalScore} out of {totalStages} rounds.
                <br />
                Choosing truth, fairness, and honesty with money makes you someone others
                can trust.
              </p>
              ...
              <p className="text-emerald-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Ethics isn’t just about rules — it’s about doing what’s right,
                even when it’s hard.
              </p>
              {allStagesAnswered && (
                <button
