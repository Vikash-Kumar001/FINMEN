  ...
  const stages = [
    {
      ...
      wrong: "Money Lost",
      prompt: "Tap the outcome that shows money growing: interest earned or money lost?",
    },
    {
      id: 2,
      action: "Savings Grew",
      wrong: "Money Spent",
      prompt: "Your balance changed. Which shows growth: savings grew or money spent?",
    },
    {
      id: 3,
      action: "Profit Made",
      wrong: "Loss Incurred",
      prompt: "An investment changed. Which is growth: profit made or loss incurred?",
    },
    {
      id: 4,
      action: "Investment Up",
      wrong: "Money Down",
      prompt: "The value moved. Which is better: investment up or money down?",
    },
    {
      id: 5,
      action: "Wealth Grows",
      wrong: "Funds Shrink",
      prompt: "For your future, what do you want: wealth grows or funds shrink?",
    },
  ];
      ...
      <div className="flex items-center justify-between px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 relative z-30 bg-white/40 backdrop-blur-sm border-b border-sky-200 flex-shrink-0 gap-2 sm:gap-4">
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            <Zap className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-sky-500" />
            <span className="bg-gradient-to-r from-sky-600 via-blue-600 to-emerald-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Reflex: Growth Check</span>
              <span className="xs:hidden">Growth Check</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-sky-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    <Zap className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-sky-500" />
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-sky-700">
                      Growth Reflex Round {currentStage + 1}
                    </span>
                  </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-sky-200 shadow-xl text-center">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-sky-800 mb-2 sm:mb-4">
                  {isCorrect ? "Growth Detected!" : "Look for Growth"}
                </h3>
                <p className="text-lg sm:text-xl text-sky-900 mb-6 sm:mb-8 leading-relaxed px-1">
                  {isCorrect
                    ? "Nice! You spotted the result where money actually grows."
                    : "The better growth choice is: " + stages[currentStage].action}
                </p>
                <button
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-sky-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-sky-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {stages.length} — you’re quick at spotting
                where money is growing!
                <br />
                Remember: interest, profit, and “up” moves are signs that your wealth is
                on the rise. 💹
              </p>
              ...
              <p className="text-sky-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Always check if a money choice is helping your savings grow or
                making them shrink.
              </p>
              {allStagesAnswered && (
                <button
