...
const ReflexNeedsFirst = () => {
  ...
  const handleTap = (isNeed) => {
    ...
    const isCorrect = (isNeed && currentItem.type === "correct") || (!isNeed && currentItem.type === "wrong");
    ...
    // Generate next item after a short delay
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-br from-green-100 via-emerald-50 to-teal-100 flex flex-col relative overflow-hidden">
      {/* Floating Needs/Wants Elements Background */}
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Reflex: Needs First</span>
                ...
                <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-5 text-left">
                  <div className="flex items-start gap-2 sm:gap-3 bg-green-50 rounded-lg p-2 sm:p-3">
                    ...
                    <p className="text-gray-700 text-xs sm:text-sm md:text-base">
                      Tap <span className="font-bold text-green-600">"NEED"</span> when you see items like: Books, School Supplies, Healthy Food, Medicine, Toothbrush
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 bg-red-50 rounded-lg p-2 sm:p-3">
                    <span className="text-xl sm:text-2xl flex-shrink-0">❌</span>
                    <p className="text-gray-700 text-xs sm:text-sm md:text-base">
                      Tap <span className="font-bold text-red-600">"WANT"</span> when you see items like: Unneeded Toys, Expensive Gadgets, Candy, Designer Clothes, Video Games
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              {currentItem && (
                <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 border-2 border-green-300 shadow-xl">
                  <div className="text-5xl sm:text-6xl md:text-7xl mb-3 sm:mb-4">{currentItem.emoji}</div>
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-green-700 mb-2 sm:mb-3">
                    {currentItem.text}
                  </div>
                  <p className="text-gray-600 text-sm sm:text-base mb-4 sm:mb-6">{currentItem.description}</p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    >
                      ...
                      <h3 className="font-bold text-base sm:text-lg md:text-xl">NEED</h3>
                    </button>
                    ...
                    >
                      <div className="text-3xl sm:text-4xl mb-2">❌</div>
                      <h3 className="font-bold text-base sm:text-lg md:text-xl">WANT</h3>
                    </button>
                  </div>
                </div>
              )}
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-green-300 shadow-xl text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 mb-4 sm:mb-5">
                ...
                <div className="bg-gradient-to-r from-purple-500/30 to-pink-500/30 p-3 sm:p-4 rounded-lg sm:rounded-xl">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">Items/Min</p>
                </div>
              </div>
