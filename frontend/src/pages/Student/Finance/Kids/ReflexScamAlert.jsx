  ...
  const stages = [
    {
      ...
      wrong: "Ignore",
      prompt:
        "The bill looks higher than expected. What should you do: check the bill or ignore it?",
    },
    {
      id: 2,
      action: "Verify Offer",
      wrong: "Accept Fast",
      prompt:
        "You see a deal that looks “too good to be true.” What is safer: verify the offer or accept fast?",
    },
    {
      id: 3,
      ...
      wrong: "Trust Blindly",
      prompt:
        "Someone asks for your money online. What should you do: ask questions or trust blindly?",
    },
    {
      id: 4,
      ...
      wrong: "Pay Now",
      prompt:
        "Before paying a stranger, what is safer: confirm details or pay immediately?",
    },
    {
      id: 5,
      action: "Report Scam",
      wrong: "Do Nothing",
      prompt:
        "You spot a scam message. What is the right step: report the scam or do nothing?",
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-rose-600 via-red-600 to-amber-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Reflex: Scam Alert</span>
              <span className="xs:hidden">Scam Alert</span>
            </span>
          </h1>
        </div>
        ...
        <div className="w-full max-w-3xl flex-1 flex flex-col justify-center min-h-0">
          {finalScore === 0 ? (
            !showResult ? (
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-rose-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-rose-700">
                      Scam Alert Reflex Round {currentStage + 1}
                    </span>
                  </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-rose-200 shadow-xl text-center">
                <div
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-rose-800 mb-2 sm:mb-4">
                  {isCorrect ? "Scam Spotted!" : "Look More Carefully"}
                </h3>
                <p className="text-lg sm:text-xl text-rose-900 mb-6 sm:mb-8 leading-relaxed px-1">
                  {isCorrect
                    ? "Great! You reacted like a scam-smart hero."
                    : "A safer action is: " + stages[currentStage].action}
                </p>
                <button
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-rose-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-rose-700 mb-2 sm:mb-3">
                Scam Alert Reflex Star!
              </h3>
              <p className="text-rose-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {stages.length} — strong scam-spotting
                reflexes!
                <br />
                Always slow down, check details, and report anything that looks like a
                trick. 🔍
              </p>
              ...
              <p className="text-rose-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Scams lose money and trust — smart kids always double-check
                before they pay or share information.
              </p>
              {allStagesAnswered && (
                <button
                  onClick={() => navigate(resolvedBackPath)}
