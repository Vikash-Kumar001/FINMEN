...
const ReflexSmallBusiness = () => {
  ...
  const stages = [
    {
      ...
      wrong: "Buy & Waste",
      prompt:
        "You bake cookies. What is the business move: bake & sell, or buy and waste?",
    },
    {
      id: 2,
      action: "Make Crafts",
      wrong: "Spend All",
      prompt:
        "You love art. What helps your small business more: make crafts to sell or just spend everything?",
    },
    {
      id: 3,
      ...
      wrong: "Do Nothing",
      prompt:
        "Your neighbor needs help walking their dog. What helps you earn: offer a service or do nothing?",
    },
    {
      id: 4,
      action: "Save Profits",
      wrong: "Spend Profits",
      prompt:
        "Your stand makes a profit. What helps your business grow: save profits or spend them all?",
    },
    {
      id: 5,
      ...
      wrong: "Waste Money",
      prompt:
        "You can use your money to grow your business or waste it. Which choice builds a stronger small business?",
    },
  ];
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-br from-amber-100 via-orange-50 to-emerald-100 flex flex-col relative overflow-hidden">
      ...
      <div className="flex items-center justify-between px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 relative z-30 bg-white/40 backdrop-blur-sm border-b border-amber-200 flex-shrink-0 gap-2 sm:gap-4">
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            <Zap className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-amber-500" />
            <span className="bg-gradient-to-r from-amber-600 via-orange-600 to-emerald-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Reflex: Small Business</span>
              <span className="xs:hidden">Small Business</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-amber-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-amber-700">
                      Small Business Reflex Round {currentStage + 1}
                    </span>
                  </div>
                  <p className="text-amber-950 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 font-semibold leading-relaxed px-1">
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-amber-200 shadow-xl text-center">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-amber-800 mb-2 sm:mb-4">
                  {isCorrect ? "Smart Business Move!" : "Think Like an Owner"}
                </h3>
                <p className="text-lg sm:text-xl text-amber-900 mb-6 sm:mb-8 leading-relaxed px-1">
                  {isCorrect
                    ? "Great! That choice helps your small business grow and stay strong."
                    : "The better business choice is: " + stages[currentStage].action}
                </p>
                <button
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-amber-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-amber-700 mb-2 sm:mb-3">
                Business Reflex Star!
              </h3>
              <p className="text-amber-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {stages.length} — you’re quick at choosing
                smart business actions!
                <br />
                Small business success comes from good ideas, saving profits, and growing
                step by step. 💰
              </p>
              ...
              <p className="text-amber-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Treat your ideas like a small business — earn, save, and reinvest
                to grow them.
              </p>
              {allStagesAnswered && (
                <button
