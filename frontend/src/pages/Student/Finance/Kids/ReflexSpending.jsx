...
const ReflexSpending = () => {
  ...
  const words = [
    ...
    { text: "Buy Now", type: "wrong", emoji: "⏰" },
    { text: "Budget First", type: "correct", emoji: "📊" },
    { text: "No Plan", type: "wrong", emoji: "❌" },
    { text: "Research Deal", type: "correct", emoji: "🛒" },
    { text: "Random Shop", type: "wrong", emoji: "🛍️" }
  ];
        ...
        {gameState === "waiting" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 mb-6">
              Tap the words that represent smart spending habits as fast as you can!
            </p>
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-green-500/20 p-4 rounded-xl">
                <h3 className="font-bold text-green-300 mb-2">Smart Choices</h3>
                <p className="text-white/80 text-sm">Plan Purchase, Save Money, Compare Prices, Budget First, Research Deal</p>
              </div>
              <div className="bg-red-500/20 p-4 rounded-xl">
                <h3 className="font-bold text-red-300 mb-2">Impulse Choices</h3>
                <p className="text-white/80 text-sm">Impulse Buy, Spend All, Buy Now, No Plan, Random Shop</p>
              </div>
            </div>
            <button
              onClick={startGame}
        ...
        {gameState === "playing" && (
          <div className="space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20">
              <h3 className="text-white font-bold mb-2 text-center">Smart Spending Habits</h3>
