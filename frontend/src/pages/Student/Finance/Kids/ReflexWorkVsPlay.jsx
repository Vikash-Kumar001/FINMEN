  ...
  const stages = [
    {
      ...
      wrong: "Waste → Nothing",
      prompt:
        "You can choose to work and earn or waste time and earn nothing. Which is better for your future?",
    },
    {
      id: 2,
      action: "Study → Learn",
      wrong: "Play All Day",
      prompt:
        "You have homework to do. Which habit helps you learn and get better chances later?",
    },
    {
      id: 3,
      action: "Save Earnings",
      wrong: "Spend All",
      prompt:
        "You earn some pocket money. Which choice helps you reach your goals faster?",
    },
    {
      id: 4,
      action: "Do Chores",
      wrong: "Skip Chores",
      prompt:
        "Your family asks for help with simple chores. Which action shows responsibility?",
    },
    {
      id: 5,
      action: "Plan Work",
      wrong: "Stay Idle",
      prompt:
        "You have free time. Which habit helps you manage school, play, and future work better?",
    },
  ];
      ...
      <div className="flex items-center justify-between px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 relative z-30 bg-white/40 backdrop-blur-sm border-b border-indigo-200 flex-shrink-0 gap-2 sm:gap-4">
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            <Zap className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-indigo-500" />
            <span className="bg-gradient-to-r from-indigo-600 via-sky-600 to-emerald-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Reflex: Work vs Play</span>
              <span className="xs:hidden">Work vs Play</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-indigo-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    <Zap className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-indigo-500" />
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-indigo-700">
                      Work vs Play Round {currentStage + 1}
                    </span>
                  </div>
                  <p className="text-indigo-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 font-semibold leading-relaxed px-1">
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-indigo-200 shadow-xl text-center">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-indigo-800 mb-2 sm:mb-4">
                  {isCorrect ? "Right Work Choice!" : "Think About the Future"}
                </h3>
                <p className="text-lg sm:text-xl text-indigo-900 mb-6 sm:mb-8 leading-relaxed px-1">
                  {isCorrect
                    ? "Great! Working, learning, and planning first helps you enjoy play later."
                    : "A better habit is: " + stages[currentStage].action}
                </p>
                <button
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-indigo-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-indigo-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {stages.length} — you’re great at picking
                work and learning before play!
                <br />
                When you handle work first, play time feels better and your future looks
                brighter. 🌟
              </p>
              ...
              <p className="text-indigo-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Balance is best — finish work, then enjoy play, and your goals will
                grow faster.
              </p>
              {allStagesAnswered && (
                <button
