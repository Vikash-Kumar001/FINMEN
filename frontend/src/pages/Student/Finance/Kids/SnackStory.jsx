  ...
  const questions = [
    {
      ...
      choices: [
        { id: "a", text: "Lunch", emoji: "🍱", correct: true },
        { id: "b", text: "Chips", emoji: "🍟", correct: false },
      ],
    },
    {
      id: 2,
      ...
      choices: [
        { id: "a", text: "Healthy Snack", emoji: "🥗", correct: true },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Water", emoji: "💧", correct: true },
        { id: "b", text: "Soda", emoji: "🥤", correct: false },
      ],
    },
    {
      id: 4,
      ...
      choices: [
        { id: "a", text: "Fruit", emoji: "🍎", correct: true },
        { id: "b", text: "Cookies", emoji: "🍪", correct: false },
      ],
    },
    {
      id: 5,
      ...
      choices: [
        { id: "a", text: "Balanced Meal", emoji: "🍽️", correct: true },
        { id: "b", text: "Ice Cream", emoji: "🍦", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Snack Story</span>
              <span className="xs:hidden">Snack</span>
            </span>
          </h1>
        </div>
        ...
        <div className="w-full max-w-3xl flex-1 flex flex-col justify-center min-h-0">
          {finalScore === 0 ? (
            !showResult ? (
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-green-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great choice! You picked the healthy option!"
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-green-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-600 mb-2 sm:mb-3">Healthy Choice Star!</h3>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — excellent choices!
                <br />
                You know how to pick healthy snacks! 🎯
              </p>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Choose healthy needs first!
              </p>
