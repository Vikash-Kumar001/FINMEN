...
const ToyStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Your friend lends you their favorite toy. What should you do with it?",
      choices: [
        { id: "a", text: "Keep it safe and use it gently", emoji: "🧸", correct: true },
        { id: "b", text: "Play roughly and break it", emoji: "💥", correct: false },
        { id: "c", text: "Throw it around", emoji: "🌀", correct: false },
      ],
    },
    {
      id: 2,
      text: "You borrowed a toy and playtime is over. What is the right action?",
      choices: [
        { id: "a", text: "Return the toy and say thank you", emoji: "🙏", correct: true },
        { id: "b", text: "Hide the toy in your bag", emoji: "🎒", correct: false },
        { id: "c", text: "Pretend you lost it", emoji: "🙈", correct: false },
      ],
    },
    {
      id: 3,
      text: "Your friend asks for their toy back. What should you do?",
      choices: [
        { id: "a", text: "Give it back politely", emoji: "🤝", correct: true },
        { id: "b", text: "Say “No, it’s mine now”", emoji: "😠", correct: false },
        { id: "c", text: "Ignore them and keep playing", emoji: "🙄", correct: false },
      ],
    },
    {
      id: 4,
      text: "You accidentally broke a borrowed toy. What is the honest choice?",
      choices: [
        { id: "a", text: "Tell your friend and try to fix/replace it", emoji: "🛠️", correct: true },
        { id: "b", text: "Hide the broken toy", emoji: "🧺", correct: false },
        { id: "c", text: "Blame someone else", emoji: "👀", correct: false },
      ],
    },
    {
      id: 5,
      text: "Why is it important to care for and return borrowed toys?",
      choices: [
        { id: "a", text: "It shows you are honest and respectful", emoji: "😊", correct: true },
        { id: "b", text: "So you can keep more toys", emoji: "📦", correct: false },
        { id: "c", text: "So others stop asking for their toys back", emoji: "🤷‍♂️", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Toy Story</span>
              <span className="xs:hidden">Toy Story</span>
            </span>
          </h1>
        </div>
          ...
          {finalScore === 0 ? (
            !showResult ? (
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center">
                ...
                <p className="text-lg sm:text-xl text-gray-700 mb-6 sm:mb-8">
                  {isCorrect
                    ? "Great choice! You’re caring for your friend’s toy!"
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-purple-300 shadow-xl text-center max-w-2xl w-full">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-600 mb-2 sm:mb-3">
                Responsible Toy Star!
              </h3>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — amazing toy-sharing
                manners!
                <br />
                You know how to care for borrowed toys and return them with respect. 🎯
              </p>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Borrowed toys are a trust — keep them safe, return them, and be
