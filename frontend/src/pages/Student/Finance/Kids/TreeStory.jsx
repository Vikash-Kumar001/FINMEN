  ...
  const questions = [
    {
      id: 1,
      icon: "🌱",
      text: "You plant a small tree. What is the money lesson?",
      choices: [
        { id: "a", text: "Save a little money regularly so it can grow", correct: true },
        { id: "b", text: "Spend all your money quickly", correct: false },
        { id: "c", text: "Hide money and never use it", correct: false },
      ],
    },
    {
      id: 2,
      icon: "💧",
      text: "You water the tree every day. What is this like with money?",
      choices: [
        { id: "a", text: "Adding small savings again and again", correct: true },
        { id: "b", text: "Only saving once and forgetting", correct: false },
        { id: "c", text: "Spending more than you have", correct: false },
      ],
    },
    {
      id: 3,
      icon: "🌳",
      text: "The tree grows bigger. What happens if you keep saving and investing?",
      choices: [
        { id: "a", text: "Your money can grow like a big tree", correct: true },
        { id: "b", text: "Your money disappears", correct: false },
        { id: "c", text: "You can never touch your money", correct: false },
      ],
    },
    {
      id: 4,
      icon: "🍎",
      text: "The tree gives fruits. What are the fruits like in money life?",
      choices: [
        { id: "a", text: "Rewards like interest and profit", correct: true },
        { id: "b", text: "Random gifts from strangers", correct: false },
        { id: "c", text: "Free money with no effort", correct: false },
      ],
    },
    {
      id: 5,
      icon: "🪴",
      text: "You take care of the tree for many years. What is the best money habit here?",
      choices: [
        { id: "a", text: "Be patient and keep saving for long-term goals", correct: true },
        { id: "b", text: "Stop saving as soon as you get bored", correct: false },
        { id: "c", text: "Spend everything when you feel like it", correct: false },
      ],
    },
  ];
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold px-2 flex items-center justify-center gap-1 sm:gap-2 truncate">
            ...
            <span className="bg-gradient-to-r from-emerald-600 via-green-600 to-lime-600 bg-clip-text text-transparent truncate">
              <span className="hidden xs:inline">Tree Story: Money Tree</span>
              <span className="xs:hidden">Tree Story</span>
            </span>
          </h1>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center px-2 sm:px-4 md:px-6 z-10 py-2 sm:py-4 overflow-y-auto min-h-0">
        {!showResult && finalScore === 0 && (
          <div className="mb-1 sm:mb-2 md:mb-3 relative z-20 flex-shrink-0">
            <p className="text-emerald-800 text-xs sm:text-sm mt-0.5 sm:mt-1 font-medium">
          ...
          {finalScore === 0 ? (
            !showResult ? (
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-emerald-200 shadow-xl">
                  <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <span className="text-xs sm:text-sm md:text-base font-semibold text-emerald-700">
                      Money Tree Question {currentQuestion + 1}
                    </span>
                  </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-emerald-200 shadow-xl text-center">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-emerald-800 mb-2 sm:mb-4">
                  {isCorrect ? "Great Growing Choice!" : "Try Another Seed"}
                </h3>
                <p className="text-lg sm:text-xl text-emerald-800 mb-6 sm:mb-8 leading-relaxed px-1">
                  {isCorrect
                    ? "Nice! That’s how money grows strong, just like a healthy tree."
                    : "The best money-growing choice is: " +
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border-2 border-emerald-200 shadow-xl text-center max-w-2xl w-full">
              ...
              <p className="text-emerald-900 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed px-1">
                You scored {finalScore} out of {questions.length} — your savings habits
                are growing strong!
                <br />
                Just like a tree, your money needs time, care, and patience to grow big. 🌳
              </p>
              ...
              <p className="text-emerald-800 text-xs sm:text-sm mb-3 sm:mb-4 px-1">
                Lesson: Save regularly, be patient, and let your money grow like a tree over
                time.
              </p>
