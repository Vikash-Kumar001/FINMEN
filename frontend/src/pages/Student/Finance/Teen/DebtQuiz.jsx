...
const DebtQuiz = () => {
  ...
  const gameId = "finance-teens-112";
  ...
  const questions = [
    {
      id: 1,
      text: "Borrow ₹100, repay ₹120. What is the extra ₹20 called?",
      options: [
        { id: "interest", text: "Interest", emoji: "💰", description: "Cost of borrowing", isCorrect: true },
        { id: "principal", text: "Principal", emoji: "📜", description: "Original amount", isCorrect: false }
      ],
      reward: 3
    },
    {
      id: 2,
      text: "What’s the original amount borrowed called?",
      options: [
        { id: "principal", text: "Principal", emoji: "💸", description: "Base loan amount", isCorrect: true },
        { id: "fee", text: "Fee", emoji: "⚖️", description: "Extra charge", isCorrect: false }
      ],
      reward: 3
    },
    {
      id: 3,
      text: "What happens if you don’t repay a loan?",
      options: [
        { id: "debt", text: "Debt accumulates", emoji: "📉", description: "Owed amount grows", isCorrect: true },
    ...
    {
      id: 4,
      text: "What’s a safe borrowing practice?",
      options: [
        { id: "plan", text: "Plan repayment", emoji: "📅", description: "Ensures timely payment", isCorrect: true },
        { id: "borrowmore", text: "Borrow more", emoji: "📈", description: "Risks debt", isCorrect: false }
      ],
      reward: 4
    },
    {
      id: 5,
      text: "What’s a loan agreement?",
      options: [
        { id: "contract", text: "A contract", emoji: "🤝", description: "Binds borrower and lender", isCorrect: true },
        { id: "note", text: "A note", emoji: "📝", description: "Not binding", isCorrect: false }
      ],
      reward: 5
    }
  ];
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            {finalScore >= 3 ? (
              <>
                ...
                <h3 className="text-3xl font-bold mb-4">Debt Quiz Star!</h3>
                <p className="text-white/90 text-lg mb-6">You got {finalScore} out of 5 correct!</p>
                <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2">
                  +{coins} Coins
                </div>
                <p className="text-white/80 mt-4">Lesson: Understand debt terms!</p>
              </>
            ) : (
              <>
