...
const JournalOfDigitalUse = () => {
  ...
  const stages = [
    { id: 1, prompt: "One safe way I used online money was ___." },
    { id: 2, prompt: "One digital payment app I trust is ___." },
    { id: 3, prompt: "One way to stay safe online is ___." },
    { id: 4, prompt: "One time I avoided a scam was ___." },
    { id: 5, prompt: "One benefit of digital payments is ___." }
  ];
      ...
      <div className="text-white space-y-8">
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            ...
            <h3 className="text-3xl font-bold mb-4">Digital Use Journal Star!</h3>
            <p className="text-white/90 text-lg mb-6">You completed {score} out of 5 stages!</p>
            <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2">
              +{score} Coins
            </div>
            <p className="text-white/80 mt-4">Lesson: Reflect on safe digital practices!</p>
          </div>
        )}
      </div>
    </GameShell>
