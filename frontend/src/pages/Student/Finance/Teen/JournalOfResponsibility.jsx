...
const JournalOfResponsibility = () => {
  ...
  const gameId = "finance-teens-197";
  ...
  const stages = [
    { id: 1, prompt: "One way I will use money responsibly is ___." },
    { id: 2, prompt: "One way to avoid financial mistakes is ___." },
    { id: 3, prompt: "One ethical financial choice I can make is ___." },
    { id: 4, prompt: "One way to help others with money is ___." },
    { id: 5, prompt: "One reason to stay honest with money is ___." }
  ];
      ...
      <div className="text-white space-y-8">
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            ...
            <h3 className="text-3xl font-bold mb-4">Responsible Finance Star!</h3>
            <p className="text-white/90 text-lg mb-6">You completed {score} out of 5 stages!</p>
            <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2">
              +{score} Coins
            </div>
            <p className="text-white/80 mt-4">Lesson: Use money responsibly!</p>
          </div>
        )}
      </div>
    </GameShell>
