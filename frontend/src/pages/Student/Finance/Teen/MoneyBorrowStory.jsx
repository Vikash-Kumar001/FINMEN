...
const MoneyBorrowStory = () => {
  ...
  const gameId = "finance-teens-111";
  ...
  const stages = [
    {
      id: 1,
      text: "You borrow ₹100 from a friend. Forget to repay?",
      options: [
        { id: "repay", text: "Repay", emoji: "✅", description: "Maintain trust", isCorrect: true },
        { id: "forget", text: "Forget", emoji: "❌", description: "Harms friendship", isCorrect: false }
      ],
      reward: 5
    },
    {
      id: 2,
      text: "You borrow ₹200 for a gift. Repay on time?",
      options: [
        { id: "repay", text: "Repay on time", emoji: "💸", description: "Builds trust", isCorrect: true },
        { id: "delay", text: "Delay repayment", emoji: "⏰", description: "Risks trust", isCorrect: false }
      ],
      reward: 5
    },
    {
      id: 3,
      text: "You borrow ₹150 for snacks. Set a repayment plan?",
      options: [
        { id: "plan", text: "Set a plan", emoji: "📅", description: "Organized repayment", isCorrect: true },
        { id: "noplan", text: "No plan", emoji: "🚫", description: "Risks forgetting", isCorrect: false }
      ],
      reward: 6
    },
    {
      id: 4,
      text: "You borrow ₹300 for clothes. Discuss terms with lender?",
      options: [
        { id: "discuss", text: "Discuss terms", emoji: "🤝", description: "Clear agreement", isCorrect: true },
        { id: "nodiscuss", text: "Don’t discuss", emoji: "🙈", description: "Risks confusion", isCorrect: false }
      ],
      reward: 6
    },
    {
      id: 5,
      text: "You borrow ₹500 for a game. Repay with interest?",
      options: [
        { id: "interest", text: "Repay with interest", emoji: "💰", description: "Fair to lender", isCorrect: true },
        { id: "nointerest", text: "No interest", emoji: "😕", description: "May upset lender", isCorrect: false }
      ],
      reward: 7
    }
  ];
