...
const PuzzleOfDigitalTools = () => {
  ...
  const correctMatches = [
    { leftId: 1, rightId: 1 }, // UPI → PhonePe (position 1)
    { leftId: 2, rightId: 2 }, // Debit Card → ATM (position 2)
    { leftId: 3, rightId: 3 }, // OTP → Security (position 3)
    { leftId: 4, rightId: 4 }, // QR Code → GPay (position 4)
    { leftId: 5, rightId: 5 }  // CVV → Card Safety (position 5)
  ];
