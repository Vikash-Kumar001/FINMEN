...
const PuzzleOfDigitalTools = () => {
  ...
  const puzzles = [
    {
      id: 1,
      text: "Match: UPI → PhonePe, Debit Card → ATM, OTP → Security",
      options: [
        { id: "correct", text: "Match correctly", emoji: "✅", description: "Correct tools", isCorrect: true },
    ...
    {
      id: 2,
      text: "Match: Net Banking → Online, Credit Card → POS, PIN → Safety",
      options: [
        { id: "correct", text: "Match correctly", emoji: "✅", description: "Right tools", isCorrect: true },
    ...
    {
      id: 3,
      text: "Match: QR Code → UPI, CVV → Card Security, HTTPS → Safe Site",
      options: [
        { id: "correct", text: "Match correctly", emoji: "✅", description: "Secure matches", isCorrect: true },
    ...
    {
      id: 4,
      text: "Match: Wallet → Paytm, OTP → Verification, Card → Swipe",
      options: [
        { id: "correct", text: "Match correctly", emoji: "✅", description: "Correct tools", isCorrect: true },
        { id: "wrong", text: "Match wrong", emoji: "❌", description: "Wrong match", isCorrect: false }
      ],
      reward: 6
    },
    {
      id: 5,
      text: "Match: UPI → GPay, PIN → Protection, ATM → Cash Withdrawal",
      options: [
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            {finalScore >= 3 ? (
              <>
                ...
                <h3 className="text-3xl font-bold mb-4">Digital Tools Puzzle Star!</h3>
                <p className="text-white/90 text-lg mb-6">You got {finalScore} out of 5 correct!</p>
                <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2">
                  +{coins} Coins
                </div>
                <p className="text-white/80 mt-4">Lesson: Know your digital tools!</p>
              </>
            ) : (
              <>
