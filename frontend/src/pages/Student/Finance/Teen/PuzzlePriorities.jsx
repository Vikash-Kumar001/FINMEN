...
const PuzzlePriorities = () => {
  ...
  const puzzles = [
    {
      id: 1,
      text: "Match: School Fees → Must, Concert Ticket → Want",
      options: [
        { id: "correct", text: "Match correctly", emoji: "✅", description: "Smart prioritization", isCorrect: true },
        { id: "wrong", text: "Match wrong", emoji: "❌", description: "Incorrect choice", isCorrect: false }
      ],
      reward: 5
    },
    {
      id: 2,
      text: "Match: Rent → Must, New Phone → Want",
      options: [
        { id: "correct", text: "Match correctly", emoji: "✅", description: "Good decision", isCorrect: true },
        { id: "wrong", text: "Match wrong", emoji: "❌", description: "Bad choice", isCorrect: false }
      ],
      reward: 5
    },
    {
      id: 3,
      text: "Match: Groceries → Must, Video Game → Want",
      options: [
        { id: "correct", text: "Match correctly", emoji: "✅", description: "Wise choice", isCorrect: true },
    ...
    {
      id: 4,
      text: "Match: Internet Bill → Must, Movie Night → Want",
      options: [
        { id: "correct", text: "Match correctly", emoji: "✅", description: "Smart move", isCorrect: true },
        { id: "wrong", text: "Match wrong", emoji: "❌", description: "Wrong choice", isCorrect: false }
      ],
      reward: 6
    },
    {
      id: 5,
      text: "Match: Textbooks → Must, Headphones → Want",
      options: [
        { id: "correct", text: "Match correctly", emoji: "✅", description: "Great prioritization", isCorrect: true },
        { id: "wrong", text: "Match wrong", emoji: "❌", description: "Incorrect", isCorrect: false }
      ],
      reward: 7
    }
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            {finalScore >= 3 ? (
              <>
                ...
                <h3 className="text-3xl font-bold mb-4">Priority Puzzle Star!</h3>
                <p className="text-white/90 text-lg mb-6">You got {finalScore} out of 5 correct!</p>
                <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2">
                  +{coins} Coins
                </div>
                <p className="text-white/80 mt-4">Lesson: Prioritize must-haves over wants!</p>
              </>
            ) : (
              <>
