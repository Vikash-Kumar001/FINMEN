...
const PuzzleRealPriorities = () => {
  ...
  const puzzles = [
    {
      id: 1,
      text: "Match: Shelter → Need, Gaming Console → Want",
      options: [
    ...
    {
      id: 2,
      text: "Match: Food → Need, Designer Clothes → Want",
      options: [
    ...
    {
      id: 3,
      text: "Match: School Fees → Need, Concert Ticket → Want",
      options: [
    ...
    {
      id: 4,
      text: "Match: Medicine → Need, New Phone → Want",
      options: [
    ...
    {
      id: 5,
      text: "Match: Transport → Need, Headphones → Want",
      options: [
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            {finalScore >= 3 ? (
              <>
                ...
                <p className="text-white/80 mt-4">Lesson: Needs come before wants!</p>
              </>
            ) : (
              <>
