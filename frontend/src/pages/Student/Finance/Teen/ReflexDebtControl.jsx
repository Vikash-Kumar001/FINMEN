...
const ReflexDebtControl = () => {
  ...
  const gameId = "finance-teens-119";
  ...
  const stages = [
    {
      id: 1,
      action: "Borrow Wisely",
      wrong: "Overspend + Debt",
      prompt: "Tap to borrow wisely!"
    },
    {
      id: 2,
      action: "Plan Repayment",
      wrong: "Ignore Debt",
      prompt: "Tap to plan repayment!"
    },
    {
      id: 3,
      action: "Check Terms",
      wrong: "Borrow Blindly",
      prompt: "Tap to check terms!"
    },
    {
      id: 4,
      action: "Save First",
    ...
    },
    {
      id: 5,
      action: "Limit Loans",
      wrong: "Multiple Debts",
      prompt: "Tap to limit loans!"
    }
  ];
      ...
      <div className="text-center text-white space-y-8">
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
            ...
            <h3 className="text-3xl font-bold mb-4">Debt Control Star!</h3>
            <p className="text-white/90 text-lg mb-6">You scored {finalScore} out of 5!</p>
            <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2">
              +{coins} Coins
            </div>
            <p className="text-white/80 mt-4">Lesson: Control debt with wise choices!</p>
            {finalScore < 3 && (
              <button
