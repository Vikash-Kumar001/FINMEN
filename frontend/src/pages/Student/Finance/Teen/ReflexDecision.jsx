  ...
  const stages = [
    {
      id: 1,
      action: "Pay Fees",
      wrong: "Skip for Gadgets",
      prompt: "Tap to pay fees!"
    },
    {
      id: 2,
      action: "Save Money",
    ...
    },
    {
      ...
      action: "Track Budget",
      wrong: "Ignore Budget",
      prompt: "Tap to track budget!"
    },
    {
      id: 4,
      action: "Pay Rent",
      wrong: "Spend on Party",
      prompt: "Tap to pay rent!"
    },
    {
      id: 5,
      action: "Save for Books",
      wrong: "Buy Snacks",
      prompt: "Tap to save for books!"
    }
  ];
      ...
      <div className="text-center text-white space-y-8">
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
            ...
            <h3 className="text-3xl font-bold mb-4">Reflex Decision Star!</h3>
            <p className="text-white/90 text-lg mb-6">You scored {finalScore} out of 5!</p>
            <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2">
              +{coins} Coins
            </div>
            <p className="text-white/80 mt-4">Lesson: Quick decisions prioritize needs!</p>
            {finalScore < 3 && (
              <button
