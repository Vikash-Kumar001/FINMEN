...
const ReflexEthicalChoice = () => {
  ...
  const gameId = "finance-teens-193";
  ...
  const stages = [
    {
      ...
      action: "Fair Pay",
      wrong: "Cheat Pay",
      prompt: "Tap for Fair Pay!"
    },
    {
      id: 2,
      action: "Honest Deal",
      wrong: "Trick Deal",
      prompt: "Tap for Honest Deal!"
    },
    {
      id: 3,
      action: "Ethical Choice",
      wrong: "Unfair Choice",
      prompt: "Tap for Ethical Choice!"
    },
    {
      id: 4,
      action: "Be Truthful",
      wrong: "Lie for Gain",
      prompt: "Tap for Be Truthful!"
    },
    {
      id: 5,
      action: "Fair Trade",
      wrong: "Cheat Trade",
      prompt: "Tap for Fair Trade!"
    }
  ];
  ...
  return (
    <GameShell
      ...
      score={coins}
      subtitle={stages[currentStage]?.prompt || "Test your ethical reflexes!"}
      coins={coins}
      ...
      <div className="text-center text-white space-y-8">
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
            ...
            <h3 className="text-3xl font-bold mb-4">Ethical Choice Star!</h3>
            <p className="text-white/90 text-lg mb-6">You scored {finalScore} out of 5!</p>
            <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2">
              +{coins} Coins
            </div>
            <p className="text-white/80 mt-4">Lesson: Choose fairness in financial decisions!</p>
            {finalScore < 3 && (
              <button
