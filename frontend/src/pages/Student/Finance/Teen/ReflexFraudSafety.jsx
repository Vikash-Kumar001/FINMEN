...
const ReflexFraudSafety = () => {
  ...
  const gameId = "finance-teens-173";
  ...
  const stages = [
    {
      id: 1,
      action: "Don’t Share OTP",
      wrong: "Share OTP",
      prompt: "Tap for don’t share OTP!"
    },
    {
      id: 2,
      action: "Verify Caller",
      wrong: "Trust Caller",
      prompt: "Tap to verify caller!"
    },
    {
      id: 3,
      action: "Check Website",
      wrong: "Click Link",
      prompt: "Tap to check website!"
    },
    {
      id: 4,
      action: "Report Fraud",
      wrong: "Ignore Fraud",
      prompt: "Tap to report fraud!"
    },
    {
      id: 5,
      action: "Secure Password",
      wrong: "Weak Password",
      prompt: "Tap for secure password!"
    }
  ];
  ...
  return (
    <GameShell
      ...
      score={coins}
      subtitle={stages[currentStage]?.prompt || "Test your fraud safety reflexes!"}
      coins={coins}
      ...
      <div className="text-center text-white space-y-8">
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
            ...
            <h3 className="text-3xl font-bold mb-4">Fraud Safety Star!</h3>
