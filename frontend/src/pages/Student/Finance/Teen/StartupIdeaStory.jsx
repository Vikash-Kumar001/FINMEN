...
const StartupIdeaStory = () => {
  ...
  const gameId = "finance-teens-151";
  ...
  const stages = [
    {
      ...
      options: [
        { id: "yes", text: "Yes", emoji: "💡", description: "Creating a business", isCorrect: true },
        { id: "no", text: "No", emoji: "❌", description: "Just a hobby", isCorrect: false }
      ],
      reward: 5
    },
    {
      id: 2,
      text: "Teen starts a tutoring service. Is this entrepreneurship?",
      options: [
        { id: "yes", text: "Yes", emoji: "📚", description: "Building a service", isCorrect: true },
        { id: "no", text: "No", emoji: "🙅", description: "Just helping friends", isCorrect: false }
      ],
      reward: 5
    },
    {
      id: 3,
      text: "Teen sells custom T-shirts online. Is this entrepreneurship?",
      options: [
        { id: "yes", text: "Yes", emoji: "👕", description: "Running a business", isCorrect: true },
        { id: "no", text: "No", emoji: "🚫", description: "Not serious", isCorrect: false }
      ],
      reward: 6
    },
    {
      id: 4,
      text: "Teen creates an app for local events. Is this entrepreneurship?",
      options: [
        { id: "yes", text: "Yes", emoji: "📱", description: "Innovative venture", isCorrect: true },
        { id: "no", text: "No", emoji: "❌", description: "Just coding", isCorrect: false }
      ],
      reward: 6
    },
    {
      id: 5,
      text: "Teen sells baked goods at school. Is this entrepreneurship?",
      options: [
        { id: "yes", text: "Yes", emoji: "🍰", description: "Starting a small business", isCorrect: true },
        { id: "no", text: "No", emoji: "🙈", description: "Not a business", isCorrect: false }
      ],
      reward: 7
    }
  ];
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            {finalScore >= 3 ? (
              <>
                ...
                <h3 className="text-3xl font-bold mb-4">Startup Story Star!</h3>
                <p className="text-white/90 text-lg mb-6">You got {finalScore} out of 5 correct!</p>
                <div className="bg-green-500 py-3 px-6 rounded-full inline-flex items-center gap-2">
                  +{coins} Coins
                </div>
                <p className="text-white/80 mt-4">Lesson: Entrepreneurship starts with ideas!</p>
              </>
            ) : (
              <>
