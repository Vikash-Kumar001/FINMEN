...
const StartupStory = () => {
  ...
  const gameId = "finance-teens-135";
  ...
  const stages = [
    {
      id: 1,
      text: "Friend invests ₹100 in lemonade stand. Earns ₹150. Smart?",
      options: [
        { id: "yes", text: "Yes", emoji: "✅", description: "Good return", isCorrect: true },
        { id: "no", text: "No", emoji: "❌", description: "Risky, no gain", isCorrect: false }
      ],
      reward: 5
    },
    {
      id: 2,
      text: "You invest ₹200 in a bake sale. Earn ₹300. Smart move?",
      options: [
        { id: "yes", text: "Yes", emoji: "💸", description: "Profitable", isCorrect: true },
    ...
    {
      id: 3,
      text: "Friend invests ₹150 in a craft stall. Earns ₹225. Wise?",
      options: [
    ...
    {
      id: 4,
      text: "You invest ₹300 in a car wash. Earn ₹450. Good choice?",
      options: [
    ...
    {
      id: 5,
      text: "Friend invests ₹500 in a small shop. Earns ₹800. Smart?",
      options: [
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            {finalScore >= 3 ? (
              <>
                ...
                <p className="text-white/80 mt-4">Lesson: Smart investments can yield profits!</p>
              </>
            ) : (
              <>
