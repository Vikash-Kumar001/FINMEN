    ...
    const gamePillars = [
        {
            ...
            filters: [
                { 
                    ...
                    games: [
                        { title: 'Spot the Pattern', key: 'spot-the-pattern', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/spot-the-pattern' },
                        { title: 'Cat or Dog', key: 'cat-or-dog', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/cat-or-dog' },
                        { title: 'Sorting Colors', key: 'sorting-colors', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/sorting-colors' },
                        { title: 'True or False AI Quiz', key: 'true-or-false-ai-quiz', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/true-or-false-ai-quiz' },
                        { title: 'Emoji Classifier', key: 'emoji-classifier', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/emoji-classifier' },
                        { title: 'Self-Driving Car Game', key: 'self-driving-car-game', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/self-driving-car-game' },
                        { title: 'Pattern Finding Puzzle', key: 'pattern-finding-puzzle', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/pattern-finding-puzzle' },
                        { title: 'Robot Helper Story', key: 'robot-helper-story', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/robot-helper-story' },
                        { title: 'Spam vs Not Spam', key: 'spam-vs-not-spam', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/spam-vs-not-spam' },
                        { title: 'Siri/Alexa Quiz', key: 'siri-alexa-quiz', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/siri-alexa-quiz' },
                        { title: 'AI in Games', key: 'ai-in-games', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/ai-in-games' },
                        { title: 'Match AI Tools', key: 'match-ai-tools', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/match-ai-tools' },
                        { title: 'Pattern Music Game', key: 'pattern-music-game', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/pattern-music-game' },
                        { title: 'Robot Vision Game', key: 'robot-vision-game', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/robot-vision-game' },
                        { title: 'Smart Home Story', key: 'smart-home-story', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/smart-home-story' },
                        { title: 'Train the Robot', key: 'train-the-robot', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/train-the-robot' },
                        { title: 'Prediction Puzzle', key: 'prediction-puzzle', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/prediction-puzzle' },
                        { title: 'Friendly AI Quiz', key: 'friendly-ai-quiz', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/friendly-ai-quiz' },
                        { title: 'Robot Emotion Story', key: 'robot-emotion-story', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/robot-emotion-story' },
                        { title: 'Recommendation Game', key: 'recommendation-game', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/recommendation-game' },
                        { title: 'AI or Not Quiz', key: 'ai-or-not-quiz', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/ai-or-not-quiz' },
                        { title: 'Robot Helper Reflex', key: 'robot-helper-reflex', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/robot-helper-reflex' },
                        { title: 'Match AI Uses', key: 'match-ai-uses', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/match-ai-uses' },
                        { title: 'Sorting Animals', key: 'sorting-animals', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/sorting-animals' },
                        { title: 'AI Basics Badge', key: 'ai-basics-badge', icon: <Target className="w-6 h-6" />, difficulty: 'Easy', duration: '10-20 min', coins: 30, route: '/student/games/ai/ai-basics-badge' }
                    ]
                },
                { name: 'AI in daily life & applications', game: { title: 'Daily AI Detective', description: 'Find AI around you every day.', icon: <Lightbulb className="w-6 h-6" />, difficulty: 'Easy', duration: '12 min', coins: 35, route: '/student/games/ai/daily-ai-detective' } },
