  ...
  const challenges = [
    {
      id: 1,
      type: "multipleChoice",
      question: "Which emotion might you feel when you get a surprise gift?",
      options: [
        "Sadness",
        "Joy",
        "Anger"
      ...
      correctAnswer: "Joy",
      explanation: "Joy is the emotion we typically feel when receiving unexpected gifts!"
    },
    {
      id: 2,
      type: "trueFalse",
      question: "It's normal to feel different emotions throughout the day.",
      correctAnswer: "true",
      explanation: "Yes! Our emotions naturally change as we experience different situations."
    },
    {
      id: 3,
      type: "fillBlank",
      question: "When feeling angry, it's helpful to take ___ breaths.",
      correctAnswer: "deep",
      explanation: "Deep breathing activates our body's relaxation response and helps calm anger."
    },
    {
      id: 4,
      type: "scenario",
      question: "You feel nervous before a test. What's the best approach?",
      options: [
        "Pretend you're not nervous",
        "Acknowledge the feeling and prepare well",
        "Skip the test to avoid nervousness"
      ],
      correctAnswer: "Acknowledge the feeling and prepare well",
      explanation: "Recognizing nervousness and taking positive action is the healthiest approach."
    },
    {
      id: 5,
      type: "dragAndDrop",
      items: [
        { id: "happy", name: "😊 Happy", correctZone: "positive" },
        { id: "sad", name: "😢 Sad", correctZone: "negative" },
        { id: "angry", name: "😠 Angry", correctZone: "negative" }
      ],
      zones: [
        { id: "positive", name: "Positive Emotions" },
        { id: "negative", name: "Negative Emotions" }
      ],
      correctAnswer: 3, // Number of correct matches needed
      explanation: "Understanding which emotions are positive and negative helps us categorize our feelings."
    }
  ];
      ...
      case "dragAndDrop":
        return (
          <div className="space-y-6">
            <h3 className="text-xl font-semibold text-white text-center">Sort these emotions into the correct categories:</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white/10 rounded-xl p-4">
                <h4 className="text-white font-semibold mb-3 text-center">Emotions</h4>
    ...
    return (
      ...
      totalXp={totalXp}>
        <div className="text-center p-8">
          ...
          <h2 className="text-2xl font-bold mb-4">Emotion Explorer</h2>
          <p className="text-white/80 mb-6">
            You've completed all emotion challenges!
          </p>
          <div className="text-yellow-400 font-bold text-lg mb-8">
            You've earned your Emotion Explorer Badge!
          </div>
          <button
            onClick={handleNext}
