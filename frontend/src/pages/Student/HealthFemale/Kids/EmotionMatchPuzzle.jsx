...
const EmotionMatchPuzzle = () => {
  ...
  const items = [
    { id: 'happy', emoji: '😊', match: 'smile', description: 'Happy feelings show on your face as a smile' },
    { id: 'smile', emoji: '😄', match: 'happy', description: 'A smile shows that you are happy' },
    { id: 'sad', emoji: '😢', match: 'tears', description: 'Sad feelings show on your face with tears' },
    { id: 'tears', emoji: '💧', match: 'sad', description: 'Tears show that you are sad' },
    { id: 'angry', emoji: '😠', match: 'redface', description: 'Angry feelings show on your face as redness' },
    { id: 'redface', emoji: '😡', match: 'angry', description: 'A red face shows that you are angry' },
    { id: 'scared', emoji: '😨', match: 'wideeyes', description: 'Scared feelings show with wide eyes' },
    { id: 'wideeyes', emoji: '😱', match: 'scared', description: 'Wide eyes show that you are scared' },
    { id: 'surprised', emoji: '😲', match: 'openmouth', description: 'Surprised feelings show with an open mouth' },
    { id: 'openmouth', emoji: '😮', match: 'surprised', description: 'An open mouth shows that you are surprised' }
  ];
                  ...
                  <div className="text-center p-2 text-white">
                    ...
                    <div className="text-xs font-medium bg-white/20 px-2 py-1 rounded-full">
                      {item.id === 'happy' ? 'Happy' : 
                       ...
                       item.id === 'tears' ? 'Tears' :
                       item.id === 'angry' ? 'Angry' :
                       item.id === 'redface' ? 'Red Face' :
                       item.id === 'scared' ? 'Scared' :
                       item.id === 'wideeyes' ? 'Wide Eyes' :
                       item.id === 'surprised' ? 'Surprised' : 'Open Mouth'}
                    </div>
                  </div>
                ) : (
