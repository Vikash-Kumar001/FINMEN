...
const FeelingsJournal = () => {
  ...
  const feelingPrompts = [
    ...
    "When I feel happy, I like to ___.",
    "When I feel sad, it helps me to ___.",
    "I feel proud when ___.",
    "A time I felt scared was when ___."
  ];

  const feelingExamples = [
    "happy", "sad", "excited", "nervous", "angry", 
    "calm", "confused", "grateful", "lonely", "joyful"
  ];
  ...
  const getRandomPrompts = () => {
    const shuffled = [...feelingPrompts].sort(() => 0.5 - Math.random());
    return shuffled.slice(0, 2);
  };

  const getRandomFeelings = () => {
    const shuffled = [...feelingExamples].sort(() => 0.5 - Math.random());
    return shuffled.slice(0, 4);
  };

  const suggestedPrompts = getRandomPrompts();
  const suggestedFeelings = getRandomFeelings();

  return (
    <GameShell
      title="Journal of Feelings"
      subtitle="Write about your emotions"
      onNext={handleNext}
      nextEnabled={gameFinished}
      showGameOver={gameFinished}
      score={coins}
      gameId="health-female-kids-57"
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Today I felt... because... It made me want to... When I feel this way, I can..."
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="text-white font-semibold mr-2">Feelings to explore:</span>
              {suggestedFeelings.map((feeling, index) => (
                <span 
                  key={index}
          ...
          {gameFinished && (
            <div className="mt-6 p-4 bg-green-500/20 rounded-xl border border-green-400 text-center">
              <p className="text-green-200">
                Great job! Writing about your feelings helps you understand and manage them better.
              </p>
            </div>
          )}
        </div>
