  ...
  const challenges = [
    {
      id: 1,
      type: "multipleChoice",
      question: "Which is the best practice for daily hygiene?",
      options: [
        "Bathe daily with soap",
        "Bathe once a week",
        "Only wash hands"
      ],
      correctAnswer: "Bathe daily with soap",
      explanation: "Daily bathing with soap removes bacteria and keeps you fresh and clean."
    },
    {
      id: 2,
      type: "trueFalse",
      question: "You should wash your face gently twice a day.",
      correctAnswer: "true",
      explanation: "Gentle face washing twice daily removes dirt and oil without irritating the skin."
    },
    {
      id: 3,
      type: "fillBlank",
      question: "Pads should be changed every ___ hours during periods.",
      correctAnswer: "4-8",
      explanation: "Changing pads every 4-8 hours prevents odor, leaks, and infection risk."
    },
    {
      id: 4,
      type: "scenario",
      question: "You're going to gym class. What's the best preparation?",
      options: [
        "Wear the same clothes from yesterday",
        "Wear fresh clothes and bring a water bottle",
        "Skip showering because you'll sweat anyway"
      ],
      correctAnswer: "Wear fresh clothes and bring a water bottle",
      explanation: "Fresh clothes and hydration help you stay comfortable and confident during physical activity."
    },
    {
      id: 5,
      type: "dragAndDrop",
      items: [
        { id: "soap", name: "Soap", correctZone: "body" },
        { id: "shampoo", name: "Shampoo", correctZone: "hair" },
        { id: "toothbrush", name: "Toothbrush", correctZone: "teeth" }
      ],
      zones: [
        { id: "body", name: "Body Care" },
        { id: "hair", name: "Hair Care" },
        { id: "teeth", name: "Oral Care" }
      ],
      correctAnswer: 3, // Number of correct matches needed
      explanation: "Using the right products for each body part ensures effective and appropriate care."
    }
  ];
      ...
      case "dragAndDrop":
        return (
          <div className="space-y-6">
            <h3 className="text-xl font-semibold text-white text-center">Sort these hygiene items into the correct categories:</h3>
    ...
    return (
      ...
      >
        <div className="text-center p-8">
          ...
          <h2 className="text-2xl font-bold mb-4">Fresh Girl</h2>
          <p className="text-white/80 mb-6">
            You've completed all hygiene challenges!
          </p>
          <div className="text-yellow-400 font-bold text-lg mb-8">
            You've earned your Fresh Girl Badge!
          </div>
          <button
            onClick={handleNext}
