  ...
  const challenges = [
    {
      id: 1,
      type: "multipleChoice",
      question: "What is the benefit of a consistent sleep schedule?",
      options: [
        "It makes you feel tired all day",
        "It improves mood, focus, and overall health",
        "It's not important for kids"
      ],
      correctAnswer: "It improves mood, focus, and overall health",
      explanation: "A consistent sleep schedule helps regulate your body's internal clock, leading to better sleep quality and improved daily functioning."
    },
    {
      id: 2,
      type: "trueFalse",
      question: "Drinking water only when you feel thirsty is enough for good hydration.",
      correctAnswer: "false",
      explanation: "False! By the time you feel thirsty, your body is already slightly dehydrated. It's better to drink water regularly throughout the day."
    },
    {
      id: 3,
      type: "fillBlank",
      question: "A healthy morning routine includes brushing teeth, washing face, and eating a ___ breakfast.",
      correctAnswer: "nutritious",
      explanation: "A nutritious breakfast provides essential nutrients and energy to start your day right and helps with concentration at school."
    },
    {
      id: 4,
      type: "scenario",
      question: "You're feeling stressed about school. What's a healthy way to cope?",
      options: [
        "Stay up late playing video games",
        "Talk to a trusted adult and practice deep breathing",
        "Skip meals to save time"
      ],
      correctAnswer: "Talk to a trusted adult and practice deep breathing",
      explanation: "Talking to someone you trust and practicing relaxation techniques are healthy ways to manage stress and maintain emotional wellbeing."
    },
    {
      id: 5,
      type: "dragAndDrop",
      items: [
        { id: "sleep", name: "Sleep", correctZone: "beneficial" },
        { id: "exercise", name: "Exercise", correctZone: "beneficial" },
        { id: "junkfood", name: "Junk Food", correctZone: "harmful" }
      ],
      zones: [
        { id: "beneficial", name: "Beneficial Habits" },
        { id: "harmful", name: "Harmful Habits" }
      ],
      correctAnswer: 3, // Number of correct matches needed
      explanation: "Understanding which habits are beneficial and which are harmful helps you make better choices for your health and wellbeing."
    }
  ];
      ...
      case "dragAndDrop":
        return (
          <div className="space-y-6">
            <h3 className="text-xl font-semibold text-white text-center">Sort these habits into the correct categories:</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white/10 rounded-xl p-4">
                <h4 className="text-white font-semibold mb-3 text-center">Habits</h4>
    ...
    return (
      ...
      totalXp={totalXp}>
        <div className="text-center p-8">
          ...
          <h2 className="text-2xl font-bold mb-4">Healthy Routine Kid</h2>
          <p className="text-white/80 mb-6">
            You've completed all daily habit challenges!
          </p>
          <div className="text-yellow-400 font-bold text-lg mb-8">
            You've earned your Healthy Routine Kid Badge!
          </div>
          <button
            onClick={handleNext}
