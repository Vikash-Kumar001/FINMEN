...
const ReflexDangerAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🏃‍♀️ for 'Exercise' or ❌ for 'Drugs'",
      correctAnswer: '🏃‍♀️',
      feedback: {
        correct: "Great job! Exercise keeps your body and mind healthy!",
        incorrect: "Remember, drugs are harmful and can cause serious health problems!"
      }
    },
    {
      id: 2,
      text: "Tap 🥗 for 'Healthy Food' or ❌ for 'Junk Food'",
      correctAnswer: '🥗',
      feedback: {
        correct: "Excellent! Healthy food provides nutrients your body needs!",
        incorrect: "Junk food lacks nutrition and can harm your health!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 💧 for 'Water' or ❌ for 'Alcohol'",
      correctAnswer: '💧',
      feedback: {
        correct: "Perfect! Water is essential for good health!",
        incorrect: "Alcohol can be harmful to your health!"
      }
    },
    {
      id: 4,
      text: "Tap 🛌 for 'Sleep' or ❌ for 'Stay Up All Night'",
      correctAnswer: '🛌',
      feedback: {
        correct: "Well done! Sleep helps your body and mind recover!",
        incorrect: "Staying up all night can harm your health and focus!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🧠 for 'Education' or ❌ for 'Drop Out'",
      correctAnswer: '🧠',
      feedback: {
        correct: "Awesome! Education helps you build a bright future!",
        incorrect: "Dropping out limits your future opportunities!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg">
            Keep staying alert to dangers and making healthy choices!
          </div>
        </div>
      </GameShell>
    );
