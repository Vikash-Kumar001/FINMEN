...
const ReflexGrowthAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🏃‍♀️ for 'Exercise & Rest' or ❌ for 'Ignore Health'",
      correctAnswer: '🏃‍♀️',
      feedback: {
        correct: "Great job! Exercise and rest work together for healthy growth!",
        incorrect: "Remember, both exercise and rest are important for healthy development!"
      }
    },
    {
      id: 2,
      text: "Tap 🥗 for 'Balanced Nutrition' or ❌ for 'Junk Food Only'",
      correctAnswer: '🥗',
      feedback: {
        correct: "Excellent! Balanced nutrition provides all the nutrients your body needs!",
        incorrect: "Your body needs a variety of nutrients for proper growth and development!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 😴 for 'Adequate Sleep' or ❌ for 'All Nighter'",
      correctAnswer: '😴',
      feedback: {
        correct: "Perfect! Adequate sleep allows your body to grow and repair itself!",
        incorrect: "Sleep is crucial for growth hormone production and overall health!"
      }
    },
    {
      id: 4,
      text: "Tap 🧘 for 'Stress Management' or ❌ for 'Constant Stress'",
      correctAnswer: '🧘',
      feedback: {
        correct: "Well done! Managing stress helps your body develop properly!",
        incorrect: "Chronic stress can interfere with healthy growth and development!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 💧 for 'Stay Hydrated' or ❌ for 'Dehydration'",
      correctAnswer: '💧',
      feedback: {
        correct: "Awesome! Proper hydration supports all body functions including growth!",
        incorrect: "Dehydration can negatively impact your body's ability to function optimally!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg">
            Keep making smart choices for healthy growth!
          </div>
        </div>
      </GameShell>
    );
