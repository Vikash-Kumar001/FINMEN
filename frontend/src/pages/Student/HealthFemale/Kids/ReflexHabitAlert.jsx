...
const ReflexHabitAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 💧 for 'Drink Water' or ❌ for 'Skip Water'",
      correctAnswer: '💧',
      feedback: {
        correct: "Great job! Drinking water keeps your body hydrated!",
        incorrect: "Remember, staying hydrated is important for your health!"
      }
    },
    {
      id: 2,
      text: "Tap 🍎 for 'Eat Fruit' or ❌ for 'Skip Fruit'",
      correctAnswer: '🍎',
      feedback: {
        correct: "Excellent! Fruits provide vitamins and nutrients!",
        incorrect: "Fruits are important for good health!"
      }
    },
    {
      id: 3,
      ...
      correctAnswer: '🛌',
      feedback: {
        correct: "Perfect! Getting enough sleep helps your body recover!",
        incorrect: "Sleep is essential for good health and focus!"
      }
    },
    {
      id: 4,
      text: "Tap 🧹 for 'Clean Room' or ❌ for 'Leave Messy'",
      correctAnswer: '🧹',
      feedback: {
        correct: "Well done! A clean environment helps you stay healthy!",
        incorrect: "Keeping your space clean prevents germs and improves focus!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 📚 for 'Read Book' or ❌ for 'Skip Reading'",
      correctAnswer: '📚',
      feedback: {
        correct: "Awesome! Reading improves your knowledge and mind!",
        incorrect: "Reading helps expand your mind and vocabulary!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg">
            Keep developing healthy habits!
          </div>
        </div>
      </GameShell>
    );
