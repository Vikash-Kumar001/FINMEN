...
const ReflexHealthyFood = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🥦 for 'Vegetables' or ❌ for 'Chips'",
      correctAnswer: '🥦',
      feedback: {
        correct: "Great job! Vegetables are full of vitamins!",
        incorrect: "Remember, vegetables are much healthier than chips!"
      }
    },
    {
      id: 2,
      text: "Tap 🍎 for 'Fruits' or ❌ for 'Candy'",
      correctAnswer: '🍎',
      feedback: {
        correct: "Excellent! Fruits have natural sugars and vitamins!",
        incorrect: "Fruits are healthier than candy with artificial sugars!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🥛 for 'Milk' or ❌ for 'Soda'",
      correctAnswer: '🥛',
      feedback: {
        correct: "Perfect! Milk has calcium for strong bones!",
        incorrect: "Milk is much healthier than soda with lots of sugar!"
      }
    },
    {
      id: 4,
      text: "Tap 🍗 for 'Lean Protein' or ❌ for 'Fried Chicken'",
      correctAnswer: '🍗',
      feedback: {
        correct: "Well done! Lean protein helps build strong muscles!",
        incorrect: "Lean protein is healthier than fried foods!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 🌾 for 'Whole Grains' or ❌ for 'White Bread'",
      correctAnswer: '🌾',
      feedback: {
        correct: "Awesome! Whole grains give you lasting energy!",
        incorrect: "Whole grains are much better than refined white bread!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg">
            Keep making healthy food choices!
          </div>
        </div>
      </GameShell>
    );
