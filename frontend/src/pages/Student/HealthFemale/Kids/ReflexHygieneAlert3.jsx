...
const ReflexHygieneAlert3 = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🧼 for 'Soap' or ❌ for 'Skip Bath'",
      correctAnswer: '🧼',
      feedback: {
        correct: "Great job! Using soap helps remove bacteria and keeps you clean!",
        incorrect: "Remember, soap is essential for proper hygiene and removing bacteria!"
      }
    },
    {
      id: 2,
      text: "Tap 🚿 for 'Daily Bath' or ❌ for 'Rare Bathing'",
      correctAnswer: '🚿',
      feedback: {
        correct: "Excellent! Daily bathing helps maintain good hygiene and prevent odor!",
        incorrect: "Regular bathing is important for hygiene and feeling fresh!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 👕 for 'Clean Clothes' or ❌ for 'Dirty Clothes'",
      correctAnswer: '👕',
      feedback: {
        correct: "Perfect! Wearing clean clothes helps prevent odor and infections!",
        incorrect: "Clean clothes are important for hygiene and feeling confident!"
      }
    },
    {
      id: 4,
      text: "Tap 🦷 for 'Brush Teeth' or ❌ for 'Skip Brushing'",
      correctAnswer: '🦷',
      feedback: {
        correct: "Well done! Brushing teeth prevents cavities and keeps your mouth healthy!",
        incorrect: "Regular tooth brushing is essential for oral health!"
      }
    },
    {
      id: 5,
      ...
      correctAnswer: '💧',
      feedback: {
        correct: "Awesome! Staying hydrated supports all body functions including skin health!",
        incorrect: "Adequate hydration is important for overall health and well-being!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg">
            Keep practicing good hygiene habits!
          </div>
        </div>
      </GameShell>
    );
