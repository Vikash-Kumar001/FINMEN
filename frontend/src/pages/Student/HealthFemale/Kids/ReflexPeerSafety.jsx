...
const ReflexPeerSafety = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 🙅‍♀️ for 'Say No' or ❌ for 'Join Wrong Act'",
      correctAnswer: '🙅‍♀️',
      feedback: {
        correct: "Great job! Saying no to wrong activities keeps you safe!",
        incorrect: "Remember, saying no to harmful activities protects you!"
      }
    },
    {
      id: 2,
      text: "Tap 🛡️ for 'Stand Up for Yourself' or ❌ for 'Follow Pressure'",
      correctAnswer: '🛡️',
      feedback: {
        correct: "Excellent! Standing up for yourself shows strength!",
        incorrect: "Standing up for your values is always the right choice!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 👥 for 'Good Friends Support You' or ❌ for 'Bad Friends Pressure'",
      correctAnswer: '👥',
      feedback: {
        correct: "Perfect! Good friends respect your choices!",
        incorrect: "True friends support your good decisions!"
      }
    },
    {
      id: 4,
      ...
      correctAnswer: '🤝',
      feedback: {
        correct: "Well done! Asking for help shows wisdom!",
        incorrect: "Trusted adults can help you handle peer pressure!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap ✅ for 'Make Good Choices' or ❌ for 'Regret Later'",
      correctAnswer: '✅',
      feedback: {
        correct: "Awesome! Good choices lead to positive outcomes!",
        incorrect: "Making good choices now helps your future!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg">
            Keep standing up to peer pressure!
          </div>
        </div>
      </GameShell>
    );
