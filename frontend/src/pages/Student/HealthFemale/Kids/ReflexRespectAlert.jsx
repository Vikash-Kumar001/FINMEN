...
const ReflexRespectAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 💪 for 'Respect Myself' or ❌ for 'Follow Wrong Crowd'",
      correctAnswer: '💪',
      feedback: {
        correct: "Great job! Respecting yourself is the foundation of healthy relationships!",
        incorrect: "Remember, respecting yourself comes before following others!"
      }
    },
    {
      id: 2,
      text: "Tap 🛡️ for 'Stand Up for Values' or ❌ for 'Compromise Integrity'",
      correctAnswer: '🛡️',
      feedback: {
        correct: "Excellent! Standing up for your values shows strength!",
        incorrect: "Your values are important and worth protecting!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🤝 for 'Healthy Friendship' or ❌ for 'Toxic Influence'",
      correctAnswer: '🤝',
      feedback: {
        correct: "Perfect! Healthy friendships support your wellbeing!",
        incorrect: "True friends respect your boundaries and values!"
      }
    },
    {
      id: 4,
      text: "Tap 🎯 for 'Stay Focused on Goals' or ❌ for 'Distract from Dreams'",
      correctAnswer: '🎯',
      feedback: {
        correct: "Well done! Staying focused on your goals leads to success!",
        incorrect: "Your dreams and goals are worth protecting!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 👑 for 'Self-Worth Matters' or ❌ for 'Seek Approval'",
      correctAnswer: '👑',
      feedback: {
        correct: "Awesome! Recognizing your self-worth is empowering!",
        incorrect: "Your worth comes from within, not from others' approval!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg">
            Keep respecting yourself and your values!
          </div>
        </div>
      </GameShell>
    );
