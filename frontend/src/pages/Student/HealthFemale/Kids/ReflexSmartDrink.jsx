...
const ReflexSmartDrink = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Quick! Tap 💧 for 'Water' or ❌ for 'Soda'",
      correctAnswer: '💧',
      feedback: {
        correct: "Great job! Water keeps you hydrated without extra sugar!",
        incorrect: "Remember, water is the healthiest drink for your body!"
      }
    },
    {
      id: 2,
      text: "Tap 🥛 for 'Milk' or ❌ for 'Energy Drink'",
      correctAnswer: '🥛',
      feedback: {
        correct: "Excellent! Milk has protein and calcium for strong bones!",
        incorrect: "Milk is much healthier than energy drinks with lots of caffeine!"
      }
    },
    {
      id: 3,
      text: "Quick! Tap 🍹 for 'Fresh Juice' or ❌ for 'Syrup Drink'",
      correctAnswer: '🍹',
      feedback: {
        correct: "Perfect! Fresh juice has vitamins without added sugars!",
        incorrect: "Fresh juice is healthier than syrup drinks with artificial flavors!"
      }
    },
    {
      id: 4,
      text: "Tap 🥤 for 'Herbal Tea' or ❌ for 'Soda'",
      correctAnswer: '🥤',
      feedback: {
        correct: "Well done! Herbal tea is a healthy, caffeine-free option!",
        incorrect: "Herbal tea is much better than soda with lots of sugar!"
      }
    },
    {
      id: 5,
      text: "Quick! Tap 💧 for 'Coconut Water' or ❌ for 'Sports Drink'",
      correctAnswer: '💧',
      feedback: {
        correct: "Awesome! Coconut water naturally hydrates without artificial ingredients!",
        incorrect: "Coconut water is much better than sports drinks with added sugars!"
      }
    }
  ];
      ...
      >
        <div className="text-center p-8">
          ...
          <div className="text-yellow-400 font-bold text-lg">
            Keep making smart drink choices!
          </div>
        </div>
      </GameShell>
    );
