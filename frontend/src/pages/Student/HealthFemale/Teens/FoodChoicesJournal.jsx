...
const FoodChoicesJournal = () => {
  ...
  const prompts = [
    {
      id: 1,
      title: "Healthy Habit Change",
      text: "One change I made in my eating habits is ___."
    },
    {
      id: 2,
      title: "Nutrition Discovery",
      text: "I learned that ___ food gives me more energy for sports."
    },
    {
      id: 3,
      title: "Food Challenge",
      text: "A challenge I faced with healthy eating was ___."
    },
    {
      id: 4,
      title: "Healthy Success Story",
      text: "One healthy food choice that made me feel good is ___."
    },
    {
      id: 5,
      title: "Future Nutrition Goals",
      text: "In the future, I want to improve my ___ eating habit."
    }
  ];
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/weekly-meals-simulation");
  };
          ...
          {gameFinished && (
            <div className="text-center space-y-4 mt-8">
              <div className="text-green-400">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Food Choices Journal Complete!</h3>
                <p className="text-white/90 mb-4">
                  Excellent reflection! You've completed all 5 journal prompts about your nutrition journey.
                </p>
