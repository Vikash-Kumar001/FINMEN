...
const JournalOfDoctorVisits = () => {
  ...
  const prompts = [
    ...
    {
      id: 2,
      text: "I felt ___ during my last doctor visit"
    },
    {
      id: 3,
      text: "Something I learned about my health is ___"
    },
    {
      id: 4,
      text: "A question I would ask a doctor is ___"
    },
    {
      id: 5,
      text: "One way I can take better care of my health is ___"
    }
  ];
    ...
    >
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <div className="mb-6">
            <h2 className="text-white text-xl font-bold mb-4">Reflect on your healthcare experiences:</h2>
