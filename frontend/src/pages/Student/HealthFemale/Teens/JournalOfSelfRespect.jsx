...
const JournalOfSelfRespect = () => {
  ...
  const prompts = [
    {
      id: 1,
      text: "One thing I like about myself is ___"
    },
    {
      id: 2,
      text: "A skill or talent I'm proud of is ___"
    },
    {
      id: 3,
      text: "A kind thing I've done for someone else is ___"
    },
    {
      id: 4,
      text: "A challenge I've overcome is ___"
    },
    {
      id: 5,
      text: "Something I'm grateful for about my life is ___"
    }
  ];
    ...
    >
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <div className="mb-6">
            <h2 className="text-white text-xl font-bold mb-4">Reflect on your self-respect:</h2>
