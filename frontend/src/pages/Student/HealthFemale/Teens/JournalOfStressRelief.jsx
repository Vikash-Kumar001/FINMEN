...
const JournalOfStressRelief = () => {
  ...
  const prompts = [
    {
      id: 1,
      text: "One way I manage stress is ___"
    },
    {
      id: 2,
      text: "A relaxing activity I enjoy is ___"
    },
    {
      id: 3,
      text: "When I feel overwhelmed, I ___"
    },
    {
      id: 4,
      text: "A person I can talk to about stress is ___"
    },
    {
      id: 5,
      text: "Something that makes me feel confident is ___"
    }
  ];
    ...
    >
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <div className="mb-6">
            <h2 className="text-white text-xl font-bold mb-4">Reflect on your stress management:</h2>
