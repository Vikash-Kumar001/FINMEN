...
const JournalOfTeenHabits = () => {
  ...
  const prompts = [
    {
      id: 1,
      text: "One habit I built as a teen is ___"
    },
    {
      id: 2,
      text: "A healthy routine I follow daily is ___"
    },
    {
      id: 3,
      text: "The biggest challenge in maintaining good habits is ___"
    },
    {
      id: 4,
      text: "A strategy that helps me stay consistent is ___"
    },
    {
      id: 5,
      text: "How my habits have improved my life is ___"
    }
  ];
    ...
    >
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <div className="mb-6">
            <h2 className="text-white text-xl font-bold mb-4">Reflect on your healthy habits:</h2>
