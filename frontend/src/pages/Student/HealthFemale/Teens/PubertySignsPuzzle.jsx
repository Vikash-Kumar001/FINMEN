...
const PubertySignsPuzzle = () => {
  ...
  const puzzles = [
    {
      ...
      emoji: "🔴",
      matches: [
        { id: "puberty", text: "Puberty", emoji: "🦋", correct: true },
    ...
    },
    {
      ...
      matches: [
        ...
        { id: "exercise", text: "Exercise", emoji: "🏃", correct: false }
      ]
    },
    {
      id: 3,
      ...
      matches: [
        { id: "puberty", text: "Puberty", emoji: "🦋", correct: true },
        { id: "personality", text: "Personality", emoji: "👤", correct: false },
        { id: "weather", text: "Weather", emoji: "☀️", correct: false }
      ]
    },
    {
      id: 4,
      ...
      matches: [
        { id: "puberty", text: "Puberty", emoji: "🦋", correct: true },
        { id: "genetics", text: "Genetics", emoji: "🧬", correct: false },
        { id: "hygiene", text: "Hygiene", emoji: "🧼", correct: false }
      ]
    },
    {
      id: 5,
      ...
      matches: [
        { id: "puberty", text: "Puberty", emoji: "🦋", correct: true },
        { id: "nutrition", text: "Nutrition", emoji: "🍎", correct: false },
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/acne-story");
  };
      ...
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <p className="text-white text-lg mb-6 text-center">
            Match the puberty sign to what causes it!
          </p>
