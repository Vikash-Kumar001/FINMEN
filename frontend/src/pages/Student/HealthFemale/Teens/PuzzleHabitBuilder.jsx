...
const PuzzleHabitBuilder = () => {
  ...
  const puzzles = [
    {
      ...
      emoji: "💧",
      matches: [
        { id: "hydration", text: "Hydration", emoji: "🥤", correct: true },
        { id: "energy", text: "Energy", emoji: "⚡", correct: false },
        { id: "focus", text: "Focus", emoji: "🎯", correct: false }
      ]
    },
    {
      id: 2,
      ...
      emoji: "🏃",
      matches: [
        { id: "fitness", text: "Fitness", emoji: "💪", correct: true },
        { id: "sleep", text: "Sleep", emoji: "😴", correct: false },
        { id: "diet", text: "Diet", emoji: "🥗", correct: false }
      ]
    },
    {
      id: 3,
      ...
      matches: [
        ...
        { id: "hydration", text: "Hydration", emoji: "🥤", correct: false },
        { id: "fitness", text: "Fitness", emoji: "💪", correct: false }
      ]
    },
    {
      id: 4,
      ...
      emoji: "😴",
      matches: [
        { id: "restoration", text: "Restoration", emoji: "🔄", correct: true },
        { id: "entertainment", text: "Entertainment", emoji: "🎮", correct: false },
    ...
    },
    {
      ...
      emoji: "🍎",
      matches: [
        { id: "health", text: "Health", emoji: "❤️", correct: true },
        { id: "wealth", text: "Wealth", emoji: "💰", correct: false },
        { id: "popularity", text: "Popularity", emoji: "🌟", correct: false }
      ]
    }
  ];
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/chores-story");
  };
      ...
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <p className="text-white text-lg mb-6 text-center">
            Match the habit to its primary benefit!
          </p>
