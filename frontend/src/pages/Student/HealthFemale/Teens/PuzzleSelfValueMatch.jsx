...
const PuzzleSelfValueMatch = () => {
  ...
  const puzzles = [
    {
      ...
      emoji: "🦁",
      matches: [
        { id: "speak", text: "Speak Up", emoji: "📢", correct: true },
        { id: "hide", text: "Stay Silent", emoji: "🤫", correct: false },
        { id: "fear", text: "Avoid Challenges", emoji: "🏃", correct: false }
      ]
    },
    {
      id: 2,
      ...
      emoji: "👸",
      matches: [
        { id: "sayno", text: "Say No", emoji: "✋", correct: true },
        { id: "yes", text: "Always Agree", emoji: "👍", correct: false },
        { id: "ignore", text: "Ignore Values", emoji: "🙈", correct: false }
      ]
    },
    {
      id: 3,
      ...
      emoji: "😇",
      matches: [
        { id: "confidence", text: "Confidence", emoji: "🌟", correct: true },
        { id: "weakness", text: "Weakness", emoji: "😿", correct: false },
        { id: "judgment", text: "Judgment", emoji: "🤨", correct: false }
      ]
    },
    {
      id: 4,
      ...
      emoji: "🧗",
      matches: [
        { id: "persist", text: "Keep Trying", emoji: "💪", correct: true },
        { id: "quit", text: "Give Up", emoji: "🏳️", correct: false },
        { id: "blame", text: "Blame Others", emoji: "😠", correct: false }
      ]
    },
    {
      id: 5,
      ...
      emoji: "🤗",
      matches: [
        { id: "understand", text: "Understand Others", emoji: "👂", correct: true },
        { id: "ignore", text: "Ignore Feelings", emoji: "😶", correct: false },
        { id: "selfish", text: "Think Only of Self", emoji: "🤳", correct: false }
      ]
    }
  ];
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/social-media-story");
  };
      ...
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <p className="text-white text-lg mb-6 text-center">
            Match the personal value to its positive expression!
          </p>
