...
const PuzzleSubstanceEffects = () => {
  ...
  const puzzles = [
    {
      ...
      emoji: "🚬",
      matches: [
        { id: "lungs", text: "Lungs", emoji: "🫁", correct: true },
        { id: "liver", text: "Liver", emoji: "🍺", correct: false },
    ...
    },
    {
      ...
      emoji: "🍺",
      matches: [
        { id: "liver", text: "Liver", emoji: "🍺", correct: true },
    ...
    },
    {
      ...
      emoji: "💊",
      matches: [
        { id: "brain", text: "Brain", emoji: "🧠", correct: true },
        { id: "lungs", text: "Lungs", emoji: "🫁", correct: false },
        { id: "stomach", text: "Stomach", emoji: " dạ dày", correct: false }
      ]
    },
    {
      id: 4,
      ...
      emoji: " cigaret",
      matches: [
        { id: "addiction", text: "Addiction", emoji: "🔗", correct: true },
        { id: "energy", text: "Energy", emoji: "⚡", correct: false },
        { id: "relaxation", text: "Relaxation", emoji: "🧘", correct: false }
      ]
    },
    {
      id: 5,
      ...
      emoji: "🌿",
      matches: [
        { id: "memory", text: "Memory", emoji: "🧠", correct: true },
        { id: "strength", text: "Strength", emoji: "💪", correct: false },
        { id: "vision", text: "Vision", emoji: "👀", correct: false }
      ]
    }
  ];
  ...
  const handleNext = () => {
    navigate("/student/health-female/teens/party-story");
  };
      ...
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <p className="text-white text-lg mb-6 text-center">
            Match the substance to its primary effect on the body!
          </p>
