...
const ReflexConfidenceCheck = () => {
  ...
  const scenarios = [
    { action: "I Can Try", emoji: "💪", isCorrect: true },
    { action: "I Am Useless", emoji: "❌", isCorrect: false },
    { action: "I Am Capable", emoji: "🌟", isCorrect: true },
    { action: "I Will Fail", emoji: "😰", isCorrect: false },
    { action: "I Deserve Respect", emoji: "👑", isCorrect: true },
    { action: "I Am Worthless", emoji: "🗑️", isCorrect: false },
    { action: "I Can Learn", emoji: "📚", isCorrect: true },
    { action: "I Am Stupid", emoji: "😵", isCorrect: false }
  ];
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Get ready for confidence choices...'}
              {gameState === 'showing' && 'Watch for the confidence signal...'}
              {gameState === 'ready' && 'QUICK! Choose the positive self-belief!'}
              {gameState === 'success' && `Great choice! (${reactionTime}ms)`}
              {gameState === 'fail' && 'Too slow! Always choose positive self-belief!'}
            </p>
          </div>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Always choose positive self-belief!</p>
              </div>
            </div>
          )}
        </div>
