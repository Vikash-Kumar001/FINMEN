...
const ReflexDrinkChoice = () => {
  ...
  const scenarios = [
    { action: "Water", emoji: "💧", isCorrect: true },
    { action: "Cola", emoji: "🥤", isCorrect: false },
    { action: "Fresh Juice", emoji: "🧃", isCorrect: true },
    { action: "Energy Drink", emoji: "🔋", isCorrect: false },
    { action: "Coconut Water", emoji: "🥥", isCorrect: true },
    { action: "Soda", emoji: "🥤", isCorrect: false },
    { action: "Milk", emoji: "🥛", isCorrect: true },
    { action: "Fruit Drink", emoji: "🍹", isCorrect: false }
  ];
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Get ready for smart drink choices...'}
              {gameState === 'showing' && 'Watch for the drink signal...'}
              {gameState === 'ready' && 'QUICK! Choose the healthy drink option!'}
              {gameState === 'success' && `Smart choice! (${reactionTime}ms)`}
              {gameState === 'fail' && 'Too slow! Always choose healthy drinks!'}
            </p>
          </div>
          ...
          {gameState === 'success' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-green-400">
                ...
                <h3 className="text-xl font-bold text-white">Smart Drink Choice!</h3>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Always choose healthy drinks!</p>
              </div>
            </div>
          )}
        </div>
