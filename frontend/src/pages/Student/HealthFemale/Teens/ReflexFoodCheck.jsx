...
const ReflexFoodCheck = () => {
  ...
  const scenarios = [
    { action: "Balanced Plate", emoji: "🥗", isCorrect: true },
    { action: "Pizza Every Day", emoji: "🍕", isCorrect: false },
    { action: "Fresh Fruits", emoji: "🍎", isCorrect: true },
    { action: "Chips Only", emoji: "🍟", isCorrect: false },
    { action: "Home Cooked Meal", emoji: "🍛", isCorrect: true },
    { action: "Fast Food", emoji: "🍔", isCorrect: false },
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Get ready for smart food choices...'}
              {gameState === 'showing' && 'Watch for the food signal...'}
              {gameState === 'ready' && 'QUICK! Choose the healthy food option!'}
          ...
          {gameState === 'success' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-green-400">
                ...
                <h3 className="text-xl font-bold text-white">Smart Food Choice!</h3>
