...
const ReflexHygieneAlert = () => {
  ...
  const scenarios = [
    { action: "Fresh Clothes", emoji: "👚", isCorrect: true },
    { action: "Repeat Dirty", emoji: "👕", isCorrect: false },
    { action: "Use Sanitary Pad", emoji: "🧻", isCorrect: true },
    { action: "Reuse Product", emoji: "❌", isCorrect: false },
    { action: "Wash Hands", emoji: "🧼", isCorrect: true },
    { action: "Skip Washing", emoji: "💧", isCorrect: false },
