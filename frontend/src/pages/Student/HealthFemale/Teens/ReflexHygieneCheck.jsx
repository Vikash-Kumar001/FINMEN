...
const ReflexHygieneCheck = () => {
  ...
  const scenarios = [
    ...
    { action: "Ignore Sweat", emoji: "❌", isCorrect: false },
    { action: "Wash Face", emoji: "🧼", isCorrect: true },
    { action: "Skip Cleansing", emoji: "💧", isCorrect: false },
    { action: "Change Clothes", emoji: "👕", isCorrect: true },
    { action: "Wear Dirty", emoji: "👚", isCorrect: false },
