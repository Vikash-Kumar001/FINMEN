...
const ReflexStressCheck = () => {
  ...
  const scenarios = [
    ...
    { action: "Panic", emoji: "😰", isCorrect: false },
    { action: "Take a Walk", emoji: "🚶", isCorrect: true },
    { action: "Isolate Self", emoji: "🚪", isCorrect: false },
    { action: "Listen to Music", emoji: "🎵", isCorrect: true },
    { action: "Cry Alone", emoji: "😢", isCorrect: false }
  ];
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Get ready for stress management choices...'}
              ...
              {gameState === 'fail' && 'Too slow! Always choose healthy stress responses!'}
            </p>
          </div>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Always choose healthy stress responses!</p>
              </div>
            </div>
          )}
        </div>
