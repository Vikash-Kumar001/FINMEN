...
const ReflexTeenChoice = () => {
  ...
  const scenarios = [
    ...
    { action: "Music", emoji: "🎵", isCorrect: true },
    { action: "Smoking", emoji: "🚬", isCorrect: false },
    { action: "Art", emoji: "🎨", isCorrect: true },
    { action: "Gambling", emoji: "🎰", isCorrect: false }
  ];
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Get ready for healthy choices...'}
              {gameState === 'showing' && 'Watch for the activity signal...'}
              {gameState === 'ready' && 'QUICK! Choose the healthy activity!'}
