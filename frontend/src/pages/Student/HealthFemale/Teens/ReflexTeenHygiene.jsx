...
const ReflexTeenHygiene = () => {
  ...
  const scenarios = [
    { action: "Change Pads Often", emoji: "🩹", isCorrect: true },
    { action: "Keep Same Pad", emoji: "❌", isCorrect: false },
    { action: "Wash Hands", emoji: "🧼", isCorrect: true },
    { action: "Skip Hand Washing", emoji: "💧", isCorrect: false },
    { action: "Use Deodorant", emoji: "🧴", isCorrect: true },
    { action: "Skip Deodorant", emoji: "👕", isCorrect: false },
    { action: "Shower Daily", emoji: "🚿", isCorrect: true },
    { action: "Skip Shower", emoji: "🛏️", isCorrect: false }
  ];
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Get ready for smart hygiene choices...'}
              {gameState === 'showing' && 'Watch for the hygiene signal...'}
              {gameState === 'ready' && 'QUICK! Choose the smart hygiene option!'}
              {gameState === 'success' && `Smart choice! (${reactionTime}ms)`}
              {gameState === 'fail' && 'Too slow! Always choose smart hygiene!'}
            </p>
          </div>
          ...
          {gameState === 'success' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-green-400">
                ...
                <h3 className="text-xl font-bold text-white">Smart Hygiene!</h3>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Always choose smart hygiene!</p>
              </div>
            </div>
          )}
        </div>
