...
const FoodHabitsJournal = () => {
  ...
  const prompts = [
    {
      id: 1,
      title: "Favorite Healthy Food",
      text: "One healthy food I like is ___ because ___."
    },
    {
      id: 2,
      title: "Healthy Breakfast",
      text: "For breakfast, I eat ___ to start my day healthy."
    },
    {
      id: 3,
      title: "Fruit I Enjoy",
      text: "My favorite fruit is ___ and I like it because ___."
    },
    {
      id: 4,
      title: "Healthy Lunch",
      text: "A healthy lunch I enjoy includes ___."
    },
    {
      id: 5,
      title: "Water Habits",
      text: "I drink water ___ times a day to stay healthy."
    }
  ];
  ...
  const handleNext = () => {
    navigate("/student/health-male/kids/junk-food-story");
  };
          ...
          {gameFinished && (
            <div className="text-center space-y-4 mt-8">
              <div className="text-green-400">
                ...
                <p className="text-white/90 mb-4">
                  Excellent reflection! You've shared 5 thoughts about your healthy eating habits.
                </p>
