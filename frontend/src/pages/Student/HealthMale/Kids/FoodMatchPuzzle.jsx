...
const FoodMatchPuzzle = () => {
  ...
  const puzzles = [
    {
      ...
      emoji: "🥛",
      matches: [
        { id: "calcium", text: "Calcium", emoji: "🦴", correct: true },
        { id: "protein", text: "Protein", emoji: "💪", correct: false },
        { id: "vitamins", text: "Vitamins", emoji: "🌟", correct: false }
      ]
    },
    {
      id: 2,
      ...
      matches: [
        ...
        { id: "calcium", text: "Calcium", emoji: "🦴", correct: false }
      ]
    },
    {
      id: 3,
      ...
      matches: [
        { id: "protein", text: "Protein", emoji: "💪", correct: false },
        { id: "vitamins", text: "Vitamins", emoji: "🌟", correct: true },
        { id: "calcium", text: "Calcium", emoji: "🦴", correct: false }
      ]
    },
    {
  ...
  return (
    <GameShell
      ...
      subtitle={showResult ? "Puzzle Complete!" : `Match foods with their benefits (${currentPuzzle + 1}/${puzzles.length} completed)`}
      score={score}
          ...
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-white/90 text-center mb-6">
                Match the food to what it gives your body!
              </p>
