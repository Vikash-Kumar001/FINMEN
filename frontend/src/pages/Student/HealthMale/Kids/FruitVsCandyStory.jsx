...
const FruitVsCandyStory = () => {
  ...
  const handleNext = () => {
    navigate("/student/health-male/kids/quiz-food-groups");
  };
          ...
          <div className="grid grid-cols-1 gap-4">
            {getCurrentQuestion().options.map(option => (
              <button
                ...
                className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white p-6 rounded-2xl shadow-lg transition-all transform hover:scale-105 text-left"
              >
