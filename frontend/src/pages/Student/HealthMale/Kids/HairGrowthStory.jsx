...
const HairGrowthStory = () => {
  ...
  const handleNext = () => {
    navigate("/student/health-male/kids/reflex-growth-alert");
  };
          ...
          <div className="grid grid-cols-1 gap-4">
            {getCurrentQuestion().options.map(option => (
              <button
                ...
                className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white p-6 rounded-2xl shadow-lg transition-all transform hover:scale-105 text-left"
              >
