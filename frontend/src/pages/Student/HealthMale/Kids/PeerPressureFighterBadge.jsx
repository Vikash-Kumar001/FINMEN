...
const PeerPressureFighterBadge = () => {
  ...
  const challenges = [
    {
      id: 1,
      text: "Say no to skipping homework",
      emoji: "📚",
      description: "School work comes before fun - you made the responsible choice",
      completed: false
    },
    {
      id: 2,
      text: "Refuse dangerous dares",
      emoji: "⚠️",
      description: "Your safety is more important than any dare or challenge",
      completed: false
    },
    {
      id: 3,
      text: "Stand up to bullying",
      emoji: "🛡️",
      description: "You showed courage by not letting others pressure you",
      completed: false
    },
    {
      id: 4,
      ...
      emoji: "🚧",
      description: "Everyone deserves respect - you honored that principle",
      completed: false
    },
    {
      id: 5,
      text: "Choose honesty over fitting in",
      emoji: "🤝",
      description: "Being true to yourself is more important than following the crowd",
      completed: false
    }
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={`Complete ${completedChallenges.length} of ${challenges.length} pressure challenges`}
      onNext={handleNext}
      nextEnabled={gameFinished}
      showGameOver={gameFinished}
      score={completedChallenges.length * 2}
      gameId="health-male-kids-70"
      ...
      <div className="space-y-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          <div className="text-center mb-6">
            ...
            <h3 className="text-2xl font-bold text-white mb-2">Earn Your Peer Pressure Fighter Badge</h3>
            <p className="text-white/90">
              Complete 5 peer pressure challenges to prove you're a pressure-fighting champion!
            </p>
          </div>
