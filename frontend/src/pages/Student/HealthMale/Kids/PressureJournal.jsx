          ...
          <div className="space-y-4">
            <div className="relative">
              <textarea
                ...
                placeholder="Write about a time when you said no to pressure... What happened? How did it make you feel? Be proud of your strength! 💪"
              ...
              <div className="text-white/80">
                {isLongEnough ? (
                  <span className="flex items-center text-green-400">
                    ...
                    Excellent! You've shared your experience with saying no!
                  </span>
                ) : (
            ...
            <div className="text-center space-y-4 mt-8">
              <div className="text-green-400">
                ...
                <p className="text-white/90 mb-4 text-lg">
                  Thank you for sharing your story! Remembering times you stood up to pressure helps you stay strong in the future!
                </p>
