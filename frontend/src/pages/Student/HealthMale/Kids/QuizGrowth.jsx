...
const QuizGrowth = () => {
  ...
  const handleNext = () => {
    navigate("/student/health-male/kids/reflex-growth-basics");
  };
          ...
          <div className="grid grid-cols-1 gap-4">
            {getCurrentQuestion().options.map(option => (
              <button
                ...
                className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white p-6 rounded-2xl shadow-lg transition-all transform hover:scale-105 text-left"
              >
