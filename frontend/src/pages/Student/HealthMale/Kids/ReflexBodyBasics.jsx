...
const ReflexBodyBasics = () => {
  ...
  const scenarios = [
    { action: "💚 Organs Work Together", emoji: "💚", isCorrect: true },
    { action: "❌ Organs Work Alone", emoji: "❌", isCorrect: false },
    { action: "🫀 Heart Pumps Blood", emoji: "🫀", isCorrect: true },
    { action: "🧠 Brain Only Thinks", emoji: "🧠", isCorrect: false },
    { action: "🫁 Lungs Give Oxygen", emoji: "🫁", isCorrect: true },
    { action: "❤️ Heart Breathes", emoji: "❤️", isCorrect: false },
    { action: "🫄 Stomach Digests", emoji: "🫄", isCorrect: true },
    { action: "🦴 Bones Think", emoji: "🦴", isCorrect: false }
  ];
  ...
  const handleNext = () => {
    navigate("/student/health-male/kids/body-match-puzzle");
  };
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Body basics incoming...'}
              {gameState === 'showing' && 'Watch for the body signal...'}
              {gameState === 'ready' && 'QUICK! Choose the correct body function!'}
              {gameState === 'success' && `Body choice! (${reactionTime}ms)`}
              {gameState === 'fail' && 'Too slow! Remember how body organs work!'}
            </p>
          </div>
          ...
          {gameState === 'success' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-green-400">
                ...
                <h3 className="text-xl font-bold text-white">Body Choice!</h3>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Learn how body organs work together!</p>
              </div>
            </div>
          )}
        </div>
