...
const ReflexFoodAlert = () => {
  ...
  const scenarios = [
    ...
    { action: "🍫 Chocolate", emoji: "🍫", isCorrect: false }
  ];
  ...
  const handleNext = () => {
    navigate("/student/health-male/kids/healthy-kid-badge");
  };
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Food alert incoming...'}
