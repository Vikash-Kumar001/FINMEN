...
const ReflexGrowthBasics = () => {
  ...
  const scenarios = [
    { action: "🛌 Healthy Sleep", emoji: "🛌", isCorrect: true },
    { action: "🌙 Stay Awake", emoji: "🌙", isCorrect: false },
    ...
    { action: "🥕 Eat Veggies", emoji: "🥕", isCorrect: true },
    { action: "🍪 Skip Veggies", emoji: "🍪", isCorrect: false }
  ];
  ...
  const handleNext = () => {
    navigate("/student/health-male/kids/growth-helpers-puzzle");
  };
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Growth basics incoming...'}
              {gameState === 'showing' && 'Watch for the growth signal...'}
              {gameState === 'ready' && 'QUICK! Choose the healthy growth habit!'}
              {gameState === 'success' && `Growth choice! (${reactionTime}ms)`}
              {gameState === 'fail' && 'Too slow! Always choose healthy growth habits!'}
            </p>
          </div>
