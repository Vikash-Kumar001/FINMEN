...
const ReflexHabitAlert = () => {
  ...
  const questions = [
    {
      id: 1,
      instruction: "You are late! Tap the GOOD habit!",
      wrongEmoji: "🚫",
      correctEmoji: "🍎",
      correctAnswer: "🍎",
      correctText: "Eat Breakfast",
      wrongText: "Skip It"
    },
    {
      id: 2,
      instruction: "You are tired. Tap the GOOD habit!",
      correctEmoji: "😴",
      wrongEmoji: "☕",
      correctAnswer: "😴",
      correctText: "Sleep Early",
      wrongText: "Drink Soda"
    },
    {
      id: 3,
      instruction: "You are bored. Tap the GOOD habit!",
      wrongEmoji: "📺",
      correctEmoji: "📖",
      correctAnswer: "📖",
    ...
    {
      id: 4,
      instruction: "Your hands are dirty. Tap the GOOD habit!",
      wrongEmoji: "👖",
      correctEmoji: "🧼",
      correctAnswer: "🧼",
      correctText: "Wash Hands",
      wrongText: "Wipe on Pants"
    },
    {
      id: 5,
      instruction: "You are thirsty. Tap the GOOD habit!",
      wrongEmoji: "🥤",
      correctEmoji: "💧",
      correctAnswer: "💧",
      correctText: "Drink Water",
      wrongText: "Drink Juice"
    }
  ];
  ...
  const handleEmojiClick = (selectedEmoji) => {
    ...
    if (isCorrect) {
      ...
      setLastResult({ correct: false, message: "Think again!" });
    }
          ...
          {!gameFinished ? (
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-white/90">
                You make quick, healthy decisions! Keep up the great work!
              </p>
            </div>
          )}
        </div>
