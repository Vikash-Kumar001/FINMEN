...
const ReflexHealthySteps = () => {
  ...
  const questions = [
    {
      id: 1,
      instruction: "You have a bad headache that won't go away. Do you VISIT DOCTOR?",
      correctEmoji: "🏥",
      wrongEmoji: "❌",
      correctAnswer: "🏥",
      correctText: "Doctor Visit",
      wrongText: "Ignore Problem",
      timeout: 4000
    },
    {
      id: 2,
      instruction: "Your ear hurts when you touch it. Do you VISIT DOCTOR?",
      correctEmoji: "🏥",
      wrongEmoji: "❌",
      correctAnswer: "🏥",
      correctText: "Doctor Visit",
    ...
    {
      id: 3,
      instruction: "You have a rash that spreads. Do you VISIT DOCTOR?",
      correctEmoji: "🏥",
      wrongEmoji: "❌",
      correctAnswer: "🏥",
      correctText: "Doctor Visit",
    ...
    {
      id: 4,
      instruction: "Your stomach hurts for days. Do you VISIT DOCTOR?",
      correctEmoji: "🏥",
      wrongEmoji: "❌",
      correctAnswer: "🏥",
      correctText: "Doctor Visit",
    ...
    {
      id: 5,
      instruction: "You feel dizzy and weak. Do you VISIT DOCTOR?",
      correctEmoji: "🏥",
      wrongEmoji: "❌",
      correctAnswer: "🏥",
      correctText: "Doctor Visit",
          ...
          {gameFinished && (
            <div className="text-center space-y-4">
              ...
              <p className="text-white/90">
                You chose health over ignoring problems! Quick thinking about health helps you stay well!
              </p>
            </div>
          )}
        </div>
