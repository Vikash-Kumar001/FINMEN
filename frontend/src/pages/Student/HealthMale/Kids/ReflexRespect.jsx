...
const ReflexRespect = () => {
  ...
  const questions = [
    {
      id: 1,
      instruction: "Friends want you to break a rule. Do you RESPECT boundaries?",
      correctEmoji: "🙅",
      wrongEmoji: "👥",
      correctAnswer: "🙅",
      correctText: "Respect Boundaries",
      wrongText: "Blindly Follow"
    },
    {
      id: 2,
      instruction: "Someone pressures you to share secrets. Do you RESPECT boundaries?",
      wrongEmoji: "👥",
      correctEmoji: "🙅",
      correctAnswer: "🙅",
      correctText: "Respect Boundaries",
    ...
    {
      id: 3,
      instruction: "Friends want you to ignore your parents' rules. Do you RESPECT boundaries?",
      wrongEmoji: "👥",
      correctEmoji: "🙅",
      correctAnswer: "🙅",
      correctText: "Respect Boundaries",
    ...
    {
      id: 4,
      instruction: "Someone asks for your personal information. Do you RESPECT boundaries?",
      correctEmoji: "🙅",
      wrongEmoji: "👥",
      correctAnswer: "🙅",
      correctText: "Respect Boundaries",
    ...
    {
      id: 5,
      instruction: "Friends pressure you to do something that feels wrong. Do you RESPECT boundaries?",
      wrongEmoji: "👥",
      correctEmoji: "🙅",
      correctAnswer: "🙅",
      correctText: "Respect Boundaries",
  ...
  const handleEmojiClick = (selectedEmoji) => {
    ...
    if (isCorrect) {
      ...
      setLastResult({ correct: false, message: "Oops! Respect boundaries!" });
    }
          ...
          {!gameFinished ? (
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-white/90">
                You chose respect and boundaries over following the crowd! Your quick thinking shows strong character!
              </p>
            </div>
          )}
        </div>
