...
const VoiceChangeStory = () => {
  ...
  const handleNext = () => {
    navigate("/student/health-male/kids/growing-up-poster");
  };
          ...
          <div className="grid grid-cols-1 gap-4">
            {getCurrentQuestion().options.map(option => (
              <button
                ...
                className="bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 text-white p-6 rounded-2xl shadow-lg transition-all transform hover:scale-105 text-left"
              >
