...
const ReflexEmotionalHealth = () => {
  ...
  const scenarios = [
    { action: "Talk to Mentor", emoji: "👨‍🏫", isCorrect: true },
    ...
    { action: "Seek Support", emoji: "🤝", isCorrect: true },
    { action: "Ignore Problems", emoji: "🙈", isCorrect: false },
    { action: "Practice Mindfulness", emoji: "🧘", isCorrect: true },
    { action: "Suppress Feelings", emoji: "😶", isCorrect: false }
  ];
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Emotional health scenario loading...'}
              {gameState === 'showing' && 'Watch for the emotional health signal...'}
              {gameState === 'ready' && 'QUICK! Choose the healthy emotional response!'}
              {gameState === 'success' && `Healthy choice! (${reactionTime}ms)`}
              {gameState === 'fail' && 'Too slow! Always choose healthy emotional health!'}
            </p>
          </div>
          ...
          {gameState === 'success' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-green-400">
                ...
                <h3 className="text-xl font-bold text-white">Healthy Emotional Choice!</h3>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Always choose healthy emotional health practices!</p>
              </div>
            </div>
          )}
        </div>
