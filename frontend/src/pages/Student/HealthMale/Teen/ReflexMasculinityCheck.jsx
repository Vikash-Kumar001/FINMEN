...
const ReflexMasculinityCheck = () => {
  ...
  const scenarios = [
    { action: "Kind & Strong", emoji: "💪", isCorrect: true },
    { action: "Tough Only", emoji: "❌", isCorrect: false },
    { action: "Show Emotions", emoji: "😢", isCorrect: true },
    { action: "Hide Feelings", emoji: "🤐", isCorrect: false },
    { action: "Help Others", emoji: "🤝", isCorrect: true },
    { action: "Be Selfish", emoji: "😒", isCorrect: false },
    { action: "Respect All", emoji: "🙏", isCorrect: true },
    { action: "Dominate", emoji: "👑", isCorrect: false }
  ];
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Masculinity scenario loading...'}
              {gameState === 'showing' && 'Watch for the masculinity signal...'}
              {gameState === 'ready' && 'QUICK! Choose the healthy masculinity trait!'}
              {gameState === 'success' && `Healthy choice! (${reactionTime}ms)`}
              {gameState === 'fail' && 'Too slow! Always choose healthy masculinity!'}
            </p>
          </div>
          ...
          {gameState === 'success' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-green-400">
                ...
                <h3 className="text-xl font-bold text-white">Healthy Masculinity!</h3>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Always choose healthy masculinity traits!</p>
              </div>
            </div>
          )}
        </div>
