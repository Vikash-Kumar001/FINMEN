...
const ReflexTeenAlert = () => {
  ...
  const scenarios = [
    ...
    { action: "Daily Routine", emoji: "📅", isCorrect: true },
    { action: "Procrastination", emoji: "⏳", isCorrect: false },
    { action: "Time Management", emoji: "⏰", isCorrect: true },
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Teen habit scenario loading...'}
              {gameState === 'showing' && 'Watch for the habit signal...'}
              {gameState === 'ready' && 'QUICK! Choose the healthy habit practice!'}
              {gameState === 'success' && `Habit choice! (${reactionTime}ms)`}
          ...
          {gameState === 'success' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-green-400">
                ...
                <h3 className="text-xl font-bold text-white">Healthy Habit Choice!</h3>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Always choose healthy habit practices!</p>
              </div>
            </div>
          )}
        </div>
