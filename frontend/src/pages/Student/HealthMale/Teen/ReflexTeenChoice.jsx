...
const ReflexTeenChoice = () => {
  ...
  const scenarios = [
    { action: "Sports", emoji: "⚽", isCorrect: true },
    { action: "Alcohol", emoji: "❌", isCorrect: false },
    { action: "Study", emoji: "📚", isCorrect: true },
    { action: "Drugs", emoji: "💊", isCorrect: false },
    { action: "Exercise", emoji: "🏃", isCorrect: true },
    { action: "Smoking", emoji: "🚬", isCorrect: false },
    { action: "Healthy Food", emoji: "🥗", isCorrect: true },
    { action: "Energy Drinks", emoji: "🥤", isCorrect: false }
  ];
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 text-lg">
              {gameState === 'waiting' && 'Teen choice scenario loading...'}
              {gameState === 'showing' && 'Watch for the choice signal...'}
              {gameState === 'ready' && 'QUICK! Choose the healthy teen activity!'}
              {gameState === 'success' && `Smart choice! (${reactionTime}ms)`}
              {gameState === 'fail' && 'Too slow! Always choose healthy activities!'}
            </p>
          </div>
          ...
          {gameState === 'success' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-green-400">
                ...
                <h3 className="text-xl font-bold text-white">Healthy Teen Choice!</h3>
          ...
          {gameState === 'fail' && currentScenario && (
            <div className="text-center space-y-4">
              <div className="text-red-400">
                ...
                <p className="text-white/90">Remember: Always choose healthy activities!</p>
              </div>
            </div>
          )}
        </div>
