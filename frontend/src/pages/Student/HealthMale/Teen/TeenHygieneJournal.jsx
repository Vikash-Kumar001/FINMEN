            ...
            <div className="space-y-8">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                    <div className="text-center mb-6">
                        ...
                        <h3 className="text-2xl font-bold text-white mb-2">My Hygiene Journal</h3>
                        <p className="text-white/90 mb-4">
                            Write about your self-care habits.
                        </p>
                    </div>
                        ...
                        <div className="text-center space-y-4 mt-8">
                            <div className="text-green-400">
                                ...
                                <p className="text-white/90 mb-4 text-lg">
                                    Taking care of yourself is important. Well done!
                                </p>
                                <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-full p-4 inline-block mb-4">
                                    <div className="text-white font-bold text-xl">SELF-CARE PRO</div>
                                </div>
                            </div>
                        </div>
                    )}
