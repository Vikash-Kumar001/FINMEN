...
const BadgeTeamKid = () => {
  ...
  // ✅ 5 Teamwork Acts (Yes/No)
  const teamworkActs = [
    { id: 1, text: "Helped a teammate score a goal", emoji: "⚽" },
    { id: 2, text: "Shared materials during class activity", emoji: "📚" },
    { id: 3, text: "Encouraged a friend who was struggling", emoji: "💪" },
    { id: 4, text: "Took turns in a group game", emoji: "🎲" },
    { id: 5, text: "Helped organize a team task together", emoji: "🏀" },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
          <h2 className="text-2xl font-bold text-white mb-6 text-center">
            Team Kid Challenge: Work Together 🤝
          </h2>

          <p className="text-white/80 mb-6 text-center">
            Answer honestly — do you show teamwork in your daily actions?
          </p>
            ...
            <div className="mt-8 text-center">
              {isWinner ? (
                <div className="text-green-400 text-xl font-bold">
                  🤝 Team Spirit! You are a true Team Kid!
                </div>
              ) : (
                <div className="text-red-400 text-lg font-semibold">
                  ⚠️ Some answers show less teamwork — try again to improve!
                </div>
              )}
            </div>
          )}
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm z-50">
          <div className="bg-gradient-to-r from-green-400 via-teal-400 to-cyan-400 text-white rounded-2xl p-10 text-center shadow-2xl animate-bounce">
            ...
            <p className="text-lg mb-6">
              You’ve earned the <strong>Team Kid Badge!</strong> 🤝
            </p>
            <button
