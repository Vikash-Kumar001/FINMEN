            ...
            {selectedChoiceData.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-6">
                  <p className="text-white text-center">
                    Perfect! Lying is never okay, even about small things like homework. Honesty means telling 
                    the truth always. If you didn't do your homework, it's better to admit it and face the 
                    consequences than to lie!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Lying is never okay, even about small things. Being honest builds trust and respect. 
