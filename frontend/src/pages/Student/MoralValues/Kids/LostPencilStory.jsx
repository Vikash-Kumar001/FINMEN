            ...
            {selectedChoiceData.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    ...
                    Even if we find something, it doesn't belong to us. Honesty builds trust!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    {selectedChoice === 1
                      ? "Even if we find something, it belongs to someone else. The right thing is to return it!"
                      : "Giving it to your friend doesn't help the real owner. Always try to return lost items!"}
                  </p>
                </div>
                <button
