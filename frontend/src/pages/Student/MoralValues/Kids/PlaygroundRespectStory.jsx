        ...
        {!showFeedback ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {selectedChoiceData.isCorrect ? "💖 Inclusive Friend!" : "Think Again..."}
            </h2>
            ...
            {selectedChoiceData.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Perfect! Including everyone, regardless of age or size, shows respect and kindness. 
                    Everyone deserves to play and have fun. You made someone's day!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    {selectedChoice === 1
                      ? "Everyone can play, no matter their size! Being inclusive shows respect and makes games more fun!"
                      : "Ignoring them hurts their feelings. Always include others and make them feel welcome!"}
                  </p>
                </div>
                <button
