...
const PuzzleRespectMatch = () => {
  ...
  const correctPairs = [
    { start: 1, end: 1 },  // Listen = Respect
    { start: 2, end: 2 }   // Mock = Hurt
  ];
            ...
            {coins > 0 ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Excellent! Listening shows respect, and mocking hurts people. Always choose to 
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Remember: Listen → Respect, and Mock → Hurt. Let's try again!
                  </p>
                </div>
                <button
