...
const ReflexBraveScared = () => {
  ...
  const actions = [
    { id: 1, text: "Speak up about a mistake", emoji: "🗣️", isBrave: true },
    { id: 2, text: "Run away from a challenge", emoji: "🏃‍♂️", isBrave: false },
    { id: 3, text: "Help a friend in need", emoji: "🤝", isBrave: true },
    { id: 4, text: "Avoid trying something new", emoji: "🙈", isBrave: false },
    { id: 5, text: "Stand up to a bully politely", emoji: "✊", isBrave: true }
  ];
        ...
        {!gameStarted ? (
          ...
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="text-white font-bold text-2xl">Brave 💪</div>
                </button>
                <button
                ...
                >
                  <div className="text-white font-bold text-2xl">Scared 😨</div>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4">
              {accuracy >= 70 ? "🎉 Brave Hero!" : "💪 Keep Practicing!"}
            </h2>
            ...
            <div className="bg-blue-500/20 rounded-lg p-4 mb-4">
              <p className="text-white/90 text-sm">
                💡 Brave actions include speaking truth, helping others, and facing challenges. Cowardly actions avoid responsibility or fear.
              </p>
            </div>
