...
const ReflexChoices = () => {
  ...
  const actions = [
    { id: 1, text: "Return lost pencil", emoji: "✏️", isRight: true },
    { id: 2, text: "Take candy without asking", emoji: "🍬", isRight: false },
    { id: 3, text: "Help friend pick up books", emoji: "📚", isRight: true },
    { id: 4, text: "Push someone in line", emoji: "😡", isRight: false },
    { id: 5, text: "Say thank you to teacher", emoji: "🙏", isRight: true }
  ];
  ...
  const handleChoice = (isRight) => {
    const isCorrect = currentActionData.isRight === isRight;
  ...
  const handleNext = () => {
    navigate("/student/moral-values/kids/puzzle-dilemmas"); // Replace with your next path
  };
      ...
      <div className="space-y-8">
        {!gameStarted ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">Tap the Right Action!</h2>
            <p className="text-white/80 mb-6">Tap "Right" for good actions, "Wrong" for bad ones!</p>
            <button
          ...
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
              ...
              <h2 className="text-white text-3xl font-bold text-center mb-8">{currentActionData.text}</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="text-white font-bold text-2xl">Wrong ❌</div>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4">
              {accuracy >= 70 ? "🎉 Reflex Master!" : "💪 Keep Practicing!"}
            </h2>
            ...
            <div className="bg-blue-500/20 rounded-lg p-4 mb-4">
              <p className="text-white/90 text-sm">
                💡 Tap quickly and wisely! Right actions help others and show good morals.
              </p>
            </div>
