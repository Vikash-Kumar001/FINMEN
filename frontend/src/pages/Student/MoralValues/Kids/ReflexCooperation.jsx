...
const ReflexCooperation = () => {
  ...
  const prompts = [
    { id: 1, text: "Help your teammate pick up the ball", emoji: "🤝", isCooperative: true },
    { id: 2, text: "Take all the markers for yourself", emoji: "😏", isCooperative: false },
    { id: 3, text: "Assist a friend with their homework", emoji: "📚", isCooperative: true },
    { id: 4, text: "Grab the last cookie before others", emoji: "🍪", isCooperative: false },
    { id: 5, text: "Help organize team equipment", emoji: "🏀", isCooperative: true }
  ];
        ...
        {!gameStarted ? (
          ...
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="text-white font-bold text-2xl">Help Team 🤝</div>
                </button>
                <button
                ...
                >
                  <div className="text-white font-bold text-2xl">Selfish 😏</div>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4">
              {accuracy >= 70 ? "🎉 Cooperation Star!" : "💪 Keep Practicing!"}
            </h2>
            ...
            <div className="bg-blue-500/20 rounded-lg p-4 mb-4">
              <p className="text-white/90 text-sm">
                💡 Helping your team and being cooperative is key to success! Always choose to help others.
              </p>
            </div>
