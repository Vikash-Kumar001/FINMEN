...
const ReflexEqualShare = () => {
  ...
  const questions = [
    ...
    },
    {
      id: 2,
      question: "Which shows equal sharing?",
      correctAnswer: "Split chocolate bar evenly",
      options: [
        { text: "Take all yourself", isCorrect: false, emoji: "😏" },
        { text: "Split chocolate bar evenly", isCorrect: true, emoji: "🍫" },
        { text: "Keep most for yourself", isCorrect: false, emoji: "😄" },
    ...
    },
    {
      id: 3,
      question: "Which shows equal sharing?",
      correctAnswer: "Share 3 apples equally",
      options: [
        { text: "Take all yourself", isCorrect: false, emoji: "😏" },
    ...
    },
    {
      id: 4,
      question: "Which shows equal sharing?",
      correctAnswer: "Divide snacks fairly",
      options: [
        { text: "Keep most", isCorrect: false, emoji: "😄" },
        { text: "Give nothing", isCorrect: false, emoji: "🚫" },
        { text: "Take all", isCorrect: false, emoji: "😏" },
        { text: "Divide snacks fairly", isCorrect: true, emoji: "🍪" }
      ]
    },
    {
      id: 5,
      question: "Which shows equal sharing?",
      correctAnswer: "Split equally with friend",
      options: [
        { text: "Split equally with friend", isCorrect: true, emoji: "🤝" },
        { text: "Take all yourself", isCorrect: false, emoji: "😏" },
        { text: "Keep most", isCorrect: false, emoji: "😄" },
        { text: "Give nothing", isCorrect: false, emoji: "🚫" }
      ]
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Test your sharing reflexes!` : "Test your sharing reflexes!"}
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about equal sharing!<br />
