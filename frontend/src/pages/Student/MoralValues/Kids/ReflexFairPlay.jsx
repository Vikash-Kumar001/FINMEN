...
const ReflexFairPlay = () => {
  ...
  const actions = [
    { id: 1, text: "Wait your turn", emoji: "⏳", correctAction: true },
    { id: 2, text: "Jump the line", emoji: "🏃‍♂️", correctAction: false },
    { id: 3, text: "Wait patiently", emoji: "🕰️", correctAction: true },
    { id: 4, text: "Push others aside", emoji: "🤦", correctAction: false },
    { id: 5, text: "Take turns fairly", emoji: "🤝", correctAction: true },
  ];
  ...
  const handleChoice = (isWaitTurn) => {
    const isCorrect = currentActionData.correctAction === isWaitTurn;
    if (isCorrect) {
  ...
  const handleNext = () => {
    navigate("/student/moral-values/kids/puzzle-of-fairness");
  };
      ...
      <div className="space-y-8">
        {!gameStarted ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">Tap "Wait Turn" or "Jump Line"!</h2>
            <p className="text-white/80 mb-6">React quickly! Choose fair actions to earn coins.</p>
            <button
          ...
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="text-white font-bold text-2xl">Wait Turn ⏳</div>
                </button>
                <button
                ...
                >
                  <div className="text-white font-bold text-2xl">Jump Line 🏃‍♂️</div>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4">
              {accuracy >= 70 ? "🎉 Fair Play Champion!" : "💪 Keep Practicing!"}
            </h2>
            ...
            <div className="bg-blue-500/20 rounded-lg p-4 mb-4">
              <p className="text-white/90 text-sm">
                💡 Always wait your turn and play fairly. Respect and fairness matter!
              </p>
            </div>
