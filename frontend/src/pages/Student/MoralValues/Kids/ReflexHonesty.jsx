...
const ReflexHonesty = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "Which word represents truth?",
      correctAnswer: "Truth",
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Trick", isCorrect: false, emoji: "😈" },
        { text: "Fraud", isCorrect: false, emoji: "⚠️" },
        { text: "Genuine", isCorrect: true, emoji: "🌟" }
      ]
    },
    {
      id: 5,
      ...
      options: [
        { text: "Sincere", isCorrect: true, emoji: "❤️" },
        { text: "Lie", isCorrect: false, emoji: "❌" },
        { text: "False", isCorrect: false, emoji: "🚫" },
        { text: "Deceive", isCorrect: false, emoji: "👎" }
      ]
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about truth and honesty!<br />
