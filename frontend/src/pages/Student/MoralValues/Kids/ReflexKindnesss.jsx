...
const ReflexKindnesss = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        { text: "Mock", isCorrect: false, emoji: "😡" },
        { text: "Ignore", isCorrect: false, emoji: "🙄" },
        { text: "Care", isCorrect: true, emoji: "💖" },
        { text: "Tease", isCorrect: false, emoji: "😏" }
      ]
    },
    {
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Test your kindness reflexes!` : "Test your kindness reflexes!"}
