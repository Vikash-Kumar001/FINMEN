...
const ReflexRespect = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "Which word shows respect?",
      correctAnswer: "Sorry",
      options: [
        { text: "Sorry", isCorrect: true, emoji: "🙏" },
        { text: "Shut up", isCorrect: false, emoji: "😠" },
        { text: "Hate", isCorrect: false, emoji: "💔" },
        { text: "Dumb", isCorrect: false, emoji: "👎" }
      ]
    },
    {
      id: 2,
      ...
      options: [
        { text: "Loser", isCorrect: false, emoji: "😢" },
        { text: "Thanks", isCorrect: true, emoji: "💖" },
        { text: "Stupid", isCorrect: false, emoji: "😡" },
    ...
    },
    {
      ...
      options: [
        { text: "Ugly", isCorrect: false, emoji: "😢" },
        { text: "Shut up", isCorrect: false, emoji: "😠" },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Loser", isCorrect: false, emoji: "😢" },
        { text: "Stupid", isCorrect: false, emoji: "😡" },
        { text: "Excuse me", isCorrect: true, emoji: "🙋" }
      ]
    },
    {
      id: 5,
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about respectful words!<br />
