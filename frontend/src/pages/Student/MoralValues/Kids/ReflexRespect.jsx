...
const ReflexRespect = () => {
  ...
  const words = [
    { id: 1, text: "Sorry", emoji: "🙏", isKind: true },
    { id: 2, text: "Shut up", emoji: "😠", isKind: false },
    { id: 3, text: "Thanks", emoji: "💖", isKind: true },
    { id: 4, text: "Hate", emoji: "💔", isKind: false },
    { id: 5, text: "Please", emoji: "✨", isKind: true },
    { id: 6, text: "Dumb", emoji: "👎", isKind: false },
    { id: 7, text: "Excuse me", emoji: "🙋", isKind: true },
    { id: 8, text: "Loser", emoji: "😢", isKind: false },
    { id: 9, text: "Thank you", emoji: "🙏", isKind: true },
    { id: 10, text: "Stupid", emoji: "😡", isKind: false },
    { id: 11, text: "You're welcome", emoji: "😊", isKind: true },
    { id: 12, text: "Go away", emoji: "👋", isKind: false },
    { id: 13, text: "May I", emoji: "🤲", isKind: true },
    { id: 14, text: "Ugly", emoji: "😢", isKind: false },
    { id: 15, text: "Bless you", emoji: "💫", isKind: true }
  ];
  ...
  const handleNext = () => {
    navigate("/student/moral-values/kids/puzzle-respect-match");
  };
  ...
  return (
    <GameShell
      ...
      score={coins}
      subtitle={gameStarted ? `Word ${currentWord + 1} of ${words.length}` : "Quick Word Game"}
      onNext={handleNext}
      ...
      <div className="space-y-8">
        {!gameStarted ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">Tap Kind or Rude!</h2>
            <p className="text-white/80 mb-6">Tap "Kind" for polite words, "Rude" for impolite words!</p>
            <button
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4">
              {accuracy >= 70 ? "🎉 Polite Expert!" : "💪 Keep Learning!"}
            </h2>
            ...
            <div className="bg-blue-500/20 rounded-lg p-4 mb-4">
              <p className="text-white/90 text-sm">
                💡 Use polite words like "Please," "Thank you," "Sorry," and "Excuse me" to show respect!
              </p>
            </div>
