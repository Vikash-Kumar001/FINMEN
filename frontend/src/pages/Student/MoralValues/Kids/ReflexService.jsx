...
const ReflexService = () => {
  ...
  const actions = [
    { id: 1, text: "Donate", emoji: "🎁", shouldDonate: true },
    { id: 2, text: "Waste", emoji: "🗑️", shouldDonate: false },
    { id: 3, text: "Donate", emoji: "🧸", shouldDonate: true },
    { id: 4, text: "Waste", emoji: "🍫", shouldDonate: false },
    { id: 5, text: "Donate", emoji: "🥫", shouldDonate: true }
  ];
  ...
  const handleChoice = (isDonate) => {
    const isCorrect = currentActionData.shouldDonate === isDonate;
  ...
  const handleNext = () => {
    navigate("/student/moral-values/kids/puzzle-service-match");
  };
      ...
      <div className="space-y-8">
        {!gameStarted ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">Tap Donate or Waste!</h2>
            <p className="text-white/80 mb-6">Tap "Donate" for giving actions, "Waste" for wrong actions!</p>
            <button
          ...
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="text-white font-bold text-2xl">Donate 💚</div>
                </button>
                <button
                ...
                >
                  <div className="text-white font-bold text-2xl">Waste 💔</div>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4">
              {accuracy >= 70 ? "🎉 Service Hero!" : "💪 Keep Practicing!"}
            </h2>
            ...
            <div className="bg-blue-500/20 rounded-lg p-4 mb-4">
              <p className="text-white/90 text-sm">
                💡 Always choose to donate, help, and serve others. Small actions make a big difference!
              </p>
            </div>
