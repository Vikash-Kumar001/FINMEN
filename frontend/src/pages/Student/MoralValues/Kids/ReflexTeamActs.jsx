...
const ReflexTeamActs = () => {
  ...
  const words = [
    { id: 1, text: "Share Ideas", emoji: "💡", isPositive: true },
    { id: 2, text: "Interrupt", emoji: "✋", isPositive: false },
    { id: 3, text: "Encourage Teammates", emoji: "🙌", isPositive: true },
    { id: 4, text: "Take Credit Alone", emoji: "😏", isPositive: false },
    { id: 5, text: "Listen Carefully", emoji: "👂", isPositive: true }
  ];
  ...
  }, [timeLeft, gameStarted, showResult, currentWord, autoAdvance, score]);

  const currentWordData = words[currentWord];

  const handleChoice = (isPositive) => {
    const isCorrect = currentWordData.isPositive === isPositive;
  ...
  const handleNext = () => {
    navigate("/student/moral-values/kids/puzzle-team-roles"); // Next game path
  };
      ...
      <div className="space-y-8">
        {!gameStarted ? (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">Tap Positive or Negative!</h2>
            <p className="text-white/80 mb-6">
              Tap "Positive" for helpful teamwork actions, "Negative" for harmful actions!
            </p>
            <button
          ...
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="text-white font-bold text-2xl">Negative ❌</div>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4">
              {accuracy >= 70 ? "🎉 Teamwork Star!" : "💪 Keep Practicing!"}
            </h2>
            ...
            <div className="bg-blue-500/20 rounded-lg p-4 mb-4">
              <p className="text-white/90 text-sm">
                💡 Positive actions like "Share Ideas," "Encourage Teammates," and "Listen Carefully" build great teamwork!
              </p>
            </div>
