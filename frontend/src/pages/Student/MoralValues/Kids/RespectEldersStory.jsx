...
const RespectEldersStory = () => {
  ...
  const handleNext = () => {
    navigate("/student/moral-values/kids/polite-words-quiz");
  };
        ...
        {!showFeedback ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {selectedChoiceData.isCorrect ? "🌟 Respectful Kid!" : "Think Again..."}
            </h2>
            ...
            {selectedChoiceData.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Perfect! Helping our elders right away shows respect and care. They have done so much 
                    for us, and helping them when they need us is important!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    {selectedChoice === 1
                      ? "Games can wait! When elders need help, we should help them right away. Show respect!"
                      : "Saying 'later' might mean never. When someone needs help, help them immediately!"}
                  </p>
                </div>
                <button
