        ...
        {!showFeedback ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {selectedChoiceData.isCorrect ? "🌟 Respectful Student!" : "Think Again..."}
            </h2>
            ...
            {selectedChoiceData.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Excellent! Standing up and greeting your teacher shows respect. Teachers work hard 
                    to help us learn, and greeting them is a simple way to show we appreciate them!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    {selectedChoice === 1
                      ? "Continuing to talk shows disrespect. We should greet our teacher when they enter!"
                      : "Staying quiet isn't rude, but greeting the teacher actively shows respect and appreciation!"}
                  </p>
                </div>
                <button
