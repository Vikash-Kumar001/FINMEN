...
const DebateLyingForFriend = () => {
  ...
  const topic = "Is lying okay to protect a friend?";
  const positions = [
            ...
            {selectedPos.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Excellent position! Truth matters even in friendship. Lying for a friend enables 
                    their mistakes, damages your credibility, and creates a pattern of dishonesty. Real 
                    friendship means helping them face consequences honestly, not covering up wrongdoing. 
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Loyalty doesn't mean lying. True friends help each other grow through honesty, not 
                    protect each other through deception. Lying damages both your integrity and theirs!
                  </p>
                </div>
                <p className="text-white/70 text-center">Reconsider with integrity in mind!</p>
              </>
            )}
          </div>
        )}
