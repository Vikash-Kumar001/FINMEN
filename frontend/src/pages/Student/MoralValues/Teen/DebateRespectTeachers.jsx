...
const DebateRespectTeachers = () => {
  ...
  const topic = "Should students argue rudely with teachers?";
  const positions = [
    { id: 1, position: "Yes - students have rights too", emoji: "💪", isCorrect: false },
    { id: 2, position: "No - disagree respectfully, not rudely", emoji: "🙏", isCorrect: true }
  ];
  ...
  return (
    <GameShell
      ...
      subtitle="Respectful Disagreement"
      onNext={handleNext}
        ...
        {!showFeedback ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 text-center">
              {selectedPos.isCorrect ? "🏆 Respectful Communicator!" : "Reconsider..."}
            </h2>
            ...
            {selectedPos.isCorrect ? (
              <>
                <div className="bg-green-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Excellent! You CAN disagree with teachers, but rudeness is never acceptable. Use 
                    respectful language, listen to their perspective, and express your view calmly. 
                    Respect and critical thinking aren't opposites - they work together in healthy dialogue!
                  </p>
                </div>
              ...
              <>
                <div className="bg-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-white text-center">
                    Rudeness destroys communication and shows disrespect. You can question and disagree, 
                    but always do so politely and respectfully. Good communication builds understanding!
                  </p>
                </div>
                <p className="text-white/70 text-center">Try again with a respectful approach!</p>
              </>
            )}
          </div>
        )}
