...
const ReflexCalmAction = () => {
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Stay calm or shout back?` : "Stay calm or shout back?"}
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Tap "Take Deep Breath" for calm actions, "Shout Back" for angry ones!<br />
