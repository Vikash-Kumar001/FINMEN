...
const JournalGreenHabits = () => {
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Journal of Green Habits game completed! Score: ${score}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on your green habits!` : "Journal Complete!"}
      ...
      {!showResult ? (
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-green-400 font-semibold">
            You earned {coins} coins! Keep practicing green habits! 🌱
          </p>
        </div>
      )}
    </GameShell>
