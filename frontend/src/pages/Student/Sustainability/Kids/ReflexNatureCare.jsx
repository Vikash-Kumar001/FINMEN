...
const words = [
  { word: "PROTECT NATURE", isCorrect: true },
  { word: "HARM NATURE", isCorrect: false },
  { word: "PLANT TREES", isCorrect: true },
  { word: "CUT TREES", isCorrect: false },
  { word: "CARE FOR ANIMALS", isCorrect: true },
  { word: "HURT ANIMALS", isCorrect: false }
];
...
const ReflexNatureCare = () => {
  ...
  const handleNext = () => {
    navigate("/student/sustainability/kids/badge-planet-protector-kid");
  };
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "ready" ? "Tap quickly for 'Protect Nature' actions, avoid 'Harm Nature'!" : gameState === "playing" ? `Round ${currentRound} of ${TOTAL_ROUNDS} - Time: ${timeLeft}s` : "Game Complete!"}
      ...
      {gameState === "ready" && (
        <div className="text-center space-y-6">
          ...
          <p className="text-gray-300 mb-6">
            Tap when you see PROTECT NATURE actions (like PROTECT NATURE, PLANT TREES, CARE FOR ANIMALS)
            <br />
            Don't tap for HARM NATURE actions (like HARM NATURE, CUT TREES, HURT ANIMALS)
          </p>
          <button
            onClick={startGame}
      ...
      {gameState === "playing" && currentWord && (
        <div className="text-center space-y-6">
          <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-2xl p-8 border border-green-400/30">
            ...
            <p className="text-gray-300 mb-6">
              {currentRound % 2 === 1 ? "Tap if this protects nature!" : "Don't tap - this harms nature!"}
            </p>
            <button
              onClick={handleTap}
      ...
      {gameState === "finished" && (
        <div className="text-center space-y-6">
          ...
          <p className="text-green-400 font-semibold">
            You earned {coins} coins! Great nature-protecting reflexes! 🌳
          </p>
        </div>
      )}
    </GameShell>
