...
const ReflexConsciousConsumer = () => {
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Reflex Conscious Consumer game completed! Score: ${score}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const questions = [
    {
      id: 1,
      text: "Buying locally-made products",
      isSustainable: true,
      emoji: "🏪"
    },
    {
      id: 2,
      text: "Choosing products with minimal packaging",
      isSustainable: true,
      emoji: "📦"
    },
    {
      id: 3,
      text: "Buying fast fashion items",
      isSustainable: false,
      emoji: "👕"
    },
       {
      id: 4,
      text: "Purchasing items made from recycled materials",
      isSustainable: true,
      emoji: "♻️"
    },
    {
      id: 5,
      text: "Buying single-use items frequently",
      isSustainable: false,
      emoji: "🛍️"
    }
  ];
  ...
  const handleAnswer = (isCorrect) => {
    ...
    if (isCorrect) {
      ...
      setFeedbackText("Correct! Sustainable choice!");
      setFeedbackType("success");
    } else {
      setFeedbackText("Not sustainable, but that's okay! Keep learning.");
            ...
            <div className="space-y-6">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    onClick={() => handleAnswer(currentQuestionData?.isSustainable === true)}
                  ...
                  >
                    ...
                    <h4 className="font-bold text-base">Sustainable Choice</h4>
                  </button>
                  
                  <button
                    onClick={() => handleAnswer(currentQuestionData?.isSustainable === false)}
                  ...
                  >
                    <div className="text-2xl mb-2">❌</div>
                    <h4 className="font-bold text-base">Not Sustainable</h4>
                  </button>
                </div>
