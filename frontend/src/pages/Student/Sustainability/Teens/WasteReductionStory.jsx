...
const WasteReductionStory = () => {
  ...
  useEffect(() => {
    if (showResult) {
      console.log(`🎮 Waste Reduction Story game completed! Score: ${score}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const questions = [
    {
      ...
      options: [
        { id: "plan", text: "Create a waste reduction plan", emoji: "📋", description: "Strategic approach", isCorrect: true },
        { id: "ignore", text: "Ignore the issue", emoji: "😐", description: "Action is needed", isCorrect: false },
        { id: "wait", text: "Wait for others to act", emoji: "⏳", description: "Take initiative", isCorrect: false }
      ]
    },
    {
      id: 2,
      ...
      options: [
        { id: "disposable", text: "Use more disposable items", emoji: "🥤", description: "Increases waste", isCorrect: false },
        { id: "reusable", text: "Use reusable containers", emoji: "🍱", description: "Reduces single-use waste", isCorrect: true },
    ...
    },
    {
      ...
      options: [
        { id: "recycle", text: "Only recycle", emoji: "♻️", description: "Reducing is better", isCorrect: false },
        { id: "landfill", text: "Use landfills", emoji: "🗑️", description: "Not sustainable", isCorrect: false },
        { id: "reduce", text: "Reduce consumption", emoji: "📉", description: "Prevent waste at source", isCorrect: true }
      ]
    }
  ];
