...
const ContributionJournal = () => {
  ...
  const questions = [
    {
      id: 1,
      prompt: "Service I did today?"
    },
    {
      id: 2,
      prompt: "Helped family how?"
    },
    {
      id: 3,
      prompt: "Community help?"
    },
    {
      id: 4,
      prompt: "Volunteered what?"
    },
    {
      id: 5,
      prompt: "Kind act done?"
    }
  ];
        ...
        {!showResult ? (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4">
              {finalScore >= 3 ? "🎉 Contributor!" : "💪 Contribute More!"}
            </h2>
            <p className="text-white/90 text-xl mb-4">
              You journaled {finalScore} contributions!
            </p>
