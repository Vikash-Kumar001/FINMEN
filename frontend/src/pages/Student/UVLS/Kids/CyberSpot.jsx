            ...
            {finalScore >= 3 ? (
              <div>
                ...
                <p className="text-white/80">
                  Lesson: Recognizing cyberbullying helps you stay safe online and protect others!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/80 text-sm">
                  Tip: Cyberbullying includes mean messages, spreading rumors, threats, and excluding others online. Always report it!
                </p>
              </div>
            )}
          </div>
