...
const DecisionPoster = () => {
  ...
  const questions = [
    {
      id: 1,
      steps: ["Stop", "Think", "Choose"]
    },
    {
      id: 2,
      steps: ["Look", "Listen", "Decide"]
    },
    {
      id: 3,
      steps: ["Ask", "Weigh", "Pick"]
    },
    {
      id: 4,
      steps: ["Pause", "Plan", "Act"]
    },
    {
      id: 5,
      steps: ["See", "Consider", "Select"]
    }
  ];
  ...
  const handlePoster = () => {
    ...
    const isComplete = posterSteps.length === 3; // Assume correct if arranged
    if (isComplete) {
        ...
        {!showResult ? (
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <p className="text-white text-lg mb-4">Arrange decision steps!</p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-4">
              {finalScore >= 3 ? "🎉 Decision Artist!" : "💪 Arrange More!"}
            </h2>
