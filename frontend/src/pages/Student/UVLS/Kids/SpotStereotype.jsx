            ...
            {score >= 3 ? (
              <div>
                ...
                <p className="text-white/80">
                  Lesson: Recognizing stereotypes helps us treat everyone fairly and with respect. Challenge unfair assumptions!
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="text-white/80 text-sm">
                  Tip: Stereotypes are unfair assumptions about groups of people based on gender, age, or background. Learn to recognize and challenge them!
                </p>
              </div>
            )}
          </div>
