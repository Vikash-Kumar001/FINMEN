...
const AllyJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "Plan a concrete ally action to support gender equality."',
      minLength: 10,
    },
    {
      question: 'Write: "What are the specific steps you will take to implement this action?"',
      minLength: 10,
    },
    {
      question: 'Write: "Who can support you in this ally action?"',
      minLength: 10,
    },
    {
      question: 'Write: "What challenges might you face and how will you overcome them?"',
      minLength: 10,
    },
    {
      question: 'Write: "When will you complete this ally action and how will you measure its success?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      title="Ally Journal"
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Plan your ally action!` : "Journal Complete!"}
