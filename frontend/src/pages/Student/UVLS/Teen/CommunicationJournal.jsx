...
const CommunicationJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "Set a communication goal. What do you want to improve?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is your first milestone toward this goal?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is your second milestone?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is your third milestone?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is your final milestone to achieve your goal?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Set your communication goals!` : "Journal Complete!"}
