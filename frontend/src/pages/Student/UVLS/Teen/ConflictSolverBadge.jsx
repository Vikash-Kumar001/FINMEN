...
const ConflictSolverBadge = () => {
  ...
  return (
    <GameShell
      ...
      subtitle="Demonstrate 5 resolutions"
      onNext={handleNext}
        ...
        {!showResult ? (
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <p className="text-white text-xl mb-6">Mark resolutions complete:</p>
              ...
              <div className="space-y-3">
                {tasks.map((task, index) => (
                  ...
                  >
                    {tasks[index] ? '✅' : ''} Multi-step resolution {index + 1}
                  </button>
                ))}
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-white/90 text-xl mb-4">
              You demonstrated 5 resolutions.
            </p>
            <p className="text-white/70 text-sm">
              Teacher Note: Present case studies at school assembly.
            </p>
          </div>
        )}
      </div>
