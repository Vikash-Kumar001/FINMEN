...
import InclusionJournal from "../Kids/InclusionJournal";
...
const CorrectingBiasRoleplay = () => {
  ...
  const handleConfirm = () => {
    ...
    if (currentScenario < scenarios.length - 1) {
      ...
      const goodCount = newResponses.filter(r => r.isGood).length;
      if (goodCount >= 2) {
        setCoins(3); // +3 Coins for respectful correction (minimum for progress)
      }
      setTimeout(() => {
        setShowResult(true);
      }, 1500);
