...
const EmergencyStepsQuiz = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Emergency: Fire. What's the correct first step?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 2,
      text: "Emergency: Severe bleeding. What's the correct first step?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 3,
      text: "Emergency: Someone is choking. What's the correct first step?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 4,
      text: "Emergency: Heart attack symptoms. What's the correct first step?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 5,
      text: "Emergency: Earthquake. What's the correct first step?",
      options: [
        { 
          id: "a", 
