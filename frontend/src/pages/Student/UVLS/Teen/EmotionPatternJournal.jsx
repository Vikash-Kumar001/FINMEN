...
const EmotionPatternJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "Track your mood for day 1. How did you feel today?"',
      minLength: 10,
    },
    {
      question: 'Write: "Track your mood for day 2. What emotions did you experience?"',
      minLength: 10,
    },
    {
      question: 'Write: "Track your mood for day 3. What influenced your emotions today?"',
      minLength: 10,
    },
    {
      question: 'Write: "Track your mood for day 4. How did you manage your emotions?"',
      minLength: 10,
    },
    {
      question: 'Write: "Reflect on patterns over the week. What patterns do you notice in your emotions?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Track your emotions!` : "Journal Complete!"}
