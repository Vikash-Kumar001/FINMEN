...
const EqualityDebate = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Topic: Policy changes equality. What's the strongest argument supporting policy changes?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 2,
      text: "Topic: Culture influences more than policy. What's the strongest argument?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 3,
      text: "What makes a debate argument strong?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 4,
      text: "How should you respond to opposing arguments in a debate?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 5,
      text: "What's the best way to conclude a debate argument?",
      options: [
        { 
          id: "a", 
