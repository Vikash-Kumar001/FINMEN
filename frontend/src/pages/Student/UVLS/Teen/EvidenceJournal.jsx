...
const EvidenceJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "Describe a recent personal decision you made. What was the decision?"',
      minLength: 10,
    },
    {
      question: 'Write: "List the evidence or information you used to make this decision."',
      minLength: 10,
    },
    {
      question: 'Write: "What sources did you get this evidence from?"',
      minLength: 10,
    },
    {
      question: 'Write: "Were there any gaps in your evidence? What information was missing?"',
      minLength: 10,
    },
    {
      question: 'Write: "How will you improve your evidence-gathering for future decisions?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Record evidence!` : "Journal Complete!"}
