...
const HabitChangeJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "What habit do you want to change?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is step 1 of your plan to change this habit?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is step 2 of your plan?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is step 3 of your plan?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is step 4 of your plan?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Plan habit change!` : "Journal Complete!"}
