...
const InclusionJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "Describe a time when you challenged exclusion or stood up for someone being left out."',
      minLength: 10,
    },
    {
      question: 'Write: "What was the outcome of your action? How did it make you feel?"',
      minLength: 10,
    },
    {
      question: 'Write: "Think of another situation where you could promote inclusion. What would you do?"',
      minLength: 10,
    },
    {
      question: 'Write: "How can you be an ally to those who face exclusion regularly?"',
      minLength: 10,
    },
    {
      question: 'Write: "What commitments will you make to promote inclusion in your community?"',
      minLength: 10,
    },
  ];
