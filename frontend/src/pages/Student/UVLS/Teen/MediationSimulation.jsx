...
const MediationSimulation = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Dispute: Classroom seating conflict. What's the best mediation approach?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 2,
      text: "Dispute: Group project roles. What's the best mediation approach?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 3,
      text: "Dispute: Playground game rules. What's the best mediation approach?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 4,
      text: "Dispute: Lunch table seating. What's the best mediation approach?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 5,
      text: "Dispute: Club budget allocation. What's the best mediation approach?",
      options: [
        { 
          id: "a", 
