...
const NegotiationJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "Describe a negotiation you led or participated in."',
      minLength: 10,
    },
    {
      question: 'Write: "What lesson did you learn from this negotiation?"',
      minLength: 10,
    },
    {
      question: 'Write: "What would you do differently next time?"',
      minLength: 10,
    },
    {
      question: 'Write: "What negotiation tactics worked well?"',
      minLength: 10,
    },
    {
      question: 'Write: "How will you apply these lessons in future negotiations?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Reflect on negotiations!` : "Journal Complete!"}
