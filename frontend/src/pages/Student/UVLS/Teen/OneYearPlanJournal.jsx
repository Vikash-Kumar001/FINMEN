...
const OneYearPlanJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "What is your one-year goal?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is milestone 1 (3 months) toward this goal?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is milestone 2 (6 months) toward this goal?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is milestone 3 (9 months) toward this goal?"',
      minLength: 10,
    },
    {
      question: 'Write: "What is milestone 4 (12 months) - your final goal achievement?"',
      minLength: 10,
    },
  ];
  ...
  return (
    <GameShell
      ...
      subtitle={!showResult ? `Question ${currentStage + 1} of ${stages.length}: Plan your year!` : "Journal Complete!"}
