...
const ReflectiveJournal = () => {
  ...
  const stages = [
    {
      question: 'Write: "Describe someone different from you and what you learned from understanding their perspective."',
      minLength: 10,
    },
    {
      question: 'Write: "Reflect on a time you judged someone without knowing their story. How did learning more change your view?"',
      minLength: 10,
    },
    {
      question: 'Write: "Write about an experience where you felt misunderstood. How can this help you understand others better?"',
      minLength: 10,
    },
    {
      question: 'Write: "Think about a time you showed empathy. What impact did it have on the other person?"',
      minLength: 10,
    },
    {
      question: 'Write: "How will you use what you learned about empathy in your daily interactions?"',
      minLength: 10,
    },
  ];
