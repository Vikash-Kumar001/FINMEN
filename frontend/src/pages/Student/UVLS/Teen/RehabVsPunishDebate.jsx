...
const RehabVsPunishDebate = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Topic: Punishment deters bullying. What's a balanced argument?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 2,
      text: "Topic: Rehab helps bullies change. How do you present a balanced view?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 3,
      text: "What makes an effective debate argument about bullying interventions?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 4,
      text: "How should you respond when someone argues for punishment only?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 5,
      text: "What's the best way to conclude a debate about bullying interventions?",
      options: [
        { 
          id: "a", 
